/**
 @file HTable_test_key_at_index.c
 @author Greg Lee
 @version 2.0.0
...
void test_key_at_index_1( void )
{
   ...
   CU_ASSERT( ii_htable_key_at_index( htable, 0 ) == 1000 );
   CU_ASSERT( ii_htable_key_at_index( htable, 1 ) == 1013 );
...
void test_key_at_index_2( void )
{
   ...
   CU_ASSERT( ss_htable_key_at_index( htable, 0 ) == k1 );
   CU_ASSERT( ss_htable_key_at_index( htable, 1 ) == k2 );
