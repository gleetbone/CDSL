/**
 @file HTable_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   CU_ASSERT( ii_htable_is_deep_equal( htable1, htable ) == 0 );
   ...
   CU_ASSERT( ii_htable_is_deep_equal( htable1, htable ) == 1 );
...
void test_is_deep_equal_2( void )
{
   ...
   CU_ASSERT( ss_htable_is_deep_equal( htable1, htable ) == 0 );
