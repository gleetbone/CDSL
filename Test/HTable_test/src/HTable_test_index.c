...
void test_index_1( void )
{
   ...
   CU_ASSERT( ii_htable_index( htable ) == -1 );

   ii_htable_start( htable );

   CU_ASSERT( ii_htable_index( htable ) == 0 );
...
void test_index_2( void )
{
   ...
   CU_ASSERT( ss_htable_index( htable ) == -1 );

   ss_htable_start( htable );

   CU_ASSERT( ss_htable_index( htable ) == 0 );

   ss_htable_forth( htable );
