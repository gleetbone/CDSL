/**
 @file configuration_test_superkey_has.c
 @author Greg Lee
 @version 2.0.0
...
void test_superkey_has_1( void )
{
   ...
   int32_t flag = configuration_superkey_has( configuration, s, k );
 
   CU_ASSERT( flag == 1 );
   
   flag = configuration_superkey_has( configuration, s, k1 );
...
void test_superkey_has_2( void )
{
   ...
   int32_t flag = configuration_superkey_has_cstring( configuration, "food", "fruit" );
 
   CU_ASSERT( flag == 1 );
   
   flag = configuration_superkey_has_cstring( configuration, "food", "meat" );
