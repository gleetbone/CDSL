/**
 @file configuration_test_is_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_equal_1( void )
{
   ...
   configuration1 = configuration_clone( configuration );

   CU_ASSERT( configuration != NULL );
   CU_ASSERT( configuration1 != NULL );
   
   CU_ASSERT( configuration_is_equal( configuration, configuration ) == 1 );
   CU_ASSERT( configuration_is_equal( configuration, configuration1 ) == 1 );
 
   configuration_dispose( &configuration1 );
