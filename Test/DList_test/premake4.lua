...
solution( name )
   ...
   project( name )
      ...
      includedirs { "src", "../../base", "../../dbc", "../../DList", "../../Protocol_Base", "../../P_Indexable", "../../P_Iterable", "../../P_Iterable_kv", "../../P_DIterable", "../../P_DIterable_kv", "../../P_Basic", "../../P_Searcher", "../../P_Sorter", "../../String"  }
