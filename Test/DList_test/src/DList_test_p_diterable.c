/**
 @file DList_test_p_diterable.c
 @author Greg Lee
 @version 1.0.0
 @brief: "tests for DList P_DIterable"
...
void test_p_diterable_1( void )
{
   ...
   CU_ASSERT( i_diterable_dispose_f( pb_list ) == int_dlist_dispose );
...
void test_p_diterable_2( void )
{
   ...
   CU_ASSERT( i_diterable_dispose_with_contents_f( pb_list ) == int_dlist_dispose_with_contents );
...
void test_p_diterable_3( void )
{
   ...
   CU_ASSERT( i_diterable_count_f( pb_list ) == int_dlist_count );
...
void test_p_diterable_4( void )
{
   ...
   CU_ASSERT( i_diterable_item_f( pb_list ) == int_dlist_item_at );
...
void test_p_diterable_5( void )
{
   ...
   CU_ASSERT( i_diterable_off_f( pb_list ) == int_dlist_off );
...
void test_p_diterable_6( void )
{
   ...
   CU_ASSERT( i_diterable_is_empty_f( pb_list ) == int_dlist_is_empty );
...
void test_p_diterable_8( void )
{
   ...
   CU_ASSERT( i_diterable_forth_f( pb_list ) == int_dlist_forth );
...
void test_p_diterable_9( void )
{
   ...
   CU_ASSERT( i_diterable_finish_f( pb_list ) == int_dlist_finish );
   CU_ASSERT( i_diterable_item( pb_list) == 13 );
...
void test_p_diterable_10( void )
{
   ...
   CU_ASSERT( i_diterable_back_f( pb_list ) == int_dlist_back );
   CU_ASSERT( i_diterable_item( pb_list) == 24 );
