...
void test_is_first_1( void )
{
   ...
   CU_ASSERT( i_dlist_is_first( list ) == 1 );

   i_dlist_forth( list );

   CU_ASSERT( i_dlist_is_first( list ) == 0 );
...
void test_is_first_2( void )
{
   ...
   CU_ASSERT( s_dlist_is_first( list ) == 1 );

   s_dlist_forth( list );

   CU_ASSERT( s_dlist_is_first( list ) == 0 );
