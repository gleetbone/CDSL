/**
 @file DList_test_cursor_is_first.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_is_first_1( void )
{
   ...
   CU_ASSERT( i_dlist_cursor_is_first( cursor ) == 1 );

   i_dlist_cursor_forth( cursor );

   CU_ASSERT( i_dlist_cursor_is_first( cursor ) == 0 );
...
void test_cursor_is_first_2( void )
{
   ...
   CU_ASSERT( s_dlist_cursor_is_first( cursor ) == 1 );

   s_dlist_cursor_forth( cursor );

   CU_ASSERT( s_dlist_cursor_is_first( cursor ) == 0 );
