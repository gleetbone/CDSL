...
void test_swap_1( void )
{
   ...
   CU_ASSERT( i_dlist_item( list, 0 ) == 24 );
   CU_ASSERT( i_dlist_item( list, 1 ) == 17 );

   i_dlist_swap( list, 0, 1 );
   
   CU_ASSERT( i_dlist_item( list, 0 ) == 17 );
   CU_ASSERT( i_dlist_item( list, 1 ) == 24 );
...
void test_swap_2( void )
{
   ...
   i_dlist_swap( list, 1, 2 );
   
   CU_ASSERT( i_dlist_item( list, 0 ) == 24 );
   CU_ASSERT( i_dlist_item( list, 1 ) == 7 );
   CU_ASSERT( i_dlist_item( list, 2 ) == 13 );
...
void test_swap_3( void )
{
   ...
   s_dlist_swap( list, 1, 2 );
   
   CU_ASSERT( string_is_equal( s_dlist_item( list, 0 ), s1 ) == 1 );
   CU_ASSERT( string_is_equal( s_dlist_item( list, 1 ), s3 ) == 1 );
   CU_ASSERT( string_is_equal( s_dlist_item( list, 2 ), s2 ) == 1 );
