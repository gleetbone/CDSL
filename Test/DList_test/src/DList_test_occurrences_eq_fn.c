/**
 @file DList_test_occurrences_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_occurrences_eq_fn_1( void )
{
   ...
   CU_ASSERT( i_dlist_occurrences_eq_fn( list, 24, is_equal_int ) == 1 );
   CU_ASSERT( i_dlist_occurrences_eq_fn( list, 17, is_equal_int ) == 0 );
...
void test_occurrences_eq_fn_2( void )
{
   ...
   CU_ASSERT( i_dlist_occurrences_eq_fn( list, 24, is_equal_int ) == 2 );
   CU_ASSERT( i_dlist_occurrences_eq_fn( list, 13, is_equal_int ) == 1 );
   CU_ASSERT( i_dlist_occurrences_eq_fn( list, 7, is_equal_int ) == 0 );
...
void test_occurrences_eq_fn_3( void )
{
   ...
   CU_ASSERT( s_dlist_occurrences_eq_fn( list, s1, is_equal_string ) == 2 );
