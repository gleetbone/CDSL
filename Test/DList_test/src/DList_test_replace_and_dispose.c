/**
 @file DList_test_replace_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_and_dispose_1( void )
{
   ...
   i_dlist_replace_and_dispose( list, 25, 0 );
...
void test_replace_and_dispose_2( void )
{
   ...
   i_dlist_replace_and_dispose( list, 25, 0 );
   i_dlist_replace_and_dispose( list, 14, 1 );
   i_dlist_replace_and_dispose( list, 8, 2 );
...
void test_replace_and_dispose_3( void )
{
   ...
   s_dlist_replace_and_dispose( list, s4, 0 );
   s_dlist_replace_and_dispose( list, s5, 1 );
   s_dlist_replace_and_dispose( list, s6, 2 );
