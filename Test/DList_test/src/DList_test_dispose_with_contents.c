/**
 @file DList_test_dispose_with_contents.c
 @author Greg Lee
 @version 1.0.0
 @brief: "tests for DList_dispose_with_contents"
 ...
 Unit tests for DList_dispose_with_contents.
...
void test_dispose_with_contents_1( void )
{
   ...
   int_dlist_dispose_with_contents( list );
