/**
 @file DList_test_cursor_item_prev.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for DList_cursor_item_prev"
...
void test_cursor_item_prev_1( void )
{
   ...
   CU_ASSERT( i_dlist_cursor_item_prev( cursor ) == 24 );
...
void test_cursor_item_prev_2( void )
{
   ...
   CU_ASSERT( i_dlist_cursor_item_prev( cursor ) == 13 );
...
void test_cursor_item_prev_3( void )
{
   ...
   CU_ASSERT( s_dlist_cursor_item_prev( cursor ) == s1 );

   s_dlist_cursor_forth( cursor );

   CU_ASSERT( s_dlist_cursor_item_prev( cursor ) == s2 );
