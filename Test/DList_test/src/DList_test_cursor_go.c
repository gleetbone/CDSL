...
void test_cursor_go_1( void )
{
   ...
   i_dlist_cursor_go( cursor, 1 );
   
   CU_ASSERT( i_dlist_cursor_item_at( cursor ) == 13 );
   
   i_dlist_cursor_go( cursor, 0 );
