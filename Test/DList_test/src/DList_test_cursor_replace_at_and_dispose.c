...
void test_cursor_replace_at_and_dispose_1( void )
{
   ...
   i_dlist_cursor_replace_at_and_dispose( cursor, 25 );
...
void test_cursor_replace_at_and_dispose_2( void )
{
   ...
   i_dlist_cursor_replace_at_and_dispose( cursor, 8 );
   
   i_dlist_cursor_back( cursor );
   
   i_dlist_cursor_replace_at_and_dispose( cursor, 14 );
...
void test_cursor_replace_at_and_dispose_3( void )
{
   ...
   s_dlist_cursor_replace_at_and_dispose( cursor, s6 );
   
   s_dlist_cursor_back( cursor );
   
   s_dlist_cursor_replace_at_and_dispose( cursor, s5 );
   
   s_dlist_cursor_back( cursor );
   
   s_dlist_cursor_replace_at_and_dispose( cursor, s4 );
