...
void test_item_2( void )
{
   ...
   CU_ASSERT( i_dlist_item( list, 0 ) == 24 );
   CU_ASSERT( i_dlist_item( list, 1 ) == 13 );
   CU_ASSERT( i_dlist_item( list, 2 ) == 7 );
...
void test_item_3( void )
{
   ...
   CU_ASSERT( s_dlist_item( list, 0 ) == s1 );
   CU_ASSERT( s_dlist_item( list, 1 ) == s2 );
   CU_ASSERT( s_dlist_item( list, 2 ) == s3 );
