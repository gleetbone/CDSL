...
void test_occurrences_1( void )
{
   ...
   CU_ASSERT( i_dlist_occurrences( list, 24 ) == 1 );
   CU_ASSERT( i_dlist_occurrences( list, 17 ) == 0 );
...
void test_occurrences_2( void )
{
   ...
   CU_ASSERT( i_dlist_occurrences( list, 24 ) == 2 );
   CU_ASSERT( i_dlist_occurrences( list, 13 ) == 1 );
   CU_ASSERT( i_dlist_occurrences( list, 7 ) == 0 );
...
void test_occurrences_3( void )
{
   ...
   CU_ASSERT( s_dlist_occurrences( list, s1 ) == 1 );
   CU_ASSERT( s_dlist_occurrences( list, s4 ) == 0 );
