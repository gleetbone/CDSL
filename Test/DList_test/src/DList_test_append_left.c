...
void test_append_left_1( void )
{
   ...
   i_dlist_append_left( list, list1 );
...
void test_append_left_5( void )
{
   ...
   s_dlist_append_left( list, list1 );
...
add_test_append_left( void )
{
   ...
   p_suite = CU_add_suite("suite_test_append_left", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_append_left_1
   add_test_to_suite( p_suite, test_append_left_1, "test_append_left_1" );

   // test_append_left_2
   add_test_to_suite( p_suite, test_append_left_2, "test_append_left_2" );

   // test_append_left_3
   add_test_to_suite( p_suite, test_append_left_3, "test_append_left_3" );

   // test_append_left_4
   add_test_to_suite( p_suite, test_append_left_4, "test_append_left_4" );

   // test_append_left_5
   add_test_to_suite( p_suite, test_append_left_5, "test_append_left_5" );
