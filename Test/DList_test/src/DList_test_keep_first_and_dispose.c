/**
 @file DList_test_keep_first_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_keep_first_and_dispose_1( void )
{
   ...
   i_dlist_keep_first_and_dispose( list, 1 );
...
void test_keep_first_and_dispose_2( void )
{
   ...
   i_dlist_keep_first_and_dispose( list, 0 );
...
void test_keep_first_and_dispose_4( void )
{
   ...
   i_dlist_keep_first_and_dispose( list, 2 );
...
void test_keep_first_and_dispose_7( void )
{
   ...
   i_dlist_keep_first_and_dispose( list, 3 );
...
void test_keep_first_and_dispose_8( void )
{
   ...
   s_dlist_keep_first_and_dispose( list, 2 );
