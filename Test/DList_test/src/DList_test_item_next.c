/**
 @file DList_test_item_next.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for DList_item_next"
...
void test_item_next_1( void )
{
   ...
   CU_ASSERT( i_dlist_item_next( list ) == 13 );
...
void test_item_next_2( void )
{
   ...
   CU_ASSERT( i_dlist_item_next( list ) == 7 );
...
void test_item_next_3( void )
{
   ...
   CU_ASSERT( s_dlist_item_next( list ) == s2 );

   s_dlist_forth( list );

   CU_ASSERT( s_dlist_item_next( list ) == s3 );
...
add_test_item_next( void )
{
   ...
   // test_item_next_3
   add_test_to_suite( p_suite, test_item_next_3, "test_item_next_3" );
