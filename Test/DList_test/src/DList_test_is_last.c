...
void test_is_last_1( void )
{
   ...
   CU_ASSERT( i_dlist_is_last( list ) == 0 );

   i_dlist_forth( list );

   CU_ASSERT( i_dlist_is_last( list ) == 1 );
...
void test_is_last_2( void )
{
   ...
   CU_ASSERT( s_dlist_is_last( list ) == 0 );

   s_dlist_forth( list );

   CU_ASSERT( s_dlist_is_last( list ) == 1 );
