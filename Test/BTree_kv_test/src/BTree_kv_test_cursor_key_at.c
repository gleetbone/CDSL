/**
 @file BTree_test_cursor_key_at.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_cursor_at"
...
void test_cursor_key_at_1( void )
{
   ...
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 1 );
...
void test_cursor_key_at_2( void )
{
   ...
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 2 );

   ii_btree_kv_cursor_forth( cursor );
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 3 );
...
void test_cursor_key_at_5( void )
{
   ...
   ii_btree_kv_cursor_forth( cursor );
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 4 );

   ii_btree_kv_cursor_forth( cursor );
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 6 );
...
void test_cursor_key_at_7( void )
{
   ...
   ii_btree_kv_cursor_forth( cursor );
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 5 );
...
void test_cursor_key_at_8( void )
{
   ...
   ii_btree_kv_cursor_forth( cursor );
   CU_ASSERT( ii_btree_kv_cursor_key_at( cursor ) == 7 );
...
/**
   test_cursor_key_at_9
*/

void test_cursor_key_at_9( void )
{
   ...
   CU_ASSERT( string_is_equal( ss_btree_kv_cursor_key_at( cursor ), s2k ) );

   ss_btree_kv_cursor_forth( cursor );
   CU_ASSERT( string_is_equal( ss_btree_kv_cursor_key_at( cursor ), s1k ) );

   ss_btree_kv_cursor_forth( cursor );
   CU_ASSERT( string_is_equal( ss_btree_kv_cursor_key_at( cursor ), s3k ) );

   ss_btree_kv_cursor_forth( cursor );
   CU_ASSERT( string_is_equal( ss_btree_kv_cursor_key_at( cursor ), s4k ) );
...
add_test_cursor_key_at( void )
{
   ...
   // test_cursor_key_at_9
   add_test_to_suite( p_suite, test_cursor_key_at_9, "test_cursor_key_at_9" );
