/**
 @file BTree_test_key_at_index.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_key_at_index"
...
void test_key_at_index_1( void )
{
   ...
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 0 ) == 1 );
...
void test_key_at_index_2( void )
{
   ...
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 0 ) == 1 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 1 ) == 2 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 2 ) == 3 );
...
void test_key_at_index_5( void )
{
   ...
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 0 ) == 1 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 1 ) == 2 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 2 ) == 4 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 3 ) == 6 );
...
void test_key_at_index_6( void )
{
   ...
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 0 ) == 2 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 1 ) == 3 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 2 ) == 4 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 3 ) == 6 );
...
void test_key_at_index_7( void )
{
   ...
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 0 ) == 2 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 1 ) == 4 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 2 ) == 5 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 3 ) == 6 );
...
void test_key_at_index_8( void )
{
   ...
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 0 ) == 2 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 1 ) == 4 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 2 ) == 6 );
   CU_ASSERT( ii_btree_kv_key_at_index( btree, 3 ) == 7 );
...
void test_key_at_index_9( void )
{
   ...
   CU_ASSERT( string_is_equal( ss_btree_kv_key_at_index( btree, 0 ), s2k ) );
   CU_ASSERT( string_is_equal( ss_btree_kv_key_at_index( btree, 1 ), s1k ) );
   CU_ASSERT( string_is_equal( ss_btree_kv_key_at_index( btree, 2 ), s3k ) );
   CU_ASSERT( string_is_equal( ss_btree_kv_key_at_index( btree, 3 ), s4k ) );
...
add_test_key_at_index( void )
{
   ...
   // test_key_at_index_9
   add_test_to_suite( p_suite, test_key_at_index_9, "test_key_at_index_9" );
