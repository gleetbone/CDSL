/**
 @file BTree_test_cursor_go.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_cursor_go"
...
void test_cursor_go_1( void )
{
   ...
   ii_btree_kv_cursor_go( cursor, 0 );
...
void test_cursor_go_2( void )
{
   ...
   ii_btree_kv_cursor_go( cursor, 1 );
   CU_ASSERT( ii_btree_kv_cursor_item_at( cursor ) == 20 );

   ii_btree_kv_cursor_go( cursor, 2 );
...
void test_cursor_go_5( void )
{
   ...
   ii_btree_kv_cursor_go( cursor, 3 );
...
add_test_cursor_go( void )
{
   ...
   // test_cursor_go_9
   add_test_to_suite( p_suite, test_cursor_go_9, "test_cursor_go_9" );
