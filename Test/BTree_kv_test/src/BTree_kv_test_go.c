/**
 @file BTree_test_go.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_go"
...
void test_go_2( void )
{
   ...
   ii_btree_kv_go( btree, 1 );
   CU_ASSERT( ii_btree_kv_item_at( btree ) == 20 );

   ii_btree_kv_go( btree, 2 );
...
void test_go_5( void )
{
   ...
   ii_btree_kv_go( btree, 2 );
   CU_ASSERT( ii_btree_kv_item_at( btree ) == 40 );

   ii_btree_kv_go( btree, 3 );
...
void test_go_7( void )
{
   ...
   ii_btree_kv_go( btree, 2 );
   CU_ASSERT( ii_btree_kv_item_at( btree ) == 50 );
...
void test_go_8( void )
{
   ...
   ii_btree_kv_go( btree, 3 );
   CU_ASSERT( ii_btree_kv_item_at( btree ) == 70 );
...
void test_go_9( void )
{
   ...
   ss_btree_kv_go( btree, 0 );
   CU_ASSERT( string_is_equal( ss_btree_kv_item_at( btree ), s2v ) );

   ss_btree_kv_go( btree, 1 );
   CU_ASSERT( string_is_equal( ss_btree_kv_item_at( btree ), s1v ) );

   ss_btree_kv_go( btree, 2 );
   CU_ASSERT( string_is_equal( ss_btree_kv_item_at( btree ), s3v ) );

   ss_btree_kv_go( btree, 3 );
   CU_ASSERT( string_is_equal( ss_btree_kv_item_at( btree ), s4v ) );
