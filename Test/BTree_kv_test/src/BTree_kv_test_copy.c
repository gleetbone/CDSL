/**
 @file BTree_test_copy.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_copy"
...
add_test_copy( void )
{
   ...
   // test_copy_4a
   add_test_to_suite( p_suite, test_copy_4a, "test_copy_4a" );

   // test_copy_5
   add_test_to_suite( p_suite, test_copy_5, "test_copy_5" );

   // test_copy_5a
   add_test_to_suite( p_suite, test_copy_5a, "test_copy_5a" );

   // test_copy_6
   add_test_to_suite( p_suite, test_copy_6, "test_copy_6" );

   // test_copy_6a
   add_test_to_suite( p_suite, test_copy_6a, "test_copy_6a" );
