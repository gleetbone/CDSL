/**
 @file BTree_test_wipe_out.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_wipe_out"
...
void test_wipe_out_7( void )
{
   ...
   string_deep_dispose( &s1k );
   string_deep_dispose( &s1v );

   string_deep_dispose( &s2k );
   string_deep_dispose( &s2v );

   string_deep_dispose( &s3k );
   string_deep_dispose( &s3v );

   string_deep_dispose( &s4k );
   string_deep_dispose( &s4v );

   string_deep_dispose( &s5k );
   string_deep_dispose( &s5v );

   string_deep_dispose( &s6k );
   string_deep_dispose( &s6v );

   string_deep_dispose( &s7k );
   string_deep_dispose( &s7v );
