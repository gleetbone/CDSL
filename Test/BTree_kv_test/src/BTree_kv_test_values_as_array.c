/**
 @file BTree_test_values_as_array.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for BTree_kv_values_as_array"
...
void test_values_as_array_1( void )
{
   ...
   array = ii_btree_kv_values_as_array( btree );
...
void test_values_as_array_9( void )
{
   ...
   array = ss_btree_kv_values_as_array( btree );

   CU_ASSERT( string_is_equal( array[0], s2v ) );
   CU_ASSERT( string_is_equal( array[1], s1v ) );
   CU_ASSERT( string_is_equal( array[2], s3v ) );
   CU_ASSERT( string_is_equal( array[3], s4v ) );
