/**
 @file Circular_Array_test_is_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_equal_1( void )
{
   ...
   ca_1 = i_circular_array_clone( ca );
   
   CU_ASSERT( i_circular_array_is_equal( ca, ca ) == 1 );
   CU_ASSERT( i_circular_array_is_equal( ca, ca_1 ) == 1 );
...
void test_is_equal_1a( void )
{
   ...
   CU_ASSERT( i_circular_array_is_equal( ca, ca_1 ) == 0 );
...
void test_is_equal_3( void )
{
   ...
   CU_ASSERT( s_circular_array_is_equal( ca, ca_1 ) == 1 );
