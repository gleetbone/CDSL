/**
 @file Circular_Array_test_ensure_count.c
 @author Greg Lee
 @version 2.0.0
...
void test_ensure_count_1( void )
{
   ...
   i_circular_array_ensure_count( ca, 3 );
   CU_ASSERT( i_circular_array_count( ca ) == 3 );
   CU_ASSERT( i_circular_array_capacity( ca ) == 4 );   

   i_circular_array_ensure_count( ca, 6 );
   CU_ASSERT( i_circular_array_count( ca ) == 6 );   
   CU_ASSERT( i_circular_array_capacity( ca ) == 6 );   
...
void test_ensure_count_2( void )
{
   ...
   s_circular_array_ensure_count( ca, 3 );
   CU_ASSERT( s_circular_array_count( ca ) == 3 );
   CU_ASSERT( s_circular_array_capacity( ca ) == 4 );   
 
   s_circular_array_ensure_count( ca, 6 );
   CU_ASSERT( s_circular_array_count( ca ) == 6 );   
   CU_ASSERT( s_circular_array_capacity( ca ) == 6 );   
