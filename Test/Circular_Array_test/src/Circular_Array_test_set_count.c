/**
 @file Circular_Array_test_set_count.c
 @author Greg Lee
 @version 2.0.0
...
void test_set_count_1( void )
{
   ...
   i_circular_array_set_count( ca, 3 );
...
void test_set_count_2( void )
{
   ...
   s_circular_array_set_count( ca, 3 );
...
add_test_set_count( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_count", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_count_1
   add_test_to_suite( p_suite, test_set_count_1, "test_set_count_1" );

   // test_set_count_2
   add_test_to_suite( p_suite, test_set_count_2, "test_set_count_2" );
