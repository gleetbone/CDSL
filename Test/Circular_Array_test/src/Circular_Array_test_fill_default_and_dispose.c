/**
 @file Circular_Array_test_fill_default_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_fill_default_and_dispose_1
*/

void test_fill_default_and_dispose_1( void )
{
   ...
   i_circular_array_fill_default_and_dispose( ca );
...
/**
   test_fill_default_and_dispose_2
*/

void test_fill_default_and_dispose_2( void )
{
   ...
   s_circular_array_fill_default_and_dispose( ca );
...
add_test_fill_default_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_fill_default_and_dispose", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_fill_default_and_dispose_1
   add_test_to_suite( p_suite, test_fill_default_and_dispose_1, "test_fill_default_and_dispose_1" );

   // test_fill_default_and_dispose_2
   add_test_to_suite( p_suite, test_fill_default_and_dispose_2, "test_fill_default_and_dispose_2" );
