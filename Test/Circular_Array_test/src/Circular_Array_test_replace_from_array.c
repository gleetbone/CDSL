/**
 @file Circular_Array_test_replace_from_array.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_replace_from_array_1
*/

void test_replace_from_array_1( void )
{
   ...
   i_circular_array_replace_from_array( ca, array, count, 1 );
...
/**
   test_replace_from_array_1a
*/

void test_replace_from_array_1a( void )
{
   i_circular_array_t *ca = NULL;
   int32_t *array = NULL;
   int32_t count = 0;
   ...
   i_circular_array_replace_from_array( ca, array, count, 0 );
...
/**
   test_replace_from_array_2
*/

void test_replace_from_array_2( void )
{
   ...
   s_circular_array_replace_from_array( ca, array, count, 1 );
...
add_test_replace_from_array( void )
{
   ...
   p_suite = CU_add_suite("suite_test_replace_from_array", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_replace_from_array_1
   add_test_to_suite( p_suite, test_replace_from_array_1, "test_replace_from_array_1" );

   // test_replace_from_array_1a
   add_test_to_suite( p_suite, test_replace_from_array_1a, "test_replace_from_array_1a" );

   // test_replace_from_array_2
   add_test_to_suite( p_suite, test_replace_from_array_2, "test_replace_from_array_2" );
