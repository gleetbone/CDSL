/**
 @file Circular_Array_test_remove_first_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_first_and_dispose_1( void )
{
   ...
   i_circular_array_remove_first_and_dispose( ca );
   
   CU_ASSERT( i_circular_array_item( ca, 0 ) == 24 );
...
void test_remove_first_and_dispose_2( void )
{
   ...
   s_circular_array_remove_first_and_dispose( ca );
