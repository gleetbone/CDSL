/**
 @file Circular_Array_test_replace_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_and_dispose_1( void )
{
   ...
   i_circular_array_replace_and_dispose( ca, 17, 0 );
...
/**
   test_replace_and_dispose_1a
*/

void test_replace_and_dispose_1a( void )
{
   i_circular_array_t *ca = NULL;
   ...
   i_circular_array_replace_and_dispose( ca, 17, 1 );
...
void test_replace_and_dispose_2( void )
{
   ...
   s_circular_array_replace_and_dispose( ca, s3, 0 );
...
add_test_replace_and_dispose( void )
{
   ...
   // test_replace_and_dispose_1a
   add_test_to_suite( p_suite, test_replace_and_dispose_1a, "test_replace_and_dispose_1a" );
