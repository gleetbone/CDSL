...
void test_is_equal_1( void )
{
   ...
   result = i_qsorter_is_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
...
void test_is_equal_1a( void )
{
   ...
   result = i_qsorter_is_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
...
void test_is_equal_2( void )
{
   ...
   result = i_qsorter_is_deep_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
...
void test_is_equal_2a( void )
{
   ...
   result = i_qsorter_is_deep_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
