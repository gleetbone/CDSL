/**
 @file Sequence_test_replace_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_and_dispose_1( void )
{
   ...
   int_sequence_replace_and_dispose( sequence, 13, 0 );
...
void test_replace_and_dispose_2( void )
{
   ...
   int_sequence_replace_and_dispose( sequence, 13, 0 );
   int_sequence_replace_and_dispose( sequence, 24, 1 );
   
   CU_ASSERT( int_sequence_item( sequence, 0 ) == 13 );
   CU_ASSERT( int_sequence_item( sequence, 1 ) == 24 );
   
   int_sequence_replace_and_dispose( sequence, 7, 1 );
...
void test_replace_and_dispose_3( void )
{
   ...
   int_sequence_replace_and_dispose( sequence, 13, 0 );
   int_sequence_replace_and_dispose( sequence, 24, 11 );
   
   CU_ASSERT( int_sequence_item( sequence, 0 ) == 13 );
   CU_ASSERT( int_sequence_item( sequence, 11 ) == 24 );
   
   int_sequence_replace_and_dispose( sequence, 7, 11 );
...
void test_replace_and_dispose_4( void )
{
   ...
   s_sequence_replace_and_dispose( sequence, s1, 0 );
   s_sequence_replace_and_dispose( sequence, s2, 11 );
   
   CU_ASSERT( s_sequence_item( sequence, 0 ) == s1 );
   CU_ASSERT( s_sequence_item( sequence, 11 ) == s2 );
   
   s_sequence_replace_and_dispose( sequence, s3, 11 );
