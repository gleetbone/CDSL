...
void test_is_equal_1( void )
{
   ...
   CU_ASSERT( int_sequence_is_equal( sequence1, sequence ) == 1 );
   
   int_sequence_set_count( sequence, 1 );
   
   CU_ASSERT( int_sequence_is_equal( sequence, sequence1 ) == 0 );
   ...
   CU_ASSERT( int_sequence_is_equal( sequence, sequence1 ) == 1 );
...
void test_is_equal_2( void )
{
   ...
   CU_ASSERT( s_sequence_is_equal( sequence1, sequence ) == 1 );
   
   s_sequence_set_count( sequence, 1 );
   
   CU_ASSERT( s_sequence_is_equal( sequence, sequence1 ) == 0 );
