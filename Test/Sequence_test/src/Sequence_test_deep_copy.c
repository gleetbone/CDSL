/**
 @file Sequence_test_deep_copy.c
 @author Greg Lee
 @version 2.0.0
...
void test_deep_copy_1( void )
{
   ...
   sequence1 = int_sequence_make_n( 4 );
   
   int_sequence_deep_copy( sequence1, sequence );
...
void test_deep_copy_2( void )
{
   ...
   sequence1 = s_sequence_make_n( 4 );
   
   s_sequence_deep_copy( sequence1, sequence );
   ...
   CU_ASSERT( string_is_equal( s_sequence_item( sequence1, 0 ), s1 ) == 1 );
   CU_ASSERT( string_is_equal( s_sequence_item( sequence1, 1 ), s2 ) == 1 );
   CU_ASSERT( string_is_equal( s_sequence_item( sequence1, 2 ), s3 ) == 1 );
   CU_ASSERT( string_is_equal( s_sequence_item( sequence1, 3 ), s4 ) == 1 );
