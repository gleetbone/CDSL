...
add_test_hour_24( void )
{
   ...
   p_suite = CU_add_suite("suite_test_hour_24", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_hour_24_1
   add_test_to_suite( p_suite, test_hour_24_1, "test_hour_24_1" );
