/**
 @file date_time_test_put_month.c
 @author Greg Lee
 @version 2.0.0
...
add_test_put_month( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_month", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_month
   add_test_to_suite( p_suite, test_put_month, "test_put_month" );
