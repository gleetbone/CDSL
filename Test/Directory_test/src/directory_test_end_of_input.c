/**
 @file directory_test_end_of_input.c
 @author Greg Lee
 @version 2.0.0
...
add_test_end_of_input( void )
{
   ...
   p_suite = CU_add_suite("suite_test_end_of_input", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_end_of_input_1
   add_test_to_suite( p_suite, test_end_of_input_1, "test_end_of_input_1" );
