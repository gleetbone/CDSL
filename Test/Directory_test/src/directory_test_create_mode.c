/**
 @file directory_test_create_mode.c
 @author Greg Lee
 @version 1.0.0
...
add_test_create_mode( void )
{
   ...
   p_suite = CU_add_suite("suite_test_create_mode", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_create_mode_1
   add_test_to_suite( p_suite, test_create_mode_1, "test_create_mode_1" );
