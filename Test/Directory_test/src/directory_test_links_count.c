/**
 @file directory_test_links_count.c
 @author Greg Lee
 @version 1.0.0
...
void test_links_count_1( void )
{
   ...
   count = directory_links_count( dir );
...
add_test_links_count( void )
{
   ...
   p_suite = CU_add_suite("suite_test_links_count", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_links_count_1
   add_test_to_suite( p_suite, test_links_count_1, "test_links_count_1" );
