/**
 @file directory_test_last_entry.c
 @author Greg Lee
 @version 1.0.0
...
add_test_last_entry( void )
{
   ...
   p_suite = CU_add_suite("suite_test_last_entry", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_last_entry_1
   add_test_to_suite( p_suite, test_last_entry_1, "test_last_entry_1" );
