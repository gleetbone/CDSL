/**
 @file directory_test_recursive_delete.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_recursive_delete_1
*/

void test_recursive_delete_1( void )
{
...
add_test_recursive_delete( void )
{
   ...
   p_suite = CU_add_suite("suite_test_recursive_delete", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_recursive_delete_1
   add_test_to_suite( p_suite, test_recursive_delete_1, "test_recursive_delete_1" );
