...
add_test_filenames( void )
{
   ...
   p_suite = CU_add_suite("suite_test_filenames", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_filenames_1
   add_test_to_suite( p_suite, test_filenames_1, "test_filenames_1" );
