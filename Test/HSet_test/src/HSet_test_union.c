...
void test_union_9( void )
{
   ...
   result = s_hset_union( hset, other );

   CU_ASSERT( s_hset_count( result ) == 3 );
...
add_test_union( void )
{
   ...
   // test_union_9
   add_test_to_suite( p_suite, test_union_9, "test_union_9" );
