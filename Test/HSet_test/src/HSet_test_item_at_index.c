/**
 @file HSet_test_item_at_index.c
 @author Greg Lee
 @version 2.0.0
...
void test_item_at_index_1( void )
{
   ...
   CU_ASSERT( i_hset_item_at_index( hset, 0 ) == 24 );
   CU_ASSERT( i_hset_item_at_index( hset, 1 ) == 25 );
...
void test_item_at_index_2( void )
{
   ...
   CU_ASSERT( s_hset_item_at_index( hset, 0 ) == s1 );
   CU_ASSERT( s_hset_item_at_index( hset, 1 ) == s2 );
