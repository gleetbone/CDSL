/**
 @file string_utf8_test_remove_tail.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_tail_1( void )
{
   ...
   string_utf8_remove_tail( string, 0 );
...
void test_remove_tail_2( void )
{
   ...
   string_utf8_remove_tail( string, 1 );
...
void test_remove_tail_3( void )
{
   ...
   string_utf8_remove_tail( string, 2 );
...
void test_remove_tail_4( void )
{
   ...
   string_utf8_remove_tail( string, 3 );
...
void test_remove_tail_5( void )
{
   ...
   string_utf8_remove_tail( string, 4);
