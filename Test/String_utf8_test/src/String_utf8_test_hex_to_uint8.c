/**
 @file string_utf8_test_hex_to_uint8.c
 @author Greg Lee
 @version 2.0.0
...
{
   string_utf8_t *string = string_utf8_make_from_cstring( "00" );

   uint8_t u8 = string_utf8_hex_to_uint8( string );
...
{
   string_utf8_t *string = string_utf8_make_from_cstring( "01" );
...
{
   string_utf8_t *string = string_utf8_make_from_cstring( "10" );
...
{
   string_utf8_t *string = string_utf8_make_from_cstring( "F0" );
