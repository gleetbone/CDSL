/**
 @file string_utf8_test_starts_with.c
 @author Greg Lee
 @version 2.0.0
...
void test_starts_with_1( void )
{
   ...
   CU_ASSERT( string_utf8_starts_with( string, string1 ) == 1 );
...
void test_starts_with_2( void )
{
   ...
   CU_ASSERT( string_utf8_starts_with( string, string1 ) == 0 );
...
void test_starts_with_4( void )
{
   string_utf8_t *string = NULL;
   string_utf8_t *string1 = NULL;

   string = string_utf8_make_from_cstring( "ABC" );
   string1 = string_utf8_make_from_cstring( "AB" );
...
void test_starts_with_5( void )
{
   string_utf8_t *string = NULL;
   string_utf8_t *string1 = NULL;

   string = string_utf8_make_from_cstring( "ABCDE" );
   string1 = string_utf8_make_from_cstring( "CDE" );
...
void test_starts_with_6( void )
{
   string_utf8_t *string = NULL;
   string_utf8_t *string1 = NULL;

   string = string_utf8_make_from_cstring( "ABCDE" );
   string1 = string_utf8_make_from_cstring( "ABCDEF" );
...
add_test_starts_with( void )
{
   ...
   // test_starts_with_3
   add_test_to_suite( p_suite, test_starts_with_3, "test_starts_with_3" );

   // test_starts_with_4
   add_test_to_suite( p_suite, test_starts_with_4, "test_starts_with_4" );

   // test_starts_with_5
   add_test_to_suite( p_suite, test_starts_with_5, "test_starts_with_5" );

   // test_starts_with_6
   add_test_to_suite( p_suite, test_starts_with_6, "test_starts_with_6" );
