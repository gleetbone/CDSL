...
int
add_test_as_utf8( void );

int
add_test_as_utf16( void );

int
add_test_as_utf32( void );
...
int
add_test_append_character_ascii( void );
...
int
add_test_append_character_utf32( void );

int
add_test_append_character_wchar( void );

int
add_test_prepend_character_ascii( void );
...
int
add_test_prepend_character_utf32( void );

int
add_test_prepend_character_wchar( void );
...
int main()
{
   ...
   add_test_make_from_utf16();
   add_test_make_from_utf32();
   add_test_make_from_wchar();
   add_test_dispose();
   ...
   add_test_append_character_ascii();
   add_test_append_character();
   add_test_append_character_utf16();
   add_test_append_character_utf32();
   add_test_append_character_wchar();
   add_test_prepend_character_ascii();
   add_test_prepend_character();
   add_test_prepend_character_utf16();
   add_test_prepend_character_utf32();
   add_test_prepend_character_wchar();
   add_test_insert_character_ascii();
   add_test_insert_character();
   add_test_insert_character_utf16();
   add_test_insert_character_utf32();
   add_test_insert_character_wchar();
