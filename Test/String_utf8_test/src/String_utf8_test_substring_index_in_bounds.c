/**
 @file string_utf8_test_substring_index_in_bounds.c
 @author Greg Lee
 @version 2.0.0
...
void test_substring_index_in_bounds_1( void )
{
   ...
   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 0 ) == 0 );
...
void test_substring_index_in_bounds_2( void )
{
   ...
   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 1 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 0 ) == -1 );
...
void test_substring_index_in_bounds_3( void )
{
   ...
   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 2 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 1 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 1, 2 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 0 ) == -1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 2, 2 ) == -1 );
...
void test_substring_index_in_bounds_4( void )
{
   ...
   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 5 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 2 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 5 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 1, 5 ) == 1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 2, 5 ) == -1 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 4, 5 ) == -1 );
...
void test_substring_index_in_bounds_5( void )
{
   ...
   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 0, 7 ) == 1 );
   ...
   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 4, 11 ) == 7 );

   CU_ASSERT( string_utf8_substring_index_in_bounds( string, string1, 8, 11 ) == -1 );
