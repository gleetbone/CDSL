/**
 @file string_utf8_test_insert_float64.c
 @author Greg Lee
 @version 2.0.0
...
void test_insert_float64_1( void )
{
   ...
   string_utf8_insert_float64( string, 1.0, 0 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "1.000000ABC" );
...
void test_insert_float64_2( void )
{
   ...
   string_utf8_insert_float64( string, 123.0, 1 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "A123.000000BC" );
...
void test_insert_float64_3( void )
{
   ...
   string_utf8_insert_float64( string, 123.0, 2 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "AB123.000000C" );
...
void test_insert_float64_4( void )
{
   ...
   string_utf8_t *stringt = string_utf8_make_from_cstring( "A-123.000000BC" );
...
void test_insert_float64_5( void )
{
   ...
   string_utf8_insert_float64( string, -123.0, 0 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "-123.000000ABC" );
