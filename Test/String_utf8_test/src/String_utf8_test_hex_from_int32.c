/**
 @file string_utf8_test_hex_from_int32.c
 @author Greg Lee
 @version 2.0.0
...
void test_hex_from_int32_1( void )
{
   ...
   string_utf8_t *string = string_utf8_hex_from_int32( i32 );

   CU_ASSERT( string_utf8_is_equal_cstring( string, "00000000" ) == 1 );
...
void test_hex_from_int32_2( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "00000001" ) == 1 );
...
void test_hex_from_int32_3( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "00000010" ) == 1 );
...
void test_hex_from_int32_4( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "000000F0" ) == 1 );
...
void test_hex_from_int32_5( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "00003E81" ) == 1 );
...
void test_hex_from_int32_6( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "00010001" ) == 1 );
...
void test_hex_from_int32_7( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "12345678" ) == 1 );
...
void test_hex_from_int32_8( void )
{
   ...
   CU_ASSERT( string_utf8_is_equal_cstring( string, "FFFFFB2E" ) == 1 );
