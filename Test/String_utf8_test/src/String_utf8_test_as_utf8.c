/**
 @file string_utf8_test_as_utf8.c
 @author Greg Lee
 @version 2.0.0
...
add_test_as_utf8( void )
{
   ...
   p_suite = CU_add_suite("suite_test_as_utf8", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_as_utf8_1
   add_test_to_suite( p_suite, test_as_utf8_1, "test_as_utf8_1" );
