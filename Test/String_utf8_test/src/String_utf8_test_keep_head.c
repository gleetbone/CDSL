/**
 @file string_utf8_test_keep_head.c
 @author Greg Lee
 @version 2.0.0
...
void test_keep_head_1( void )
{
   ...
   string_utf8_keep_head( string, 0 );
...
void test_keep_head_2( void )
{
   ...
   string_utf8_keep_head( string, 1 );
...
void test_keep_head_3( void )
{
   ...
   string_utf8_keep_head( string, 2 );
...
void test_keep_head_4( void )
{
   ...
   string_utf8_keep_head( string, 3 );
...
void test_keep_head_5( void )
{
   ...
   string_utf8_keep_head( string, 4);
