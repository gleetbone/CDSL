/**
 @file string_utf8_test_replace_all_cstring2.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_all_cstring2_1( void )
{
   ...
   string_utf8_replace_all_cstring2( string, "B", "Q" );
...
void test_replace_all_cstring2_2( void )
{
   ...
   string_utf8_replace_all_cstring2( string, "B", "QR" );
...
void test_replace_all_cstring2_3( void )
{
   ...
   string_utf8_replace_all_cstring2( string, "AB", "X" );
...
void test_replace_all_cstring2_4( void )
{
   ...
   string_utf8_replace_all_cstring2( string, "CD", "XYZ" );
...
void test_replace_all_cstring2_5( void )
{
   ...
   string_utf8_replace_all_cstring2( string, "BCD", "Q" );
...
void test_replace_all_cstring2_6( void )
{
   ...
   string_utf8_replace_all_cstring2( string, "BC", "QRWXYZ" );
