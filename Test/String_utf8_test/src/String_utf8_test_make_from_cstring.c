/**
 @file string_utf8_test_make_from_cstring.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_make_from_cstring_utf8_1
*/

void test_make_from_cstring_utf8_1( void )
{
...
add_test_make_from_cstring( void )
{
   ...
   // test_make_from_cstring_utf8_1
   add_test_to_suite( p_suite, test_make_from_cstring_utf8_1, "test_make_from_cstring_utf8_1" );
