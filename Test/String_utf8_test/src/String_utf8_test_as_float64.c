/**
 @file string_utf8_test_as_float64.c
 @author Greg Lee
 @version 2.0.0
...
void test_as_float64_1( void )
{
   ...
   CU_ASSERT( string_utf8_as_float64( string ) == 0.0 );
...
void test_as_float64_2( void )
{
   ...
   CU_ASSERT( string_utf8_as_float64( string ) == 123.0 );
...
void test_as_float64_3( void )
{
   ...
   string = string_utf8_make_from_cstring( "123.25" );

   CU_ASSERT( string_utf8_as_float64( string ) == 123.25 );
...
void test_as_float64_4( void )
{
   ...
   CU_ASSERT( string_utf8_as_float64( string ) == 100.0 );
...
void test_as_float64_5( void )
{
   ...
   string = string_utf8_make_from_cstring( ".125" );

   CU_ASSERT( string_utf8_as_float64( string ) == 0.125 );
...
void test_as_float64_6( void )
{
   ...
   string = string_utf8_make_from_cstring( ".125E4" );

   CU_ASSERT( string_utf8_as_float64( string ) == 1250.0 );
