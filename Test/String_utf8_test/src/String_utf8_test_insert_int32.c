/**
 @file string_utf8_test_insert_int32.c
 @author Greg Lee
 @version 2.0.0
...
void test_insert_int32_1( void )
{
   ...
   string_utf8_insert_int32( string, 123, 0 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "123ABC" );
...
void test_insert_int32_2( void )
{
   ...
   string_utf8_insert_int32( string, 123, 1 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "A123BC" );
...
void test_insert_int32_3( void )
{
   ...
   string_utf8_insert_int32( string, 123, 2 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "AB123C" );
...
void test_insert_int32_4( void )
{
   ...
   string_utf8_t *stringt = string_utf8_make_from_cstring( "A-123BC" );
