/**
 @file string_utf8_test_replace.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_1( void )
{
   ...
   string_utf8_replace( string, string1, 1, 1 );
...
void test_replace_2( void )
{
   ...
   string = string_utf8_make_from_cstring( "ABCD" );
   string1 = string_utf8_make_from_cstring( "QR" );
...
void test_replace_3( void )
{
   ...
   string_utf8_replace( string, string1, 1, 2 );
...
void test_replace_4( void )
{
   ...
   string_utf8_replace( string, string1, 0, 1 );
...
void test_replace_5( void )
{
   ...
   string_utf8_replace( string, string1, 2, 3 );
...
void test_replace_6( void )
{
   ...
   string = string_utf8_make_from_cstring( "ABCD" );
   string1 = string_utf8_make_from_cstring( "PQRSTUV" );
