/**
 @file string_utf8_test_remove_head.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_head_1( void )
{
   ...
   string_utf8_remove_head( string, 0 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "ABCD" );
...
void test_remove_head_2( void )
{
   ...
   string_utf8_remove_head( string, 1 );
...
void test_remove_head_3( void )
{
   ...
   string_utf8_remove_head( string, 2 );
...
void test_remove_head_4( void )
{
   ...
   string_utf8_remove_head( string, 3 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "D" );
...
void test_remove_head_5( void )
{
   ...
   string_utf8_remove_head( string, 4);
