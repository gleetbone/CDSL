/**
 @file string_utf8_test_resize.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for string_utf8_make_n"
...
void test_resize_1( void )
{
   ...
   string = string_utf8_make_n( 5 );

   CU_ASSERT( string != NULL );
   CU_ASSERT( string_utf8_count( string ) == 0 );
   CU_ASSERT( string_utf8_capacity( string ) == 5 );

   string_utf8_resize( string, 32 );

   CU_ASSERT( string_utf8_count( string ) == 0 );
   CU_ASSERT( string_utf8_capacity( string ) == 32 );

   string_utf8_resize( string, 3 );
