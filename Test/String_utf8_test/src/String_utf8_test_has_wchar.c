/**
 @file string_utf8_test_has_wchar.c
 @author Greg Lee
 @version 2.0.0
...
void test_has_wchar_1( void )
{
   ...
   cp[0] = 'a';
   CU_ASSERT( string_utf8_has_wchar( string, cp[0] ) == 0 );
...
void test_has_wchar_2( void )
{
   ...
   cp[0] = 'a';
   CU_ASSERT( string_utf8_has_wchar( string, cp[0] ) == 1 );
...
add_test_has_wchar( void )
{
   ...
   // test_has_wchar_2
   add_test_to_suite( p_suite, test_has_wchar_2, "test_has_wchar_2" );
