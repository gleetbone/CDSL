/**
 @file string_utf8_test_as_utf16.c
 @author Greg Lee
 @version 2.0.0
...
void test_as_utf16_1( void )
{
   string_utf8_t *string = NULL;
   utf16_t *cstring = NULL;

   string = string_utf8_make_from_cstring( "abcd" );
   cstring = string_utf8_as_utf16( string );
...
add_test_as_utf16( void )
{
   ...
   p_suite = CU_add_suite("suite_test_as_utf16", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_as_utf16_1
   add_test_to_suite( p_suite, test_as_utf16_1, "test_as_utf16_1" );
