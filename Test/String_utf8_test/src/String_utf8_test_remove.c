/**
 @file string_utf8_test_remove.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_3( void )
{
   ...
   string_utf8_remove( string, 2 );

   string_utf8_t *stringt = string_utf8_make_from_cstring( "ABD" );
