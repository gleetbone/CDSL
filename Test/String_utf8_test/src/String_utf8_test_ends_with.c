/**
 @file string_utf8_test_ends_with.c
 @author Greg Lee
 @version 2.0.0
...
void test_ends_with_1( void )
{
   ...
   CU_ASSERT( string_utf8_ends_with( string, string1 ) == 1 );
...
void test_ends_with_3( void )
{
   ...
   CU_ASSERT( string_utf8_ends_with( string, string1 ) == 0 );
...
void test_ends_with_5( void )
{
   ...
   string1 = string_utf8_make_from_cstring( "CD" );
