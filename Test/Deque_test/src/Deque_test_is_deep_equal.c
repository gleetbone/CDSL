/**
 @file Deque_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   result = i_deque_is_deep_equal( d1, deque );
   ...
   result = i_deque_is_deep_equal( d2, deque );
   ...
   result = i_deque_is_deep_equal( d3, deque );
...
void test_is_deep_equal_2( void )
{
   ...
   s3 = string_make_from_cstring( "1" );
   s4 = string_make_from_cstring( "2" );
   
   s_deque_put_first( d1, s3 );
   s_deque_put_first( d1, s4 );
   
   result = s_deque_is_deep_equal( d1, deque );
