/**
 @file Lsqline_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   CU_ASSERT( lsqline_is_deep_equal( lsqline, lsqline1 ) == 1 );
...
void test_is_deep_equal_5( void )
{
   ...
   CU_ASSERT( lsqline_is_deep_equal( lsqline, lsqline1 ) == 0 );
...
/**
   test_is_deep_equal_10
*/

void test_is_deep_equal_10( void )
{
   lsqline_t *lsqline = NULL;
   lsqline_t *lsqline1 = NULL;
...
add_test_is_deep_equal( void )
{
   ...
   // test_is_deep_equal_10
   add_test_to_suite( p_suite, test_is_deep_equal_10, "test_is_deep_equal_10" );
