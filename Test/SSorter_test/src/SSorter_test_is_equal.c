/**
 @file SSorter_test_is_equal.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for SSorter_t"
...
{
   i_ssorter_t *sorter = NULL;
   i_ssorter_t *sorter1 = NULL;
   int32_t result = 0;

   sorter = i_ssorter_make();
   CU_ASSERT( sorter != NULL );
   
   sorter1 = i_ssorter_make();
   CU_ASSERT( sorter1 != NULL );
   
   result = i_ssorter_is_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
   
   i_ssorter_dispose( &sorter );
   i_ssorter_dispose( &sorter1 );
   CU_ASSERT( sorter == NULL );
   CU_ASSERT( sorter1 == NULL );
...
void test_is_equal_1a( void )
{
   ...
   result = i_ssorter_is_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
...
void test_is_equal_2( void )
{
   ...
   result = i_ssorter_is_deep_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
   
   
   i_ssorter_deep_dispose( &sorter );
   i_ssorter_deep_dispose( &sorter1 );
   CU_ASSERT( sorter == NULL );
   CU_ASSERT( sorter1 == NULL );
...
void test_is_equal_2a( void )
{
   ...
   result = i_ssorter_is_deep_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
