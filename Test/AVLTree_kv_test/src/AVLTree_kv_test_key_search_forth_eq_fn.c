/**
 @file AVLTree_kv_test_key_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_key_search_forth_eq_fn_1
*/

void test_key_search_forth_eq_fn_1( void )
{
   ...
   ii_avltree_kv_key_search_forth_eq_fn( avltree, 1, is_equal_int );
...
/**
   test_key_search_forth_eq_fn_2
*/

void test_key_search_forth_eq_fn_2( void )
{
   ii_avltree_kv_t *avltree = NULL;
...
/**
   test_key_search_forth_eq_fn_3
*/

void test_key_search_forth_eq_fn_3( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ...
   ii_avltree_kv_start( avltree );
   ii_avltree_kv_key_search_forth_eq_fn( avltree, 2, is_equal_int );
   CU_ASSERT( ii_avltree_kv_off( avltree ) == 0 );
...
/**
   test_key_search_forth_eq_fn_4
*/

void test_key_search_forth_eq_fn_4( void )
{
   ii_avltree_kv_t *avltree = NULL;
...
/**
   test_key_search_forth_eq_fn_5
*/
void test_key_search_forth_eq_fn_5( void )
{
   ...
   ss_avltree_kv_key_search_forth_eq_fn( avltree, s2, is_equal_s );
...
add_test_key_search_forth_eq_fn( void )
{
   ...
   p_suite = CU_add_suite("suite_test_key_search_forth_eq_fn", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_key_search_forth_eq_fn_1
   add_test_to_suite( p_suite, test_key_search_forth_eq_fn_1, "test_key_search_forth_eq_fn_1" );

   // test_key_search_forth_eq_fn_2
   add_test_to_suite( p_suite, test_key_search_forth_eq_fn_2, "test_key_search_forth_eq_fn_2" );

   // test_key_search_forth_eq_fn_3
   add_test_to_suite( p_suite, test_key_search_forth_eq_fn_3, "test_key_search_forth_eq_fn_3" );

   // test_key_search_forth_eq_fn_4
   add_test_to_suite( p_suite, test_key_search_forth_eq_fn_4, "test_key_search_forth_eq_fn_4" );

   // test_key_search_forth_eq_fn_5
   add_test_to_suite( p_suite, test_key_search_forth_eq_fn_5, "test_key_search_forth_eq_fn_5" );
