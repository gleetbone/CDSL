...
void test_go_2( void )
{
   ...
   ii_avltree_kv_go( avltree, 1 );
   CU_ASSERT( ii_avltree_kv_item_at( avltree ) == 20 );
 
   ii_avltree_kv_go( avltree, 2 );
