/**
 @file AVLTree_test_remove_last_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_last_and_dispose_1( void )
{
   ...
   ii_avltree_kv_remove_last_and_dispose( avltree );
...
void test_remove_last_and_dispose_7( void )
{
   ...
   s4a = string_make_from_cstring( "4" );
   s40a = string_make_from_cstring( "40" );
   ...
   ss_avltree_kv_remove_last_and_dispose( avltree );
   ...
   result = ss_avltree_kv_has( avltree, s4a );
   CU_ASSERT( result == 0 );
