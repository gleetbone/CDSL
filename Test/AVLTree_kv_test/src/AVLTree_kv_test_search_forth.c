/**
 @file AVLTree_kv_test_search_forth.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_forth_1( void )
{
   ...
   ii_avltree_kv_search_forth( avltree, 1 );
...
void test_search_forth_2( void )
{
   ...
   ii_avltree_kv_start( avltree );
   ii_avltree_kv_search_forth( avltree, 10 );
...
void test_search_forth_3( void )
{
   ...
   ii_avltree_kv_start( avltree );
   ii_avltree_kv_search_forth( avltree, 20 );
   CU_ASSERT( ii_avltree_kv_off( avltree ) == 0 );
...
void test_search_forth_5( void )
{
   ...
   ss_avltree_kv_search_forth( avltree, s20 );
...
add_test_search_forth( void )
{
   ...
   // test_search_forth_5
   add_test_to_suite( p_suite, test_search_forth_5, "test_search_forth_5" );
