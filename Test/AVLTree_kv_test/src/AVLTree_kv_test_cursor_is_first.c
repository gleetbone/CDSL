/**
 @file AVLTree_test_cursor_is_first.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_is_first_1( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_cursor_is_first( cursor ) == 0 );
...
/**
   test_cursor_is_first_1a
*/

void test_cursor_is_first_1a( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ii_avltree_kv_cursor_t *cursor = NULL;
   ...
   CU_ASSERT( ii_avltree_kv_cursor_is_first( cursor ) == 1 );
...
void test_cursor_is_first_5( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ii_avltree_kv_cursor_t *cursor = NULL;
...
void test_cursor_is_first_6( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ii_avltree_kv_cursor_t *cursor = NULL;
...
/**
   test_cursor_is_first_7
*/

void test_cursor_is_first_7( void )
{
   ...
   CU_ASSERT( ss_avltree_kv_cursor_is_first( cursor ) == 1 );
 
   ss_avltree_kv_cursor_finish( cursor );
   
   CU_ASSERT( ss_avltree_kv_cursor_is_first( cursor ) == 0 );
...
add_test_cursor_is_first( void )
{
   ...
   // test_cursor_is_first_1a
   add_test_to_suite( p_suite, test_cursor_is_first_1a, "test_cursor_is_first_1a" );
   ...
   // test_cursor_is_first_5
   add_test_to_suite( p_suite, test_cursor_is_first_5, "test_cursor_is_first_5" );

   // test_cursor_is_first_6
   add_test_to_suite( p_suite, test_cursor_is_first_6, "test_cursor_is_first_6" );

   // test_cursor_is_first_7
   add_test_to_suite( p_suite, test_cursor_is_first_7, "test_cursor_is_first_7" );
