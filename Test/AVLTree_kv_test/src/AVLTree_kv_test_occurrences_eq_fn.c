/**
 @file AVLTree_test_occurrences_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_occurrences_eq_fn_1( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences_eq_fn( avltree, 1, is_equal_int ) == 0 );
...
void test_occurrences_eq_fn_2( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences_eq_fn( avltree, 1, is_equal_int ) == 1 );
...
void test_occurrences_eq_fn_3( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences_eq_fn( avltree, 1, is_equal_int ) == 1 );
   CU_ASSERT( ii_avltree_kv_occurrences_eq_fn( avltree, 2, is_equal_int ) == 2 );
   CU_ASSERT( ii_avltree_kv_occurrences_eq_fn( avltree, 3, is_equal_int ) == 1 );
...
void test_occurrences_eq_fn_4( void )
{
   ...
   CU_ASSERT( ss_avltree_kv_occurrences_eq_fn( avltree, s1, is_equal_s ) == 1 );
   CU_ASSERT( ss_avltree_kv_occurrences_eq_fn( avltree, s2, is_equal_s ) == 2 );
   CU_ASSERT( ss_avltree_kv_occurrences_eq_fn( avltree, s3, is_equal_s ) == 1 );
