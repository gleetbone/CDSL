...
void test_make_from_array_2( void )
{
   ...
   avltree = ii_avltree_kv_make_from_array( key_array, value_array, 8 );
...
void test_make_from_array_3( void )
{
   ...
   avltree = ss_avltree_kv_make_from_array( key_array, value_array, 4 );

   CU_ASSERT( avltree != NULL );
   CU_ASSERT( ss_avltree_kv_count( avltree ) == 4 );
   CU_ASSERT( ss_avltree_kv_has( avltree, s2 ) == 1 );
