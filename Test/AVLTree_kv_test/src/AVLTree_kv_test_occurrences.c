...
void test_occurrences_1( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences( avltree, 1 ) == 0 );
...
void test_occurrences_2( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences( avltree, 1 ) == 1 );
...
void test_occurrences_3( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences( avltree, 1 ) == 1 );
   CU_ASSERT( ii_avltree_kv_occurrences( avltree, 2 ) == 2 );
   CU_ASSERT( ii_avltree_kv_occurrences( avltree, 3 ) == 1 );
...
void test_occurrences_4( void )
{
   ...
   CU_ASSERT( ss_avltree_kv_occurrences( avltree, s1 ) == 1 );
   CU_ASSERT( ss_avltree_kv_occurrences( avltree, s2 ) == 2 );
   CU_ASSERT( ss_avltree_kv_occurrences( avltree, s3 ) == 1 );
