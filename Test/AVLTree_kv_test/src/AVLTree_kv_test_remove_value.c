...
void test_remove_value_1( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 10 );
...
void test_remove_value_2( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 20 );
...
void test_remove_value_2b( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 30 );
...
void test_remove_value_5( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 40 );
...
void test_remove_value_5d( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 50 );
...
void test_remove_value_5e( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 60 );
...
void test_remove_value_5f( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 70 );
...
void test_remove_value_6b( void )
{
   ...
   ii_avltree_kv_remove_value( avltree, 80 );
...
void test_remove_value_7( void )
{
   ...
   ss_avltree_kv_remove_value( avltree, s10 );
