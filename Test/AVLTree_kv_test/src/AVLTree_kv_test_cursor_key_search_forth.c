/**
 @file AVLTree_kv_test_cursor_key_search_forth.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_cursor_key_search_forth_1
*/

void test_cursor_key_search_forth_1( void )
{
   ...
   ii_avltree_kv_cursor_key_search_forth( cursor, 1 );
...
/**
   test_cursor_key_search_forth_2
*/

void test_cursor_key_search_forth_2( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ii_avltree_kv_cursor_t *cursor = NULL;
...
/**
   test_cursor_key_search_forth_3
*/

void test_cursor_key_search_forth_3( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ii_avltree_kv_cursor_t *cursor = NULL;
   ...
   ii_avltree_kv_cursor_start( cursor );
   ii_avltree_kv_cursor_key_search_forth( cursor, 2 );
   CU_ASSERT( ii_avltree_kv_cursor_off( cursor ) == 0 );
...
/**
   test_cursor_key_search_forth_4
*/

void test_cursor_key_search_forth_4( void )
{
   ii_avltree_kv_t *avltree = NULL;
   ii_avltree_kv_cursor_t *cursor = NULL;
...
/**
   test_cursor_key_search_forth_5
*/
void test_cursor_key_search_forth_5( void )
{
   ...
   ss_avltree_kv_cursor_key_search_forth( cursor, s2 );
...
add_test_cursor_key_search_forth( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_key_search_forth", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_key_search_forth_1
   add_test_to_suite( p_suite, test_cursor_key_search_forth_1, "test_cursor_key_search_forth_1" );

   // test_cursor_key_search_forth_2
   add_test_to_suite( p_suite, test_cursor_key_search_forth_2, "test_cursor_key_search_forth_2" );

   // test_cursor_key_search_forth_3
   add_test_to_suite( p_suite, test_cursor_key_search_forth_3, "test_cursor_key_search_forth_3" );

   // test_cursor_key_search_forth_4
   add_test_to_suite( p_suite, test_cursor_key_search_forth_4, "test_cursor_key_search_forth_4" );

   // test_cursor_key_search_forth_5
   add_test_to_suite( p_suite, test_cursor_key_search_forth_5, "test_cursor_key_search_forth_5" );
