/**
 @file AVLTree_kv_test_cursor_search_back_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_back_eq_fn_1( void )
{
   ...
   ii_avltree_kv_cursor_search_back_eq_fn( cursor, 1, is_equal_int );
...
void test_cursor_search_back_eq_fn_2( void )
{
   ...
   ii_avltree_kv_cursor_finish( cursor );
   ii_avltree_kv_cursor_search_back_eq_fn( cursor, 10, is_equal_int );
...
void test_cursor_search_back_eq_fn_3( void )
{
   ...
   ii_avltree_kv_cursor_finish( cursor );
   ii_avltree_kv_cursor_search_back_eq_fn( cursor, 20, is_equal_int );
   CU_ASSERT( ii_avltree_kv_cursor_off( cursor ) == 0 );
...
void test_cursor_search_back_eq_fn_5( void )
{
   ...
   ss_avltree_kv_cursor_search_back_eq_fn( cursor, s20, is_equal_s );
