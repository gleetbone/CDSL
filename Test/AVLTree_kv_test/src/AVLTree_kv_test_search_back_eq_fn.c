/**
 @file AVLTree_kv_test_search_back_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_back_eq_fn_1( void )
{
   ...
   ii_avltree_kv_search_back_eq_fn( avltree, 1, is_equal_int );
...
void test_search_back_eq_fn_2( void )
{
   ...
   ii_avltree_kv_search_back_eq_fn( avltree, 10, is_equal_int );
...
void test_search_back_eq_fn_3( void )
{
   ...
   ii_avltree_kv_finish( avltree );
   ii_avltree_kv_search_back_eq_fn( avltree, 20, is_equal_int );
   CU_ASSERT( ii_avltree_kv_off( avltree ) == 0 );
...
void test_search_back_eq_fn_5( void )
{
   ...
   ss_avltree_kv_search_back_eq_fn( avltree, s20, is_equal_s );
