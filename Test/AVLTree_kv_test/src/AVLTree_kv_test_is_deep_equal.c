/**
 @file AVLTree_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_is_deep_equal( avltree1, avltree ) == 1 );
...
void test_is_deep_equal_2( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_is_deep_equal( avltree, avltree1 ) == 1 );
...
void test_is_deep_equal_2a( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_is_deep_equal( avltree, avltree ) == 1 );
