...
void test_has_eq_fn_1( void )
{
   ...
   result = ii_avltree_kv_has_eq_fn( avltree, 1, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_avltree_kv_has_eq_fn( avltree, 0, is_equal_int );
   CU_ASSERT( result == 0 );
...
void test_has_eq_fn_2( void )
{
   ...
   result = ii_avltree_kv_has_eq_fn( avltree, 2, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_avltree_kv_has_eq_fn( avltree, 1, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_avltree_kv_has_eq_fn( avltree, 3, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_5( void )
{
   ...
   result = ii_avltree_kv_has_eq_fn( avltree, 4, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_avltree_kv_has_eq_fn( avltree, 2, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_avltree_kv_has_eq_fn( avltree, 6, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_7( void )
{
   ...
   result = ii_avltree_kv_has_eq_fn( avltree, 5, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_8( void )
{
   ...
   result = ii_avltree_kv_has_eq_fn( avltree, 7, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_9( void )
{
   ...
   result = ss_avltree_kv_has_eq_fn( avltree, s4, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_avltree_kv_has_eq_fn( avltree, s2, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_avltree_kv_has_eq_fn( avltree, s6, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_avltree_kv_has_eq_fn( avltree, s7, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_avltree_kv_has_eq_fn( avltree, s0, is_equal_s );
   CU_ASSERT( result == 0 );
