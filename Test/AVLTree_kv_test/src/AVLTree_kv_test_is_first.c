...
void test_is_first_1( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_is_first( avltree ) == 0 );
...
void test_is_first_1a( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_is_first( avltree ) == 1 );
...
void test_is_first_7( void )
{
   ...
   CU_ASSERT( ss_avltree_kv_is_first( avltree ) == 1 );
 
   ss_avltree_kv_finish( avltree );
   
   CU_ASSERT( ss_avltree_kv_is_first( avltree ) == 0 );
