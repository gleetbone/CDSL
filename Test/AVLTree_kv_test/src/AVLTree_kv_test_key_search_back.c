/**
 @file AVLTree_kv_test_key_search_back.c
 @author Greg Lee
 @version 2.0.0
...
void test_key_search_back_1( void )
{
   ...
   ii_avltree_kv_key_search_back( avltree, 1 );
...
void test_key_search_back_3( void )
{
   ...
   ii_avltree_kv_finish( avltree );
   ii_avltree_kv_key_search_back( avltree, 2 );
   CU_ASSERT( ii_avltree_kv_off( avltree ) == 0 );
...
void test_key_search_back_5( void )
{
   ...
   ss_avltree_kv_key_search_back( avltree, s2 );
