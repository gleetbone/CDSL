/**
 @file AVLTree_test_occurrences_value.c
 @author Greg Lee
 @version 2.0.0
...
void test_occurrences_value_1( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences_value( avltree, 1 ) == 0 );
...
void test_occurrences_value_2( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences_value( avltree, 10 ) == 1 );
...
void test_occurrences_value_3( void )
{
   ...
   CU_ASSERT( ii_avltree_kv_occurrences_value( avltree, 10 ) == 1 );
   CU_ASSERT( ii_avltree_kv_occurrences_value( avltree, 20 ) == 2 );
   CU_ASSERT( ii_avltree_kv_occurrences_value( avltree, 30 ) == 1 );
...
void test_occurrences_value_4( void )
{
   ...
   CU_ASSERT( ss_avltree_kv_occurrences_value( avltree, s10 ) == 1 );
   CU_ASSERT( ss_avltree_kv_occurrences_value( avltree, s20 ) == 2 );
   CU_ASSERT( ss_avltree_kv_occurrences_value( avltree, s30 ) == 1 );
