...
add_test_prune_first( void )
{
   ...
   p_suite = CU_add_suite("suite_test_prune_first", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_prune_first_1
   add_test_to_suite( p_suite, test_prune_first_1, "test_prune_first_1" );

   // test_prune_first_2
   add_test_to_suite( p_suite, test_prune_first_2, "test_prune_first_2" );

   // test_prune_first_3
   add_test_to_suite( p_suite, test_prune_first_3, "test_prune_first_3" );

   // test_prune_first_4
   add_test_to_suite( p_suite, test_prune_first_4, "test_prune_first_4" );

   // test_prune_first_5
   add_test_to_suite( p_suite, test_prune_first_5, "test_prune_first_5" );
