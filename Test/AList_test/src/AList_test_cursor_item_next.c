/**
 @file AList_test_cursor_item_next.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for AList_cursor_item_next"
...
void test_cursor_item_next_1( void )
{
   ...
   CU_ASSERT( i_alist_cursor_item_next( cursor ) == 13 );
...
void test_cursor_item_next_2( void )
{
   ...
   CU_ASSERT( i_alist_cursor_item_next( cursor ) == 7 );
...
void test_cursor_item_next_3( void )
{
   ...
   CU_ASSERT( string_is_equal( s_alist_cursor_item_next( cursor ), s2 ) == 1 );

   s_alist_cursor_forth( cursor );
   CU_ASSERT( string_is_equal( s_alist_cursor_item_next( cursor ), s3 ) == 1 );
