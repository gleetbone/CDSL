/**
 ...
 Unit tests for AList_make_from_array.
...
void test_make_from_array_1( void )
{
   ...
   int_alist_t *list = int_alist_make_from_array( array, 0 );
   
   CU_ASSERT( list != NULL );
   CU_ASSERT( int_alist_count( list ) == 0 );
   CU_ASSERT( int_alist_is_empty( list ) == 1 );
...
void test_make_from_array_2( void )
{
   ...
   int_alist_t *list = int_alist_make_from_array( array, 1 );
   
   CU_ASSERT( list != NULL );
   CU_ASSERT( int_alist_count( list ) == 1 );
   CU_ASSERT( int_alist_is_empty( list ) == 0 );
   CU_ASSERT( int_alist_first( list ) == 24 );
