...
void test_is_last_1( void )
{
   ...
   CU_ASSERT( i_alist_is_last( list ) == 0 );

   i_alist_forth( list );
   
   CU_ASSERT( i_alist_is_last( list ) == 1 );
...
void test_is_last_3( void )
{
   ...
   CU_ASSERT( s_alist_is_last( list ) == 0 );
   ...
   s_alist_forth( list );
   CU_ASSERT( s_alist_is_last( list ) == 1 );
