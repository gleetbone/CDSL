/**
 @file AList_test_prune_first_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_prune_first_and_dispose_1( void )
{
   ...
   i_alist_prune_first_and_dispose( list, 1 );
...
void test_prune_first_and_dispose_3( void )
{
   ...
   i_alist_prune_first_and_dispose( list, 2 );
...
void test_prune_first_and_dispose_6( void )
{
   ...
   i_alist_prune_first_and_dispose( list, 3 );
...
void test_prune_first_and_dispose_7( void )
{
   ...
   s_alist_prune_first_and_dispose( list, 1 );
