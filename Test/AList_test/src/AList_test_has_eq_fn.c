...
void test_has_eq_fn_1( void )
{
   ...
   CU_ASSERT( i_alist_has_eq_fn( list, 17, is_equal_int ) == 0 );
   CU_ASSERT( i_alist_has_eq_fn( list, 24, is_equal_int ) == 1 );
   CU_ASSERT( i_alist_has_eq_fn( list, 13, is_equal_int ) == 1 );
...
void test_has_eq_fn_2( void )
{
   ...
   CU_ASSERT( i_alist_has_eq_fn( list, 24, is_equal_int ) == 1 );
   CU_ASSERT( i_alist_has_eq_fn( list, 13, is_equal_int ) == 1 );
   CU_ASSERT( i_alist_has_eq_fn( list, 7, is_equal_int ) == 1 );
...
void test_has_eq_fn_3( void )
{
   ...
   CU_ASSERT( s_alist_has_eq_fn( list, s1, is_equal_string ) == 1 );
   CU_ASSERT( s_alist_has_eq_fn( list, s2, is_equal_string ) == 1 );
   CU_ASSERT( s_alist_has_eq_fn( list, s3, is_equal_string ) == 1 );
   CU_ASSERT( s_alist_has_eq_fn( list, s4, is_equal_string ) == 1 );
