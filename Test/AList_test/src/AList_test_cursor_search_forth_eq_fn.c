/**
 @file AList_test_cursor_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_forth_eq_fn_1( void )
{
   ...
   i_alist_cursor_search_forth_eq_fn( cursor, 24, is_equal_int );
...
void test_cursor_search_forth_eq_fn_2( void )
{
   ...
   i_alist_cursor_search_forth_eq_fn( cursor, 13, is_equal_int );
...
void test_cursor_search_forth_eq_fn_4( void )
{
   ...
   s_alist_cursor_search_forth_eq_fn( cursor, s1, is_equal_string );
