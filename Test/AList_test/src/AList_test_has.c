...
void test_has_1( void )
{
   ...
   CU_ASSERT( i_alist_has( list, 17 ) == 0 );
   CU_ASSERT( i_alist_has( list, 24 ) == 1 );
   CU_ASSERT( i_alist_has( list, 13 ) == 1 );
...
void test_has_2( void )
{
   ...
   CU_ASSERT( i_alist_has( list, 24 ) == 1 );
   CU_ASSERT( i_alist_has( list, 13 ) == 1 );
   CU_ASSERT( i_alist_has( list, 7 ) == 1 );
...
void test_has_3( void )
{
   ...
   CU_ASSERT( s_alist_has( list, s1 ) == 1 );
   CU_ASSERT( s_alist_has( list, s2 ) == 1 );
   CU_ASSERT( s_alist_has( list, s3 ) == 1 );
   CU_ASSERT( s_alist_has( list, s4 ) == 0 );
