/**
 @file AList_test_cursor_is_first.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_is_first_1( void )
{
   ...
   CU_ASSERT( i_alist_cursor_is_first( cursor ) == 1 );
   
   i_alist_cursor_forth( cursor );

   CU_ASSERT( i_alist_cursor_is_first( cursor ) == 0 );
...
void test_cursor_is_first_3( void )
{
   ...
   CU_ASSERT( s_alist_cursor_is_first( cursor ) == 0 );

   s_alist_cursor_start( cursor );
   CU_ASSERT( s_alist_cursor_is_first( cursor ) == 1 );
