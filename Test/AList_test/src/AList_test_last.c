...
void test_last_1( void )
{
   ...
   CU_ASSERT( i_alist_last( list ) == 24 );

   i_alist_put_last( list, 13 );
   
   CU_ASSERT( i_alist_last( list ) == 13 );
...
void test_last_3( void )
{
   ...
   s_alist_start( list );
   CU_ASSERT( string_is_equal( s_alist_last( list ), s2 ) == 1 );

   s_alist_forth( list );
   CU_ASSERT( string_is_equal( s_alist_last( list ), s2 ) == 1 );

   s_alist_put_last( list, s3 );
   CU_ASSERT( string_is_equal( s_alist_last( list ), s3 ) == 1 );
