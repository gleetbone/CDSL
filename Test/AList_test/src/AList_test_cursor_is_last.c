/**
 @file AList_test_cursor_is_last.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_is_last_1( void )
{
   ...
   CU_ASSERT( i_alist_cursor_is_last( cursor ) == 0 );
   
   i_alist_cursor_forth( cursor );

   CU_ASSERT( i_alist_cursor_is_last( cursor ) == 1 );
...
void test_cursor_is_last_3( void )
{
   ...
   CU_ASSERT( s_alist_cursor_is_last( cursor ) == 0 );
   ...
   s_alist_cursor_forth( cursor );
   CU_ASSERT( s_alist_cursor_is_last( cursor ) == 1 );
