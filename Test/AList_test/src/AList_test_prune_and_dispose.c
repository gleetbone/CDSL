...
void test_prune_and_dispose_1( void )
{
   ...
   int_alist_prune_and_dispose( list, 0, 1 );
...
void test_prune_and_dispose_3( void )
{
   ...
   int_alist_prune_and_dispose( list, 1, 1 );
...
void test_prune_and_dispose_4( void )
{
   ...
   int_alist_prune_and_dispose( list, 0, 2 );
...
void test_prune_and_dispose_7( void )
{
   ...
   int_alist_prune_and_dispose( list, 2, 1 );
...
void test_prune_and_dispose_9( void )
{
   ...
   int_alist_prune_and_dispose( list, 1, 2 );
