...
void test_cursor_go_1( void )
{
   ...
   i_alist_cursor_go( cursor, 1 );
   
   CU_ASSERT( i_alist_cursor_item_at( cursor ) == 13 );
   
   i_alist_cursor_go( cursor, 0 );
