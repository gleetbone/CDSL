/**
 @file Rng_isaac_gaussian_test_make_with_seed.c
 @author Greg Lee
 @version 2.0.0
...
void gaussian_test_make_with_seed_1( void )
{
...
add_gaussian_test_make_with_seed( void )
{
   ...
   // test_make_with_seed_1
   add_test_to_suite( p_suite, gaussian_test_make_with_seed_1, "gaussian_test_make_with_seed_1" );
