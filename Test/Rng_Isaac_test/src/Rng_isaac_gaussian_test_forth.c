/**
 @file Rng_isaac_gaussian_test_forth.c
 @author Greg Lee
 @version 2.0.0
...
/**
   gaussian_test_forth_1
*/

void gaussian_test_forth_1( void )
{
...
add_gaussian_test_forth( void )
{
   ...
   p_suite = CU_add_suite("suite_gaussian_test_forth", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // gaussian_test_forth_1
   add_test_to_suite( p_suite, gaussian_test_forth_1, "gaussian_test_forth_1" );
