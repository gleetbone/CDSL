/**
 @file date_time_duration_formatter_parser_test_put_start_format_string_cstring.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_put_start_format_string_cstring_1
*/

void test_put_start_format_string_cstring_1( void )
{
   ...
   s = date_time_duration_formatter_parser_start_format_string( date_time_duration_formatter_parser );
   CU_ASSERT( string_is_equal( start_format_string, s ) == 1 );
   string_deep_dispose( &s );
 
   string_wipe_out( start_format_string );
   string_append_cstring( start_format_string, "yyyy-mm-dd [0]hh:[0]mi:[0]ss" );
...
add_test_put_start_format_string_cstring( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_start_format_string_cstring", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_start_format_string_cstring_1
   add_test_to_suite( p_suite, test_put_start_format_string_cstring_1, "test_put_start_format_string_cstring_1" );
