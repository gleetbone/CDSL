/**
 @file date_time_duration_formatter_parser_test_base_century.c
 @author Greg Lee
 @version 2.0.0
...
add_test_base_century( void )
{
   ...
   p_suite = CU_add_suite("suite_test_base_century", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_base_century_1
   add_test_to_suite( p_suite, test_base_century_1, "test_base_century_1" );
