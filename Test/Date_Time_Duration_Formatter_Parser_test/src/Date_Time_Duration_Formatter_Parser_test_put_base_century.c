/**
 @file date_time_duration_formatter_parser_test_put_base_century.c
 @author Greg Lee
 @version 2.0.0
...
void test_put_base_century_1( void )
{
   ...
   date_time_duration_formatter_parser_put_base_century( date_time_duration_formatter_parser, 1900 );
   
   CU_ASSERT( date_time_duration_formatter_parser_base_century( date_time_duration_formatter_parser ) == 1900 );
