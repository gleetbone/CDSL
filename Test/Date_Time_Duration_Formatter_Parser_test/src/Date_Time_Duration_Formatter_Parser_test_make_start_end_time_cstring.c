/**
 @file date_time_duration_formatter_parser_test_make_start_end_time_cstring.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_make_start_end_time_cstring_1
*/

void test_make_start_end_time_cstring_1( void )
{
   ...
   s = date_time_duration_formatter_parser_separator( date_time_duration_formatter_parser );
...
add_test_make_start_end_time_cstring( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_start_end_time_cstring", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_start_end_time_cstring_1
   add_test_to_suite( p_suite, test_make_start_end_time_cstring_1, "test_make_start_end_time_cstring_1" );
