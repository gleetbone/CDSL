/**
 @file date_time_duration_formatter_parser_test_put_start_format_string.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_put_start_format_string_1
*/

void test_put_start_format_string_1( void )
{
...
add_test_put_start_format_string( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_start_format_string", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_start_format_string_1
   add_test_to_suite( p_suite, test_put_start_format_string_1, "test_put_start_format_string_1" );
