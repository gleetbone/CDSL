/**
 @file date_time_duration_formatter_parser_test_is_start_end.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_start_end_1( void )
{
   ...
   CU_ASSERT( date_time_duration_formatter_parser_is_start_end( date_time_duration_formatter_parser ) == 1 );
...
add_test_is_start_end( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_start_end", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_start_end_1
   add_test_to_suite( p_suite, test_is_start_end_1, "test_is_start_end_1" );
