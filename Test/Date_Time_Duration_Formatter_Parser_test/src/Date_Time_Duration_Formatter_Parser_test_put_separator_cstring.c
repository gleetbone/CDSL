/**
 @file date_time_duration_formatter_parser_test_put_separator_cstring_cstring.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_put_separator_cstring_1
*/

void test_put_separator_cstring_1( void )
{
   ...
   end_format_string = string_make_from_cstring( "*DDdHHhMImSS.[0]MLSs" );
   ...
   string_wipe_out( separator );
   string_append_cstring( separator, " ^ " );
...
add_test_put_separator_cstring( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_separator_cstring", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_separator_cstring_1
   add_test_to_suite( p_suite, test_put_separator_cstring_1, "test_put_separator_cstring_1" );
