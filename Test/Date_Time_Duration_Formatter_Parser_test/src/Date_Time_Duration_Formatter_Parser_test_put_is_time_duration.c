/**
 @file date_time_duration_formatter_parser_test_put_is_time_duration.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_put_is_time_duration_1
*/

void test_put_is_time_duration_1( void )
{
   ...
   date_time_duration_formatter_parser_put_is_time_duration( date_time_duration_formatter_parser, 0 );
   
   CU_ASSERT( date_time_duration_formatter_parser_is_time_duration( date_time_duration_formatter_parser ) == 0 );
...
add_test_put_is_time_duration( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_is_time_duration", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_is_time_duration_1
   add_test_to_suite( p_suite, test_put_is_time_duration_1, "test_put_is_time_duration_1" );
