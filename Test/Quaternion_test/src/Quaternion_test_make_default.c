/**
 @file Quaternion_test_make_default.c
 @author Greg Lee
 @version 1.0.0
...
add_test_make_default( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_default", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_default_1
   add_test_to_suite( p_suite, test_make_default_1, "test_make_default_1" );

   // test_make_default_2
   add_test_to_suite( p_suite, test_make_default_2, "test_make_default_2" );
