/**
 @file Quaternion_test_set_from_rotation_degrees_about_vector.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_set_from_rotation_degrees_about_vector_1
*/

void test_set_from_rotation_degrees_about_vector_1( void )
{
   ...
   f_quaternion_set_from_rotation_degrees_about_vector( fq, 90.0, vector );
...
/**
   test_set_from_rotation_degrees_about_vector_2
*/
void test_set_from_rotation_degrees_about_vector_2( void )
{
   ...
   d_quaternion_set_from_rotation_degrees_about_vector( dq, 90.0, vector );
...
add_test_set_from_rotation_degrees_about_vector( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_from_rotation_degrees_about_vector", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_from_rotation_degrees_about_vector_1
   add_test_to_suite( p_suite, test_set_from_rotation_degrees_about_vector_1, "test_set_from_rotation_degrees_about_vector_1" );

   // test_set_from_rotation_degrees_about_vector_2
   add_test_to_suite( p_suite, test_set_from_rotation_degrees_about_vector_2, "test_set_from_rotation_degrees_about_vector_2" );
