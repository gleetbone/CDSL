/**
 @file Quaternion_test_get_roll.c
 @author Greg Lee
 @version 2.0.0
...
void test_get_roll_1( void )
{
   f_quaternion_t *fq = NULL;
   float32_t x = 0.0;

   fq = f_quaternion_make_default();
   x = f_quaternion_get_roll( fq );
...
/**
   test_get_roll_2
*/
void test_get_roll_2( void )
{
   d_quaternion_t *dq = NULL;
   float64_t x = 0.0;

   dq = d_quaternion_make_default();
   x = d_quaternion_get_roll( dq );
...
add_test_get_roll( void )
{
   ...
   p_suite = CU_add_suite("suite_test_get_roll", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_get_roll_1
   add_test_to_suite( p_suite, test_get_roll_1, "test_get_roll_1" );

   // test_get_roll_2
   add_test_to_suite( p_suite, test_get_roll_2, "test_get_roll_2" );
