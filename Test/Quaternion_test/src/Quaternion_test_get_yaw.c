/**
 @file Quaternion_test_get_yaw.c
 @author Greg Lee
 @version 2.0.0
...
add_test_get_yaw( void )
{
   ...
   p_suite = CU_add_suite("suite_test_get_yaw", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_get_yaw_1
   add_test_to_suite( p_suite, test_get_yaw_1, "test_get_yaw_1" );

   // test_get_yaw_2
   add_test_to_suite( p_suite, test_get_yaw_2, "test_get_yaw_2" );
