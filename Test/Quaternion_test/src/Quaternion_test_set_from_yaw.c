/**
 @file Quaternion_test_set_from_yaw.c
 @author Greg Lee
 @version 1.0.0
...
add_test_set_from_yaw( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_from_yaw", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_from_yaw_1
   add_test_to_suite( p_suite, test_set_from_yaw_1, "test_set_from_yaw_1" );

   // test_set_from_yaw_2
   add_test_to_suite( p_suite, test_set_from_yaw_2, "test_set_from_yaw_2" );
