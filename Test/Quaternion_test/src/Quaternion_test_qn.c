...
add_test_qn( void )
{
   ...
   p_suite = CU_add_suite("suite_test_qn", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_qn_1
   add_test_to_suite( p_suite, test_qn_1, "test_qn_1" );

   // test_qn_2
   add_test_to_suite( p_suite, test_qn_2, "test_qn_2" );
