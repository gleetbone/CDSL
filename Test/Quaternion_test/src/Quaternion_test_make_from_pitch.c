/**
 @file Quaternion_test_make_from_pitch.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_make_from_pitch_1
*/

void test_make_from_pitch_1( void )
{
...
/**
   test_make_from_pitch_2
*/
void test_make_from_pitch_2( void )
{
...
add_test_make_from_pitch( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_from_pitch", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_from_pitch_1
   add_test_to_suite( p_suite, test_make_from_pitch_1, "test_make_from_pitch_1" );

   // test_make_from_pitch_2
   add_test_to_suite( p_suite, test_make_from_pitch_2, "test_make_from_pitch_2" );
