/**
 @file Quaternion_test_subtracted.c
 @author Greg Lee
 @version 1.0.0
...
void test_subtracted_1( void )
{
   ...
   fq3 = f_quaternion_subtracted( fq, fq1 );

   CU_ASSERT( fq != NULL );
   CU_ASSERT( fq1 != NULL );
   CU_ASSERT( fq2 != NULL );
   CU_ASSERT( f_quaternion_is_approximately_equal( fq3, fq2, 0.00001 ) == 1.0 );
...
void test_subtracted_2( void )
{
   ...
   dq3 = d_quaternion_subtracted( dq, dq1 );

   CU_ASSERT( dq != NULL );
   CU_ASSERT( dq1 != NULL );
   CU_ASSERT( dq2 != NULL );
   CU_ASSERT( d_quaternion_is_approximately_equal( dq3, dq2, 0.00001 ) == 1.0 );
