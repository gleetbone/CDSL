/**
 @file Quaternion_test_multiplied.c
 @author Greg Lee
 @version 1.0.0
...
void test_multiplied_1( void )
{
   ...
   fq2 = f_quaternion_make( -21.0, 0.0, 27.0, 0.0 );
   fq3 = f_quaternion_multiplied( fq, fq1 );
...
void test_multiplied_2( void )
{
   ...
   dq2 = d_quaternion_make( -21.0, 0.0, 27.0, 0.0 );
   dq3 = d_quaternion_multiplied( dq, dq1 );
