/**
 @file Quaternion_test_make_from_rotation_degrees_about_vector.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_make_from_rotation_degrees_about_vector_1
*/

void test_make_from_rotation_degrees_about_vector_1( void )
{
   ...
   fq = f_quaternion_make_from_rotation_degrees_about_vector( 90.0, vector );
...
/**
   test_make_from_rotation_degrees_about_vector_2
*/
void test_make_from_rotation_degrees_about_vector_2( void )
{
   ...
   dq = d_quaternion_make_from_rotation_degrees_about_vector( 90.0, vector );
...
add_test_make_from_rotation_degrees_about_vector( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_from_rotation_degrees_about_vector", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_from_rotation_degrees_about_vector_1
   add_test_to_suite( p_suite, test_make_from_rotation_degrees_about_vector_1, "test_make_from_rotation_degrees_about_vector_1" );

   // test_make_from_rotation_degrees_about_vector_2
   add_test_to_suite( p_suite, test_make_from_rotation_degrees_about_vector_2, "test_make_from_rotation_degrees_about_vector_2" );
