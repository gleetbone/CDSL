...
/**
   test_rotated_vector_1
*/

void test_rotated_vector_1( void )
{
   ...
   v2 = f_quaternion_rotated_vector( fq, vector );
...
/**
   test_rotated_vector_2
*/
void test_rotated_vector_2( void )
{
   ...
   v2 = d_quaternion_rotated_vector( dq, vector );
...
add_test_rotated_vector( void )
{
   ...
   p_suite = CU_add_suite("suite_test_rotated_vector", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_rotated_vector_1
   add_test_to_suite( p_suite, test_rotated_vector_1, "test_rotated_vector_1" );

   // test_rotated_vector_2
   add_test_to_suite( p_suite, test_rotated_vector_2, "test_rotated_vector_2" );
