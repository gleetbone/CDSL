/**
 @file Quaternion_test_normalized.c
 @author Greg Lee
 @version 2.0.0
...
void test_normalized_1( void )
{
   ...
   fq2 = f_quaternion_normalized( fq );
...
void test_normalized_2( void )
{
   ...
   dq2 = d_quaternion_normalized( dq );
...
add_test_normalized( void )
{
   ...
   p_suite = CU_add_suite("suite_test_normalized", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_normalized_1
   add_test_to_suite( p_suite, test_normalized_1, "test_normalized_1" );

   // test_normalized_2
   add_test_to_suite( p_suite, test_normalized_2, "test_normalized_2" );
