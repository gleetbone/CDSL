...
void test_set_qn_1( void )
{
   f_quaternion_t *fq = NULL;

   fq = f_quaternion_make_default();
   f_quaternion_set_q0( fq, 1.0 );
   f_quaternion_set_q1( fq, 2.0 );
   f_quaternion_set_q2( fq, 3.0 );
   f_quaternion_set_q3( fq, 4.0 );
...
/**
   test_set_qn_2
*/
void test_set_qn_2( void )
{
   d_quaternion_t *dq = NULL;

   dq = d_quaternion_make_default();
   d_quaternion_set_q0( dq, 1.0 );
   d_quaternion_set_q1( dq, 2.0 );
   d_quaternion_set_q2( dq, 3.0 );
   d_quaternion_set_q3( dq, 4.0 );
...
add_test_set_qn( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_qn", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_qn_1
   add_test_to_suite( p_suite, test_set_qn_1, "test_set_qn_1" );

   // test_set_qn_2
   add_test_to_suite( p_suite, test_set_qn_2, "test_set_qn_2" );
