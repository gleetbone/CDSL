/**
 @file Quaternion_test_set_from_roll.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_set_from_roll_1
*/

void test_set_from_roll_1( void )
{
   f_quaternion_t *fq = NULL;
   f_quaternion_t *fq1 = NULL;

   fq = f_quaternion_make_default();
   f_quaternion_set_from_roll( fq, M_PI/3.0 );
...
/**
   test_set_from_roll_2
*/
void test_set_from_roll_2( void )
{
   d_quaternion_t *dq = NULL;
   d_quaternion_t *dq1 = NULL;

   dq = d_quaternion_make_default();
   d_quaternion_set_from_roll( dq, M_PI/3.0 );
...
add_test_set_from_roll( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_from_roll", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_from_roll_1
   add_test_to_suite( p_suite, test_set_from_roll_1, "test_set_from_roll_1" );

   // test_set_from_roll_2
   add_test_to_suite( p_suite, test_set_from_roll_2, "test_set_from_roll_2" );
