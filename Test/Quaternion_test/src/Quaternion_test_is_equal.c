/**
 @file Quaternion_test_is_equal.c
 @author Greg Lee
 @version 1.0.0
...
void test_is_equal_1( void )
{
   ...
   fq2 = f_quaternion_make( 10.0, 20.0, 30.0, 40.0 );

   CU_ASSERT( fq != NULL );
   CU_ASSERT( f_quaternion_is_equal( fq, fq1 ) == 1 );
   CU_ASSERT( f_quaternion_is_equal( fq, fq2 ) == 0 );
...
void test_is_equal_2( void )
{
   ...
   dq2 = d_quaternion_make( 10.0, 20.0, 30.0, 40.0 );

   CU_ASSERT( dq != NULL );
   CU_ASSERT( d_quaternion_is_equal( dq, dq1 ) == 1 );
   CU_ASSERT( d_quaternion_is_equal( dq, dq2 ) == 0 );
