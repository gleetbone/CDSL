...
/**
   test_make_from_roll_pitch_yaw_1
*/

void test_make_from_roll_pitch_yaw_1( void )
{
...
/**
   test_make_from_roll_pitch_yaw_2
*/
void test_make_from_roll_pitch_yaw_2( void )
{
...
add_test_make_from_roll_pitch_yaw( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_from_roll_pitch_yaw", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_from_roll_pitch_yaw_1
   add_test_to_suite( p_suite, test_make_from_roll_pitch_yaw_1, "test_make_from_roll_pitch_yaw_1" );

   // test_make_from_roll_pitch_yaw_2
   add_test_to_suite( p_suite, test_make_from_roll_pitch_yaw_2, "test_make_from_roll_pitch_yaw_2" );
