...
/**
   test_get_roll_pitch_yaw_degrees_1
*/

void test_get_roll_pitch_yaw_degrees_1( void )
{
   f_quaternion_t *fq = NULL;
   float32_t *array = NULL;

   fq = f_quaternion_make_default();
   array = f_quaternion_get_roll_pitch_yaw_degrees( fq );
   ...
   CU_ASSERT( fq != NULL );
   CU_ASSERT( array != NULL );
   CU_ASSERT( fabs( array[0] - 60.0 ) < 0.0001 );
...
/**
   test_get_roll_pitch_yaw_degrees_2
*/
void test_get_roll_pitch_yaw_degrees_2( void )
{
   d_quaternion_t *dq = NULL;
   float64_t *array = NULL;

   dq = d_quaternion_make_default();
   array = d_quaternion_get_roll_pitch_yaw_degrees( dq );
...
add_test_get_roll_pitch_yaw_degrees( void )
{
   ...
   p_suite = CU_add_suite("suite_test_get_roll_pitch_yaw_degrees", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_get_roll_pitch_yaw_degrees_1
   add_test_to_suite( p_suite, test_get_roll_pitch_yaw_degrees_1, "test_get_roll_pitch_yaw_degrees_1" );

   // test_get_roll_pitch_yaw_degrees_2
   add_test_to_suite( p_suite, test_get_roll_pitch_yaw_degrees_2, "test_get_roll_pitch_yaw_degrees_2" );
