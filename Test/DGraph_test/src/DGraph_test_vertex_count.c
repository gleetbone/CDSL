/**
 @file DGraph_test_vertex_count.c
 @author Greg Lee
 @version 2.0.0
...
add_test_vertex_count( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vertex_count", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vertex_count_1
   add_test_to_suite( p_suite, test_vertex_count_1, "test_vertex_count_1" );

   // test_vertex_count_2
   add_test_to_suite( p_suite, test_vertex_count_2, "test_vertex_count_2" );

   // test_vertex_count_3
   add_test_to_suite( p_suite, test_vertex_count_3, "test_vertex_count_3" );
