/**
 @file DGraph_test_connected_vertices_breadth_first.c
 @author Greg Lee
 @version 2.0.0
...
void test_connected_vertices_breadth_first_1( void )
{
   ...
   ip = ii_dgraph_connected_vertices_breadth_first( dgraph, v1, &count );
...
void test_connected_vertices_breadth_first_3( void )
{
   ...
   ip = ii_dgraph_connected_vertices_breadth_first( dgraph, v3, &count );
   CU_ASSERT( count == 3 );
...
void test_connected_vertices_breadth_first_4( void )
{
   ...
   ip = ii_dgraph_connected_vertices_breadth_first( dgraph, v2, &count );
   CU_ASSERT( count == 4 );
