...
add_test_edge_off( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_off", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_off_1
   add_test_to_suite( p_suite, test_edge_off_1, "test_edge_off_1" );

   // test_edge_off_2
   add_test_to_suite( p_suite, test_edge_off_2, "test_edge_off_2" );

   // test_edge_off_3
   add_test_to_suite( p_suite, test_edge_off_3, "test_edge_off_3" );
