/**
 @file DGraph_test_vertex_neighbors_from.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_vertex_neighbors_from_1
*/

void test_vertex_neighbors_from_1( void )
{
   ...
   ip = ii_dgraph_vertex_neighbors_from( dgraph, v2, &count );
...
/**
   test_vertex_neighbors_from_2
*/

void test_vertex_neighbors_from_2( void )
{
   ii_dgraph_t *dgraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   e1 = ii_dgraph_edge_add( dgraph, v1, v5, 2 );
   e2 = ii_dgraph_edge_add( dgraph, v2, v5, 3 );
   e3 = ii_dgraph_edge_add( dgraph, v3, v5, 5 );
   e4 = ii_dgraph_edge_add( dgraph, v4, v5, 7 );
   
   CU_ASSERT( ii_dgraph_edge_count( dgraph ) == 4 );
  
   ip = ii_dgraph_vertex_neighbors_from( dgraph, v5, &count );
...
/**
   test_vertex_neighbors_from_3
*/

void test_vertex_neighbors_from_3( void )
{
   ii_dgraph_t *dgraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   e1 = ii_dgraph_edge_add( dgraph, v1, v5, 2 );
   e2 = ii_dgraph_edge_add( dgraph, v3, v5, 3 );
...
add_test_vertex_neighbors_from( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vertex_neighbors_from", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vertex_neighbors_from_1
   add_test_to_suite( p_suite, test_vertex_neighbors_from_1, "test_vertex_neighbors_from_1" );

   // test_vertex_neighbors_from_2
   add_test_to_suite( p_suite, test_vertex_neighbors_from_2, "test_vertex_neighbors_from_2" );

   // test_vertex_neighbors_from_3
   add_test_to_suite( p_suite, test_vertex_neighbors_from_3, "test_vertex_neighbors_from_3" );
