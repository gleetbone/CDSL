/**
 @file DGraph_test_vertex_remove_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_vertex_remove_and_dispose_1( void )
{
   ...
   ii_dgraph_vertex_remove_and_dispose( dgraph, v );
...
void test_vertex_remove_and_dispose_2( void )
{
   ...
   ii_dgraph_vertex_remove_and_dispose( dgraph, v1 );
   ii_dgraph_vertex_remove_and_dispose( dgraph, v2 );
   ii_dgraph_vertex_remove_and_dispose( dgraph, v3 );
   ii_dgraph_vertex_remove_and_dispose( dgraph, v4 );
   ii_dgraph_vertex_remove_and_dispose( dgraph, v5 );
...
void test_vertex_remove_and_dispose_4( void )
{
   ...
   ss_dgraph_vertex_remove_and_dispose( dgraph, v1 );
