...
void test_edge_id_at_1( void )
{
   ...
   CU_ASSERT( ii_dgraph_edge_id_at( dgraph ) == e );
   
   ii_dgraph_edge_forth( dgraph );
...
void test_edge_id_at_2( void )
{
   ...
   ii_dgraph_edge_start( dgraph );
   CU_ASSERT( ii_dgraph_edge_off( dgraph ) == 0 );
   CU_ASSERT( ii_dgraph_edge_id_at( dgraph ) == e1 );
   
   ii_dgraph_edge_forth( dgraph );
   CU_ASSERT( ii_dgraph_edge_off( dgraph ) == 0 );
   CU_ASSERT( ii_dgraph_edge_id_at( dgraph ) == e2 );
   
   ii_dgraph_edge_forth( dgraph );
   CU_ASSERT( ii_dgraph_edge_off( dgraph ) == 0 );
   CU_ASSERT( ii_dgraph_edge_id_at( dgraph ) == e3 );
   
   ii_dgraph_edge_forth( dgraph );
   CU_ASSERT( ii_dgraph_edge_off( dgraph ) == 0 );
   CU_ASSERT( ii_dgraph_edge_id_at( dgraph ) == e4 );
...
add_test_edge_id_at( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_id_at", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_id_at_1
   add_test_to_suite( p_suite, test_edge_id_at_1, "test_edge_id_at_1" );

   // test_edge_id_at_2
   add_test_to_suite( p_suite, test_edge_id_at_2, "test_edge_id_at_2" );

   // test_edge_id_at_3
   add_test_to_suite( p_suite, test_edge_id_at_3, "test_edge_id_at_3" );
