/**
 @file DGraph_test_make_breadth.c
 @author Greg Lee
 @version 1.0.0
 ...
 Unit tests for DGraph_make_breadth.
...
add_test_make_breadth( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_breadth", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_1
   add_test_to_suite( p_suite, test_make_breadth_1, "test_make_breadth_1" );
