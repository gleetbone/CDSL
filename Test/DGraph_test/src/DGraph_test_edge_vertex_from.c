/**
 @file DGraph_test_edge_vertex_from.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_edge_vertex_from_1
*/

void test_edge_vertex_from_1( void )
{
   ...
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e ) == v1 );
...
/**
   test_edge_vertex_from_2
*/

void test_edge_vertex_from_2( void )
{
   ii_dgraph_t *dgraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e1 ) == v1 );
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e2 ) == v2 );
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e3 ) == v3 );
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e4 ) == v4 );
...
/**
   test_edge_vertex_from_3
*/

void test_edge_vertex_from_3( void )
{
   ii_dgraph_t *dgraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e1 ) == v1 );
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e2 ) == v3 );
   CU_ASSERT( ii_dgraph_edge_vertex_from( dgraph, e3 ) == v4 );
...
add_test_edge_vertex_from( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_vertex_from", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_vertex_from_1
   add_test_to_suite( p_suite, test_edge_vertex_from_1, "test_edge_vertex_from_1" );

   // test_edge_vertex_from_2
   add_test_to_suite( p_suite, test_edge_vertex_from_2, "test_edge_vertex_from_2" );

   // test_edge_vertex_from_3
   add_test_to_suite( p_suite, test_edge_vertex_from_3, "test_edge_vertex_from_3" );
