/**
 @file DGraph_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   dgraph1 = ii_dgraph_deep_clone( dgraph );
  
   CU_ASSERT( dgraph1 != NULL );
   CU_ASSERT( ii_dgraph_vertex_count( dgraph1 ) == 0 );

   CU_ASSERT( ii_dgraph_is_deep_equal( dgraph, dgraph1 ) == 1 );
...
void test_is_deep_equal_2( void )
{
   ...
   CU_ASSERT( ii_dgraph_is_deep_equal( dgraph, dgraph1 ) == 1 );
   CU_ASSERT( ii_dgraph_is_deep_equal( dgraph, dgraph2 ) == 0 );
...
void test_is_deep_equal_3( void )
{
   ...
   CU_ASSERT( ii_dgraph_is_deep_equal( dgraph, dgraph1 ) == 0 );
...
void test_is_deep_equal_4( void )
{
   ...
   CU_ASSERT( ii_dgraph_is_deep_equal( dgraph, dgraph1 ) == 0 );
   CU_ASSERT( ii_dgraph_is_deep_equal( dgraph1, dgraph ) == 0 );
