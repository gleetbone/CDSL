/**
 @file DGraph_test_edge_remove_from_to.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_edge_remove_from_to_1
*/

void test_edge_remove_from_to_1( void )
{
   ...
   ii_dgraph_edge_remove_from_to( dgraph, v_from, v_to );
...
add_test_edge_remove_from_to( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_remove_from_to", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_remove_from_to_1
   add_test_to_suite( p_suite, test_edge_remove_from_to_1, "test_edge_remove_from_to_1" );
