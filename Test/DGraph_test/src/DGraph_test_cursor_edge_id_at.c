/**
 @file DGraph_test_cursor_edge_id_at.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_cursor_edge_id_at_1
*/

void test_cursor_edge_id_at_1( void )
{
   ...
   CU_ASSERT( ii_dgraph_cursor_edge_id_at( cursor ) == e );
   
   ii_dgraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_dgraph_cursor_edge_off( cursor ) == 1 );
...
/**
   test_cursor_edge_id_at_2
*/

void test_cursor_edge_id_at_2( void )
{
   ii_dgraph_t *dgraph = NULL;
   ii_dgraph_cursor_t *cursor = NULL;
   int32_t v1 = 0;
   ...
   ii_dgraph_cursor_edge_start( cursor );
   CU_ASSERT( ii_dgraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_dgraph_cursor_edge_id_at( cursor ) == e1 );
   
   ii_dgraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_dgraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_dgraph_cursor_edge_id_at( cursor ) == e2 );
   
   ii_dgraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_dgraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_dgraph_cursor_edge_id_at( cursor ) == e3 );
   
   ii_dgraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_dgraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_dgraph_cursor_edge_id_at( cursor ) == e4 );
...
/**
   test_cursor_edge_id_at_3
*/

void test_cursor_edge_id_at_3( void )
{
   ii_dgraph_t *dgraph = NULL;
   ii_dgraph_cursor_t *cursor = NULL;
   int32_t v1 = 0;
   ...
   ii_dgraph_edge_remove( dgraph, e2 );
...
add_test_cursor_edge_id_at( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_edge_id_at", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_edge_id_at_1
   add_test_to_suite( p_suite, test_cursor_edge_id_at_1, "test_cursor_edge_id_at_1" );

   // test_cursor_edge_id_at_2
   add_test_to_suite( p_suite, test_cursor_edge_id_at_2, "test_cursor_edge_id_at_2" );

   // test_cursor_edge_id_at_3
   add_test_to_suite( p_suite, test_cursor_edge_id_at_3, "test_cursor_edge_id_at_3" );
