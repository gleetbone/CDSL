/**
 @file DGraph_test_cursor_edge_forth.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_cursor_edge_forth_1
*/

void test_cursor_edge_forth_1( void )
{
...
/**
   test_cursor_edge_forth_2
*/

void test_cursor_edge_forth_2( void )
{
   ii_dgraph_t *dgraph = NULL;
   ii_dgraph_cursor_t *cursor = NULL;
   int32_t v1 = 0;
...
/**
   test_cursor_edge_forth_3
*/

void test_cursor_edge_forth_3( void )
{
   ii_dgraph_t *dgraph = NULL;
   ii_dgraph_cursor_t *cursor = NULL;
   int32_t v1 = 0;
...
add_test_cursor_edge_forth( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_edge_forth", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_edge_forth_1
   add_test_to_suite( p_suite, test_cursor_edge_forth_1, "test_cursor_edge_forth_1" );

   // test_cursor_edge_forth_2
   add_test_to_suite( p_suite, test_cursor_edge_forth_2, "test_cursor_edge_forth_2" );

   // test_cursor_edge_forth_3
   add_test_to_suite( p_suite, test_cursor_edge_forth_3, "test_cursor_edge_forth_3" );
