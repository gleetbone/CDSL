/**
 @file DGraph_test_edge_is_empty.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_edge_is_empty_1
*/

void test_edge_is_empty_1( void )
{
   ...
   flag1 = ii_dgraph_edge_is_empty( dgraph );

   ii_dgraph_edge_put( dgraph, 23, v_from, v_to );

   flag2 = ii_dgraph_edge_is_empty( dgraph );
...
add_test_edge_is_empty( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_is_empty", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_is_empty_1
   add_test_to_suite( p_suite, test_edge_is_empty_1, "test_edge_is_empty_1" );
