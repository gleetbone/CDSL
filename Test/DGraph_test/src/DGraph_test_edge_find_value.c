/**
 @file DGraph_test_edge_find_value.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_edge_find_value_1
*/

void test_edge_find_value_1( void )
{
   ...
   edge = ii_dgraph_edge_find_value( dgraph, 29 );
   CU_ASSERT( edge == NULL );
...
add_test_edge_find_value( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_find_value", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_find_value_1
   add_test_to_suite( p_suite, test_edge_find_value_1, "test_edge_find_value_1" );
