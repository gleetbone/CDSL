/**
 @file DGraph_test_edge_remove_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_edge_remove_and_dispose_1
*/

void test_edge_remove_and_dispose_1( void )
{
   ...
   ii_dgraph_edge_remove_and_dispose( dgraph, e );
...
/**
   test_edge_remove_and_dispose_2
*/

void test_edge_remove_and_dispose_2( void )
{
   ii_dgraph_t *dgraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   ii_dgraph_edge_remove_and_dispose( dgraph, e1 );
   ii_dgraph_edge_remove_and_dispose( dgraph, e2 );
   ii_dgraph_edge_remove_and_dispose( dgraph, e3 );
   ii_dgraph_edge_remove_and_dispose( dgraph, e4 );
...
/**
   test_edge_remove_and_dispose_3
*/

void test_edge_remove_and_dispose_3( void )
{
   ii_dgraph_t *dgraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
...
/**
   test_edge_remove_and_dispose_4
*/

void test_edge_remove_and_dispose_4( void )
{
   ...
   CU_ASSERT( ss_dgraph_vertex_count( dgraph ) == 2 );
   CU_ASSERT( ss_dgraph_edge_count( dgraph ) == 1 );
   
   ss_dgraph_edge_remove_and_dispose( dgraph, e );
   
   CU_ASSERT( ss_dgraph_edge_count( dgraph ) == 0 );
...
add_test_edge_remove_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_remove_and_dispose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_remove_and_dispose_1
   add_test_to_suite( p_suite, test_edge_remove_and_dispose_1, "test_edge_remove_and_dispose_1" );

   // test_edge_remove_and_dispose_2
   add_test_to_suite( p_suite, test_edge_remove_and_dispose_2, "test_edge_remove_and_dispose_2" );

   // test_edge_remove_and_dispose_3
   add_test_to_suite( p_suite, test_edge_remove_and_dispose_3, "test_edge_remove_and_dispose_3" );

   // test_edge_remove_and_dispose_4
   add_test_to_suite( p_suite, test_edge_remove_and_dispose_4, "test_edge_remove_and_dispose_4" );
