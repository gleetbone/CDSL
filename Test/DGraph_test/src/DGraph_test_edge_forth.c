...
add_test_edge_forth( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_forth", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_forth_1
   add_test_to_suite( p_suite, test_edge_forth_1, "test_edge_forth_1" );

   // test_edge_forth_2
   add_test_to_suite( p_suite, test_edge_forth_2, "test_edge_forth_2" );

   // test_edge_forth_3
   add_test_to_suite( p_suite, test_edge_forth_3, "test_edge_forth_3" );
