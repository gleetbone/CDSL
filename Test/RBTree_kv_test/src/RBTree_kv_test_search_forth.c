/**
 @file RBTree_kv_test_search_forth.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_forth_1( void )
{
   ...
   ii_rbtree_kv_search_forth( rbtree, 1 );
...
void test_search_forth_2( void )
{
   ...
   ii_rbtree_kv_start( rbtree );
   ii_rbtree_kv_search_forth( rbtree, 10 );
...
void test_search_forth_3( void )
{
   ...
   ii_rbtree_kv_start( rbtree );
   ii_rbtree_kv_search_forth( rbtree, 20 );
   CU_ASSERT( ii_rbtree_kv_off( rbtree ) == 0 );
...
void test_search_forth_5( void )
{
   ...
   ss_rbtree_kv_search_forth( rbtree, s20 );
