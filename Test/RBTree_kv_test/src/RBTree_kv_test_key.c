...
void test_key_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 0 ) == 1 );
...
void test_key_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 0 ) == 1 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 1 ) == 2 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 2 ) == 3 );
...
void test_key_5( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 0 ) == 1 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 1 ) == 2 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 2 ) == 4 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 3 ) == 6 );
...
void test_key_6( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 0 ) == 2 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 1 ) == 3 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 2 ) == 4 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 3 ) == 6 );
...
void test_key_7( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 0 ) == 2 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 1 ) == 4 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 2 ) == 5 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 3 ) == 6 );
...
void test_key_8( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 0 ) == 2 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 1 ) == 4 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 2 ) == 6 );
   CU_ASSERT( ii_rbtree_kv_key( rbtree, 3 ) == 7 );
...
void test_key_9( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_key( rbtree, 0 ) == s2 );
   CU_ASSERT( ss_rbtree_kv_key( rbtree, 1 ) == s4 );
   CU_ASSERT( ss_rbtree_kv_key( rbtree, 2 ) == s6 );
   CU_ASSERT( ss_rbtree_kv_key( rbtree, 3 ) == s7 );
