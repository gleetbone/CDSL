...
void test_cursor_is_first_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_cursor_is_first( cursor ) == 0 );
...
void test_cursor_is_first_1a( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_cursor_is_first( cursor ) == 1 );
...
void test_cursor_is_first_7( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_cursor_is_first( cursor ) == 1 );
 
   ss_rbtree_kv_cursor_finish( cursor );
   
   CU_ASSERT( ss_rbtree_kv_cursor_is_first( cursor ) == 0 );
