/**
 @file RBTree_kv_test_key_search_back_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_key_search_back_eq_fn_1( void )
{
   ...
   ii_rbtree_kv_key_search_back_eq_fn( rbtree, 1, is_equal_int );
...
void test_key_search_back_eq_fn_3( void )
{
   ...
   ii_rbtree_kv_finish( rbtree );
   ii_rbtree_kv_key_search_back_eq_fn( rbtree, 2, is_equal_int );
   CU_ASSERT( ii_rbtree_kv_off( rbtree ) == 0 );
...
void test_key_search_back_eq_fn_5( void )
{
   ...
   ss_rbtree_kv_key_search_back_eq_fn( rbtree, s2, is_equal_s );
