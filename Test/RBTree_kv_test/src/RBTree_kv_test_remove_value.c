...
void test_remove_value_1( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 10 );
...
void test_remove_value_2( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 20 );
...
void test_remove_value_2b( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 30 );
...
void test_remove_value_5( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 40 );
...
void test_remove_value_5d( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 50 );
...
void test_remove_value_5e( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 60 );
...
void test_remove_value_5f( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 70 );
...
void test_remove_value_6b( void )
{
   ...
   ii_rbtree_kv_remove_value( rbtree, 80 );
...
void test_remove_value_7( void )
{
   ...
   ss_rbtree_kv_remove_value( rbtree, s10 );
