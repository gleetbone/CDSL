...
add_test_cursor_off( void )
{
   ...
   // test_cursor_off_4
   add_test_to_suite( p_suite, test_cursor_off_4, "test_cursor_off_4" );

   // test_cursor_off_5
   add_test_to_suite( p_suite, test_cursor_off_5, "test_cursor_off_5" );

   // test_cursor_off_6
   add_test_to_suite( p_suite, test_cursor_off_6, "test_cursor_off_6" );

   // test_cursor_off_7
   add_test_to_suite( p_suite, test_cursor_off_7, "test_cursor_off_7" );
