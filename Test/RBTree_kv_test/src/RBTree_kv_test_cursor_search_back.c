/**
 @file RBTree_kv_test_cursor_search_back.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_back_1( void )
{
   ...
   ii_rbtree_kv_cursor_search_back( cursor, 1 );
...
void test_cursor_search_back_2( void )
{
   ...
   ii_rbtree_kv_cursor_search_back( cursor, 10 );
...
void test_cursor_search_back_3( void )
{
   ...
   ii_rbtree_kv_cursor_finish( cursor );
   ii_rbtree_kv_cursor_search_back( cursor, 20 );
   CU_ASSERT( ii_rbtree_kv_cursor_off( cursor ) == 0 );
...
void test_cursor_search_back_5( void )
{
   ...
   ss_rbtree_kv_cursor_search_back( cursor, s20 );
