/**
 @file RBTree_kv_test_search_back.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_back_1( void )
{
   ...
   ii_rbtree_kv_search_back( rbtree, 1 );
...
void test_search_back_2( void )
{
   ...
   ii_rbtree_kv_search_back( rbtree, 10 );
...
void test_search_back_3( void )
{
   ...
   ii_rbtree_kv_finish( rbtree );
   ii_rbtree_kv_search_back( rbtree, 20 );
   CU_ASSERT( ii_rbtree_kv_off( rbtree ) == 0 );
...
void test_search_back_5( void )
{
   ...
   ss_rbtree_kv_search_back( rbtree, s20 );
