...
void test_is_first_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_is_first( rbtree ) == 0 );
...
void test_is_first_1a( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_is_first( rbtree ) == 1 );
...
void test_is_first_7( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_is_first( rbtree ) == 1 );
 
   ss_rbtree_kv_finish( rbtree );
   
   CU_ASSERT( ss_rbtree_kv_is_first( rbtree ) == 0 );
