...
void test_remove_value_and_dispose_1( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 10 );
...
void test_remove_value_and_dispose_2( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 20 );
...
void test_remove_value_and_dispose_2b( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 30 );
...
void test_remove_value_and_dispose_5( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 40 );
...
void test_remove_value_and_dispose_5d( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 50 );
...
void test_remove_value_and_dispose_5e( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 60 );
...
void test_remove_value_and_dispose_5f( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 70 );
...
void test_remove_value_and_dispose_6b( void )
{
   ...
   ii_rbtree_kv_remove_value_and_dispose( rbtree, 80 );
...
void test_remove_value_and_dispose_7( void )
{
   ...
   ss_rbtree_kv_remove_value_and_dispose( rbtree, s10 );
