...
void test_has_value_1( void )
{
   ...
   result = ii_rbtree_kv_has_value( rbtree, 10 );
   CU_ASSERT( result == 1 );
 
   result = ii_rbtree_kv_has_value( rbtree, 0 );
   CU_ASSERT( result == 0 );
...
void test_has_value_2( void )
{
   ...
   result = ii_rbtree_kv_has_value( rbtree, 20 );
   CU_ASSERT( result == 1 );
 
   result = ii_rbtree_kv_has_value( rbtree, 10 );
   CU_ASSERT( result == 1 );
 
   result = ii_rbtree_kv_has_value( rbtree, 30 );
   CU_ASSERT( result == 1 );
...
void test_has_value_5( void )
{
   ...
   result = ii_rbtree_kv_has_value( rbtree, 40 );
   CU_ASSERT( result == 1 );
 
   result = ii_rbtree_kv_has_value( rbtree, 20 );
   CU_ASSERT( result == 1 );
 
   result = ii_rbtree_kv_has_value( rbtree, 60 );
   CU_ASSERT( result == 1 );
...
void test_has_value_7( void )
{
   ...
   result = ii_rbtree_kv_has_value( rbtree, 50 );
   CU_ASSERT( result == 1 );
...
void test_has_value_8( void )
{
   ...
   result = ii_rbtree_kv_has_value( rbtree, 70 );
   CU_ASSERT( result == 1 );
...
void test_has_value_9( void )
{
   ...
   result = ss_rbtree_kv_has_value( rbtree, s40 );
   CU_ASSERT( result == 1 );
 
   result = ss_rbtree_kv_has_value( rbtree, s20 );
   CU_ASSERT( result == 1 );
 
   result = ss_rbtree_kv_has_value( rbtree, s60 );
   CU_ASSERT( result == 1 );
 
   result = ss_rbtree_kv_has_value( rbtree, s70 );
   CU_ASSERT( result == 1 );
 
   result = ss_rbtree_kv_has_value( rbtree, s00 );
   CU_ASSERT( result == 0 );
...
add_test_has_value( void )
{
   ...
   // test_has_value_9
   add_test_to_suite( p_suite, test_has_value_9, "test_has_value_9" );
