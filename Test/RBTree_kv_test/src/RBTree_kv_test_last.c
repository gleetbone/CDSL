...
void test_last_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_last( rbtree ) == 10 );
...
void test_last_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_last( rbtree ) == 30 );
...
void test_last_5( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_last( rbtree ) == 60 );
...
void test_last_8( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_last( rbtree ) == 70 );
...
void test_last_9( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_last( rbtree ) == s70 );
