/**
 @file RBTree_test_cursor_is_last.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_is_last_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_cursor_is_last( cursor ) == 0 );
...
void test_cursor_is_last_1a( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_cursor_is_last( cursor ) == 1 );
...
void test_cursor_is_last_7( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_cursor_is_last( cursor ) == 0 );
 
   ss_rbtree_kv_cursor_finish( cursor );
   
   CU_ASSERT( ss_rbtree_kv_cursor_is_last( cursor ) == 1 );
