...
void test_item_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 0 ) == 10 );
...
void test_item_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 0 ) == 10 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 1 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 2 ) == 30 );
...
void test_item_5( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 0 ) == 10 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 1 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 2 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 3 ) == 60 );
...
void test_item_6( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 0 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 1 ) == 30 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 2 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 3 ) == 60 );
...
void test_item_7( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 0 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 1 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 2 ) == 50 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 3 ) == 60 );
...
void test_item_8( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 0 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 1 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 2 ) == 60 );
   CU_ASSERT( ii_rbtree_kv_item( rbtree, 3 ) == 70 );
...
void test_item_9( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_item( rbtree, 0 ) == s20 );
   CU_ASSERT( ss_rbtree_kv_item( rbtree, 1 ) == s40 );
   CU_ASSERT( ss_rbtree_kv_item( rbtree, 2 ) == s60 );
   CU_ASSERT( ss_rbtree_kv_item( rbtree, 3 ) == s70 );
