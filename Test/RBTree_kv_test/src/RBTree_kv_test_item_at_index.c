...
void test_item_at_index_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 0 ) == 10 );
...
void test_item_at_index_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 0 ) == 10 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 1 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 2 ) == 30 );
...
void test_item_at_index_5( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 0 ) == 10 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 1 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 2 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 3 ) == 60 );
...
void test_item_at_index_6( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 0 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 1 ) == 30 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 2 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 3 ) == 60 );
...
void test_item_at_index_7( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 0 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 1 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 2 ) == 50 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 3 ) == 60 );
...
void test_item_at_index_8( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 0 ) == 20 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 1 ) == 40 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 2 ) == 60 );
   CU_ASSERT( ii_rbtree_kv_item_at_index( rbtree, 3 ) == 70 );
