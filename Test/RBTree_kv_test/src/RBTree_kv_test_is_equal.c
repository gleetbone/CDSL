...
void test_is_equal_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_is_equal( rbtree1, rbtree ) == 1 );
...
void test_is_equal_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_is_equal( rbtree, rbtree1 ) == 1 );
...
void test_is_equal_3( void )
{
   ...
   ss_rbtree_kv_put( rbtree1, s10, s1 );
   
   CU_ASSERT( ss_rbtree_kv_is_equal( rbtree, rbtree1 ) == 1 );
...
void test_is_equal_4( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_is_equal( rbtree, rbtree1 ) == 0 );
   CU_ASSERT( ss_rbtree_kv_is_deep_equal( rbtree, rbtree1 ) == 1 );
