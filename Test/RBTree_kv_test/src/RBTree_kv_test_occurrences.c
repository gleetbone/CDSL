...
void test_occurrences_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_occurrences( rbtree, 1 ) == 0 );
...
void test_occurrences_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_occurrences( rbtree, 1 ) == 1 );
...
void test_occurrences_3( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_occurrences( rbtree, 1 ) == 1 );
   CU_ASSERT( ii_rbtree_kv_occurrences( rbtree, 2 ) == 2 );
   CU_ASSERT( ii_rbtree_kv_occurrences( rbtree, 3 ) == 1 );
...
void test_occurrences_4( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_occurrences( rbtree, s1 ) == 1 );
   CU_ASSERT( ss_rbtree_kv_occurrences( rbtree, s2 ) == 2 );
   CU_ASSERT( ss_rbtree_kv_occurrences( rbtree, s3 ) == 1 );
