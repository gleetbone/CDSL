...
void test_occurrences_eq_fn_1( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_occurrences_eq_fn( rbtree, 1, is_equal_int ) == 0 );
...
void test_occurrences_eq_fn_2( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_occurrences_eq_fn( rbtree, 1, is_equal_int ) == 1 );
...
void test_occurrences_eq_fn_3( void )
{
   ...
   CU_ASSERT( ii_rbtree_kv_occurrences_eq_fn( rbtree, 1, is_equal_int ) == 1 );
   CU_ASSERT( ii_rbtree_kv_occurrences_eq_fn( rbtree, 2, is_equal_int ) == 2 );
   CU_ASSERT( ii_rbtree_kv_occurrences_eq_fn( rbtree, 3, is_equal_int ) == 1 );
...
void test_occurrences_eq_fn_4( void )
{
   ...
   CU_ASSERT( ss_rbtree_kv_occurrences_eq_fn( rbtree, s1, is_equal_s ) == 1 );
   CU_ASSERT( ss_rbtree_kv_occurrences_eq_fn( rbtree, s2, is_equal_s ) == 2 );
   CU_ASSERT( ss_rbtree_kv_occurrences_eq_fn( rbtree, s3, is_equal_s ) == 1 );
