/**
 @file RBTree_test_remove_by_index.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_by_index_1( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 0 );
...
void test_remove_by_index_2( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 1 );
...
void test_remove_by_index_2b( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 2 );
...
void test_remove_by_index_5( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 3 );
...
void test_remove_by_index_5d( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 4 );
...
void test_remove_by_index_5e( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 5 );
...
void test_remove_by_index_5f( void )
{
   ...
   ii_rbtree_kv_remove_by_index( rbtree, 6 );
...
void test_remove_by_index_7( void )
{
   ...
   ss_rbtree_kv_remove_by_index( rbtree, 0 );
