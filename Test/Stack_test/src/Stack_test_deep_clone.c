/**
 @file Stack_test_deep_clone.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for Stack_deep_clone"
 ...
 Unit tests for Stack_deep_clone.
...
void test_deep_clone_1( void )
{
   ...
   int_stack_t *list_1 = int_stack_deep_clone( list );
...
void test_deep_clone_2a( void )
{
   ...
   CU_ASSERT( list_1 != NULL );
   CU_ASSERT( int_stack_count( list_1 ) == 2 );
   CU_ASSERT( int_stack_is_empty( list_1 ) == 0 );
...
add_test_deep_clone( void )
{
   ...
   // test_deep_clone_2a
   add_test_to_suite( p_suite, test_deep_clone_2a, "test_deep_clone_2a" );
