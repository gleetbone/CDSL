/**
 @file Stack_test_prune_and_dispose.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for Stack_prune_and_dispose"
 ...
 Unit tests for Stack_prune_and_dispose.
...
void test_prune_and_dispose_1( void )
{
   ...
   int_stack_prune_and_dispose( stack, 1 );
...
void test_prune_and_dispose_3( void )
{
   ...
   int_stack_prune_and_dispose( stack, 2 );
...
void test_prune_and_dispose_4( void )
{
   ...
   s_stack_prune_and_dispose( stack, 2 );
