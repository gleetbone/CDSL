/**
 @file Stack_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for Stack_deep_equal"
 ...
 Unit tests for Stack_deep_equal.
...
void test_is_deep_equal_3( void )
{
   ...
   CU_ASSERT( int_stack_is_deep_equal( list, list1 ) == 0 );
...
void test_is_deep_equal_5( void )
{
   ...
   CU_ASSERT( s_stack_is_deep_equal( list, list2 ) == 1 );
