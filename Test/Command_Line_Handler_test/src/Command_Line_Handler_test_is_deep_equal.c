/**
 @file command_line_handler_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   command_line_handler1 = command_line_handler_deep_clone( command_line_handler );
   CU_ASSERT( command_line_handler1 != NULL );
   
   CU_ASSERT( command_line_handler_is_deep_equal( command_line_handler, command_line_handler ) == 1 );
   CU_ASSERT( command_line_handler_is_deep_equal( command_line_handler, command_line_handler1 ) == 1 );
   
   command_line_handler_deep_dispose( &command_line_handler1 );
