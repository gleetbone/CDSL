/**
 @file command_line_handler_test_help_string.c
 @author Greg Lee
 @version 2.0.0
...
void test_help_string_1( void )
{
   ...
   s = command_line_handler_help_string( command_line_handler);
   CU_ASSERT( string_is_equal( s, help_string ) == 1 );
...
add_test_help_string( void )
{
   ...
   p_suite = CU_add_suite("suite_test_help_string", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_help_string_1
   add_test_to_suite( p_suite, test_help_string_1, "test_help_string_1" );
