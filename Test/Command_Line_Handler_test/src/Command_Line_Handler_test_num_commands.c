/**
 @file command_line_handler_test_num_commands.c
 @author Greg Lee
 @version 2.0.0
...
void test_num_commands_1( void )
{
   ...
   CU_ASSERT( command_line_handler_num_commands( command_line_handler ) == 1 );
...
add_test_num_commands( void )
{
   ...
   p_suite = CU_add_suite("suite_test_num_commands", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_num_commands_1
   add_test_to_suite( p_suite, test_num_commands_1, "test_num_commands_1" );
