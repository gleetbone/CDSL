/**
 @file command_line_handler_test_option_item.c
 @author Greg Lee
 @version 2.0.0
...
void test_option_item_1( void )
{
   ...
   protocol_base_t *p_option1 = NULL;
   ...
   p_option1 = command_line_handler_option_item( command_line_handler, 0 );
   CU_ASSERT( p_option1 == p_option );
...
add_test_option_item( void )
{
   ...
   p_suite = CU_add_suite("suite_test_option_item", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_option_item_1
   add_test_to_suite( p_suite, test_option_item_1, "test_option_item_1" );
