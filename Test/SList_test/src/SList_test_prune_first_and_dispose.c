/**
 @file SList_test_prune_first_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_prune_first_and_dispose_1( void )
{
   ...
   int_slist_prune_first_and_dispose( list, 1 );
...
void test_prune_first_and_dispose_3( void )
{
   ...
   int_slist_prune_first_and_dispose( list, 2 );
...
void test_prune_first_and_dispose_6( void )
{
   ...
   int_slist_prune_first_and_dispose( list, 3 );
...
/**
   test_prune_first_and_dispose_7
*/

void test_prune_first_and_dispose_7( void )
{
   s_slist_t *list = NULL;
   ...
   s_slist_prune_first_and_dispose( list, 2 );
...
add_test_prune_first_and_dispose( void )
{
   ...
   // test_prune_first_and_dispose_7
   add_test_to_suite( p_suite, test_prune_first_and_dispose_7, "test_prune_first_and_dispose_7" );
