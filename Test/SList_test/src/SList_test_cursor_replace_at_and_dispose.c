/**
 @file SList_test_cursor_replace_at_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_replace_at_and_dispose_1( void )
{
   ...
   int_slist_cursor_replace_at_and_dispose( cursor, 25 );
...
void test_cursor_replace_at_and_dispose_2( void )
{
   ...
   int_slist_cursor_replace_at_and_dispose( cursor, 8 );

   int_slist_cursor_go( cursor, 1 );

   int_slist_cursor_replace_at_and_dispose( cursor, 14 );
...
void test_cursor_replace_at_and_dispose_3( void )
{
   ...
   s_slist_cursor_replace_at_and_dispose( cursor, s6 );

   s_slist_cursor_go( cursor, 1 );

   s_slist_cursor_replace_at_and_dispose( cursor, s5 );

   s_slist_cursor_go( cursor, 0 );

   s_slist_cursor_replace_at_and_dispose( cursor, s4 );
