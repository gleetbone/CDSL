...
void test_is_first_1( void )
{
   ...
   CU_ASSERT( int_slist_is_first( list ) == 1 );

   int_slist_forth( list );

   CU_ASSERT( int_slist_is_first( list ) == 0 );
...
void test_is_first_2( void )
{
   ...
   CU_ASSERT( s_slist_is_first( list ) == 1 );

   s_slist_forth( list );

   CU_ASSERT( s_slist_is_first( list ) == 0 );
