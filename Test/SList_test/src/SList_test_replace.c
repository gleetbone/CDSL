...
void test_replace_2( void )
{
   ...
   int_slist_replace( list, 25, 0 );
   int_slist_replace( list, 14, 1 );
   int_slist_replace( list, 8, 2 );
...
void test_replace_3( void )
{
   ...
   s_slist_replace( list, s4, 0 );
   s_slist_replace( list, s5, 1 );
   s_slist_replace( list, s6, 2 );
