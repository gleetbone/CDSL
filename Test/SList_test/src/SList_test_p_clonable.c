/**
 @file SList_test_p_clonable.c
 @author Greg Lee
 @version 1.0.0
 @brief: "tests for SList P_Clonable"
...
void test_p_clonable_1( void )
{
   ...
   CU_ASSERT( i_clonable_dispose_f( pb_list ) == int_slist_dispose );
...
void test_p_clonable_2( void )
{
   ...
   CU_ASSERT( i_clonable_dispose_with_contents_f( pb_list ) == int_slist_dispose_with_contents );
...
void test_p_clonable_3( void )
{
   ...
   CU_ASSERT( i_clonable_clone_f( pb_list ) == int_slist_make_from );
...
void test_p_clonable_4( void )
{
   ...
   CU_ASSERT( i_clonable_deep_clone_f( pb_list ) == int_slist_make_duplicate_from );
