/**
 @file SList_test_keep_first_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_keep_first_and_dispose_1( void )
{
   ...
   int_slist_keep_first_and_dispose( list, 1 );
...
void test_keep_first_and_dispose_2( void )
{
   ...
   int_slist_keep_first_and_dispose( list, 0 );
...
/**
   test_keep_first_and_dispose_4
*/

void test_keep_first_and_dispose_4( void )
{
   int_slist_t *list = NULL;
   ...
   int_slist_keep_first_and_dispose( list, 2 );
...
/**
   test_keep_first_and_dispose_5
*/

void test_keep_first_and_dispose_5( void )
{
   int_slist_t *list = NULL;
...
/**
   test_keep_first_and_dispose_6
*/

void test_keep_first_and_dispose_6( void )
{
   int_slist_t *list = NULL;
...
/**
   test_keep_first_and_dispose_7
*/

void test_keep_first_and_dispose_7( void )
{
   int_slist_t *list = NULL;
   ...
   int_slist_keep_first_and_dispose( list, 3 );
...
/**
   test_keep_first_and_dispose_8
*/

void test_keep_first_and_dispose_8( void )
{
   s_slist_t *list = NULL;
   ...
   s_slist_keep_first_and_dispose( list, 2 );
...
add_test_keep_first_and_dispose( void )
{
   ...
   // test_keep_first_and_dispose_4
   add_test_to_suite( p_suite, test_keep_first_and_dispose_4, "test_keep_first_and_dispose_4" );

   // test_keep_first_and_dispose_5
   add_test_to_suite( p_suite, test_keep_first_and_dispose_5, "test_keep_first_and_dispose_5" );

   // test_keep_first_and_dispose_6
   add_test_to_suite( p_suite, test_keep_first_and_dispose_6, "test_keep_first_and_dispose_6" );

   // test_keep_first_and_dispose_7
   add_test_to_suite( p_suite, test_keep_first_and_dispose_7, "test_keep_first_and_dispose_7" );

   // test_keep_first_and_dispose_8
   add_test_to_suite( p_suite, test_keep_first_and_dispose_8, "test_keep_first_and_dispose_8" );
