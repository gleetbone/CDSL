...
add_test_put_last( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_last", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_last_1
   add_test_to_suite( p_suite, test_put_last_1, "test_put_last_1" );

   // test_put_last_2
   add_test_to_suite( p_suite, test_put_last_2, "test_put_last_2" );

   // test_put_last_3
   add_test_to_suite( p_suite, test_put_last_3, "test_put_last_3" );
