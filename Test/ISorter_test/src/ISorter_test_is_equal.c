/**
 @file ISorter_test_is_equal.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for ISorter_t"
...
{
   i_isorter_t *sorter = NULL;
   i_isorter_t *sorter1 = NULL;
   int32_t result = 0;

   sorter = i_isorter_make();
   CU_ASSERT( sorter != NULL );
   
   sorter1 = i_isorter_make();
   CU_ASSERT( sorter1 != NULL );
   
   result = i_isorter_is_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
   
   i_isorter_dispose( &sorter );
   i_isorter_dispose( &sorter1 );
   CU_ASSERT( sorter == NULL );
   CU_ASSERT( sorter1 == NULL );
...
void test_is_equal_1a( void )
{
   ...
   result = i_isorter_is_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
...
void test_is_equal_2( void )
{
   ...
   result = i_isorter_is_deep_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
   
   
   i_isorter_deep_dispose( &sorter );
   i_isorter_deep_dispose( &sorter1 );
   CU_ASSERT( sorter == NULL );
   CU_ASSERT( sorter1 == NULL );
...
void test_is_equal_2a( void )
{
   ...
   result = i_isorter_is_deep_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
