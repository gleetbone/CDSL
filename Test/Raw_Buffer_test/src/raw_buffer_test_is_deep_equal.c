/**
 @file raw_buffer_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   CU_ASSERT( raw_buffer_is_deep_equal( raw_buffer1, raw_buffer1 ) == 1 );
   CU_ASSERT( raw_buffer_is_deep_equal( raw_buffer1, raw_buffer2 ) == 1 );
...
void test_is_deep_equal_3( void )
{
   ...
   CU_ASSERT( raw_buffer_is_deep_equal( raw_buffer1, raw_buffer2 ) == 0 );
