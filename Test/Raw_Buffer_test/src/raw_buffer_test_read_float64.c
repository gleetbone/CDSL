...
void test_read_float64_3( void )
{
   raw_buffer_t *raw_buffer = raw_buffer_make( 16 );
   float64_t value = 0;
   
   raw_buffer_put_float64_be( raw_buffer, 3.125, 0 );
   value = raw_buffer_read_float64_be( raw_buffer, 0 );

   CU_ASSERT( value == 3.125 );
   
   raw_buffer_put_float64_be( raw_buffer, 3.125, 7 );
   value = raw_buffer_read_float64_be( raw_buffer, 7 );
...
void test_read_float64_4( void )
{
   raw_buffer_t *raw_buffer = raw_buffer_make( 16 );
   float64_t value = 0;
   
   raw_buffer_put_float64_le( raw_buffer, 3.125, 0 );
   value = raw_buffer_read_float64_le( raw_buffer, 0 );

   CU_ASSERT( value == 3.125 );
   
   raw_buffer_put_float64_le( raw_buffer, 3.125, 7 );
   value = raw_buffer_read_float64_le( raw_buffer, 7 );
...
add_test_read_float64( void )
{
   ...
   // test_read_float64_3
   add_test_to_suite( p_suite, test_read_float64_3, "test_read_float64_3" );

   // test_read_float64_4
   add_test_to_suite( p_suite, test_read_float64_4, "test_read_float64_4" );
