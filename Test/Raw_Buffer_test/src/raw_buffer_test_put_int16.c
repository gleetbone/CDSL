/**
 @file raw_buffer_test_put_int16.c
 @author Greg Lee
 @version 1.0.0
...
add_test_put_int16( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_int16", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_int16_1
   add_test_to_suite( p_suite, test_put_int16_1, "test_put_int16_1" );
