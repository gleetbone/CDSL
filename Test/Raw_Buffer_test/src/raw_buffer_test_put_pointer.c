/**
 @file raw_buffer_test_put_pointer.c
 @author Greg Lee
 @version 1.0.0
...
add_test_put_pointer( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_pointer", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_pointer_1
   add_test_to_suite( p_suite, test_put_pointer_1, "test_put_pointer_1" );
