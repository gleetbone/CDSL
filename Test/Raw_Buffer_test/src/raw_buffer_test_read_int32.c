...
void test_read_int32_1( void )
{
   raw_buffer_t *raw_buffer = raw_buffer_make( 16 );
   
   int32_t value = raw_buffer_read_int32( raw_buffer, 0 );
...
void test_read_int32_2( void )
{
   raw_buffer_t *raw_buffer = raw_buffer_make( 16 );
   int32_t value = 0;
   
   raw_buffer_put_int32( raw_buffer, 100206, 0 );
   value = raw_buffer_read_int32( raw_buffer, 0 );

   CU_ASSERT( value == 100206 );
   
   raw_buffer_put_int32( raw_buffer, 100206, 7 );
   value = raw_buffer_read_int32( raw_buffer, 7 );
...
add_test_read_int32( void )
{
   ...
   p_suite = CU_add_suite("suite_test_read_int32", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_read_int32_1
   add_test_to_suite( p_suite, test_read_int32_1, "test_read_int32_1" );
