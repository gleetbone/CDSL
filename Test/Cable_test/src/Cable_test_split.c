...
void test_split_1( void )
{
   ...
   cable = cable_make_from_cstring( "axbxcd" );

   CU_ASSERT( cable != NULL );

   acable = cable_split( cable, "x", &count );
...
void test_split_2( void )
{
   ...
   cable = cable_make_from_cstring( "xaxbxcdx" );
...
void test_split_3( void )
{
   ...
   cable = cable_make_capacity_from_cstring( "axbxcd", 4 );
...
void test_split_4( void )
{
   ...
   cable = cable_make_capacity_from_cstring( "xaxbxcdx", 4 );
...
void test_split_5( void )
{
   ...
   cable = cable_make_capacity_from_cstring( "xaxbxcxdxexfxgxhxixjx", 4 );
...
void test_split_6( void )
{
   ...
   cable = cable_make_capacity_from_cstring( "xaxbxcxdxexfx", 4 );
