/**
 @file date_time_formatter_parser_test_format_string.c
 @author Greg Lee
 @version 2.0.0
...
void test_format_string_1( void )
{
...
add_test_format_string( void )
{
   ...
   p_suite = CU_add_suite("suite_test_format_string", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_format_string_1
   add_test_to_suite( p_suite, test_format_string_1, "test_format_string_1" );
