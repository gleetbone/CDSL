/**
 @file date_time_formatter_parser_test_last_error.c
 @author Greg Lee
 @version 2.0.0
...
add_test_last_error( void )
{
   ...
   p_suite = CU_add_suite("suite_test_last_error", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_last_error_1
   add_test_to_suite( p_suite, test_last_error_1, "test_last_error_1" );
