/**
 @file LSearcher_test_is_equal.c
 @author Greg Lee
 @version 2.0.0
...
{
   i_lsearcher_t *sorter = NULL;
   i_lsearcher_t *sorter1 = NULL;
   int32_t result = 0;

   sorter = i_lsearcher_make();
   CU_ASSERT( sorter != NULL );
   
   sorter1 = i_lsearcher_make();
   CU_ASSERT( sorter1 != NULL );
   
   result = i_lsearcher_is_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
   
   i_lsearcher_dispose( &sorter );
   i_lsearcher_dispose( &sorter1 );
   CU_ASSERT( sorter == NULL );
   CU_ASSERT( sorter1 == NULL );
...
void test_is_equal_1a( void )
{
   ...
   result = i_lsearcher_is_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
...
void test_is_equal_2( void )
{
   ...
   result = i_lsearcher_is_deep_equal( sorter, sorter1 );
   CU_ASSERT( result == 1 );
   
   
   i_lsearcher_deep_dispose( &sorter );
   i_lsearcher_deep_dispose( &sorter1 );
   CU_ASSERT( sorter == NULL );
   CU_ASSERT( sorter1 == NULL );
...
void test_is_equal_2a( void )
{
   ...
   result = i_lsearcher_is_deep_equal( sorter, sorter );
   CU_ASSERT( result == 1 );
