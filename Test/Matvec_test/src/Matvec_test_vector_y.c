...
void test_vector_y_1( void )
{
   ...
   CU_ASSERT( f_matvec_vector_y( fm ) == 2.0 );
...
void test_vector_y_2( void )
{
   ...
   CU_ASSERT( d_matvec_vector_y( dm ) == 2.0 );
...
void test_vector_y_3( void )
{
   ...
   CU_ASSERT( cf_matvec_vector_y( cfm ) == 2.0 + 2.0*I );
...
void test_vector_y_4( void )
{
   ...
   CU_ASSERT( cd_matvec_vector_y( cdm ) == 2.0 + 2.0*I );
...
add_test_vector_y( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vector_y", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vector_y_1
   add_test_to_suite( p_suite, test_vector_y_1, "test_vector_y_1" );

   // test_vector_y_2
   add_test_to_suite( p_suite, test_vector_y_2, "test_vector_y_2" );

   // test_vector_y_3
   add_test_to_suite( p_suite, test_vector_y_3, "test_vector_y_3" );

   // test_vector_y_4
   add_test_to_suite( p_suite, test_vector_y_4, "test_vector_y_4" );
