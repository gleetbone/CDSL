...
add_test_conjugate( void )
{
   ...
   // test_conjugate_3
   add_test_to_suite( p_suite, test_conjugate_3, "test_conjugate_3" );

   // test_conjugate_4
   add_test_to_suite( p_suite, test_conjugate_4, "test_conjugate_4" );
