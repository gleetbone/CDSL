/**
 @file Matvec_test_do_and_set_if_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_do_and_set_if_and_dispose_1
*/
...
void test_do_and_set_if_and_dispose_1( void )
{
   f_matvec_t *fm = NULL;

   fm = f_matvec_make_from_args( 2, 2, 4, 1.0, 2.0, 3.0, 4.0 );
   f_matvec_do_and_set_if_and_dispose( fm, f_func, f_test_func );
...
/**
   test_do_and_set_if_and_dispose_2
*/
void test_do_and_set_if_and_dispose_2( void )
{
   d_matvec_t *dm = NULL;

   dm = d_matvec_make_from_args( 2, 2, 4, 1.0, 2.0, 3.0, 4.0 );;
   d_matvec_do_and_set_if_and_dispose( dm, d_func, d_test_func );
...
/**
   test_do_and_set_if_and_dispose_3
*/

void test_do_and_set_if_and_dispose_3( void )
{
   cf_matvec_t *cfm = NULL;

   cfm = cf_matvec_make_from_args( 2, 2, 4, 1.0 + 1.0*I, 2.0 + 2.0*I, 3.0 + 3.0*I, 4.0 + 4.0*I );
   cf_matvec_do_and_set_if_and_dispose( cfm, cf_func, cf_test_func );
...
/**
   test_do_and_set_if_and_dispose_4
*/

void test_do_and_set_if_and_dispose_4( void )
{
   cd_matvec_t *cdm = NULL;

   cdm = cd_matvec_make_from_args( 2, 2, 4, 1.0 + 1.0*I, 2.0 + 2.0*I, 3.0 + 3.0*I, 4.0 + 4.0*I );
   cd_matvec_do_and_set_if_and_dispose( cdm, cd_func, cd_test_func );
...
add_test_do_and_set_if_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_do_and_set_if_and_dispose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_do_and_set_if_and_dispose_1
   add_test_to_suite( p_suite, test_do_and_set_if_and_dispose_1, "test_do_and_set_if_and_dispose_1" );

   // test_do_and_set_if_and_dispose_2
   add_test_to_suite( p_suite, test_do_and_set_if_and_dispose_2, "test_do_and_set_if_and_dispose_2" );

   // test_do_and_set_if_and_dispose_3
   add_test_to_suite( p_suite, test_do_and_set_if_and_dispose_3, "test_do_and_set_if_and_dispose_3" );

   // test_do_and_set_if_and_dispose_4
   add_test_to_suite( p_suite, test_do_and_set_if_and_dispose_4, "test_do_and_set_if_and_dispose_4" );
