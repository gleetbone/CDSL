...
void test_subtracted_1( void )
{
   ...
   fm = f_matvec_subtracted( fm1, fm2 );
...
void test_subtracted_2( void )
{
   ...
   dm = d_matvec_subtracted( dm1, dm2 );
...
void test_subtracted_3( void )
{
   ...
   cfm = cf_matvec_subtracted( cfm1, cfm2 );
...
void test_subtracted_4( void )
{
   ...
   cdm = cd_matvec_subtracted( cdm1, cdm2 );
...
add_test_subtracted( void )
{
   ...
   p_suite = CU_add_suite("suite_test_subtracted", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_subtracted_1
   add_test_to_suite( p_suite, test_subtracted_1, "test_subtracted_1" );

   // test_subtracted_2
   add_test_to_suite( p_suite, test_subtracted_2, "test_subtracted_2" );

   // test_subtracted_3
   add_test_to_suite( p_suite, test_subtracted_3, "test_subtracted_3" );

   // test_subtracted_4
   add_test_to_suite( p_suite, test_subtracted_4, "test_subtracted_4" );
