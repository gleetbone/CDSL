/**
 @file Matvec_test_is_column_vector.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_is_column_vector_1
*/

void test_is_column_vector_1( void )
{
   f_matvec_t *fm = NULL;
...
/**
   test_is_column_vector_2
*/

void test_is_column_vector_2( void )
{
   d_matvec_t *dm = NULL;
...
/**
   test_is_column_vector_3
*/

void test_is_column_vector_3( void )
{
...
/**
   test_is_column_vector_4
*/

void test_is_column_vector_4( void )
{
...
add_test_is_column_vector( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_column_vector", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_column_vector_1
   add_test_to_suite( p_suite, test_is_column_vector_1, "test_is_column_vector_1" );

   // test_is_column_vector_2
   add_test_to_suite( p_suite, test_is_column_vector_2, "test_is_column_vector_2" );

   // test_is_column_vector_3
   add_test_to_suite( p_suite, test_is_column_vector_3, "test_is_column_vector_3" );

   // test_is_column_vector_4
   add_test_to_suite( p_suite, test_is_column_vector_4, "test_is_column_vector_4" );
