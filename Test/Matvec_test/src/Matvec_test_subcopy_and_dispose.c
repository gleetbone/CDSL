/**
 @file Matvec_test_subcopy_and_dispose.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_subcopy_and_dispose_1
*/

void test_subcopy_and_dispose_1( void )
{
   f_matvec_t *fm = NULL;
   f_matvec_t *fm1 = NULL;
   ...
   f_matvec_subcopy_and_dispose( fm, fm1, 0, 1, 2, 1, 0, 2 );
...
/**
   test_subcopy_and_dispose_2
*/
void test_subcopy_and_dispose_2( void )
{
   d_matvec_t *dm = NULL;
   d_matvec_t *dm1 = NULL;
   ...
   d_matvec_subcopy_and_dispose( dm, dm1, 0, 1, 2, 1, 0, 2 );
...
/**
   test_subcopy_and_dispose_3
*/

void test_subcopy_and_dispose_3( void )
{
   ...
   cf_matvec_subcopy_and_dispose( cfm, cfm1, 0, 1, 2, 1, 0, 2 );
...
/**
   test_subcopy_and_dispose_4
*/

void test_subcopy_and_dispose_4( void )
{
   ...
   cd_matvec_subcopy_and_dispose( cdm, cdm1, 0, 1, 2, 1, 0, 2 );
...
add_test_subcopy_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_subcopy_and_dispose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_subcopy_and_dispose_1
   add_test_to_suite( p_suite, test_subcopy_and_dispose_1, "test_subcopy_and_dispose_1" );

   // test_subcopy_and_dispose_2
   add_test_to_suite( p_suite, test_subcopy_and_dispose_2, "test_subcopy_and_dispose_2" );

   // test_subcopy_and_dispose_3
   add_test_to_suite( p_suite, test_subcopy_and_dispose_3, "test_subcopy_and_dispose_3" );

   // test_subcopy_and_dispose_4
   add_test_to_suite( p_suite, test_subcopy_and_dispose_4, "test_subcopy_and_dispose_4" );
