/**
 @file Matvec_test_vector_squared_magnitude.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_vector_squared_magnitude_1
*/

void test_vector_squared_magnitude_1( void )
{
   f_matvec_t *fm = NULL;
   ...
   CU_ASSERT( f_matvec_vector_squared_magnitude( fm ) == 9.0 );
...
/**
   test_vector_squared_magnitude_2
*/

void test_vector_squared_magnitude_2( void )
{
   d_matvec_t *dm = NULL;
   ...
   CU_ASSERT( d_matvec_vector_squared_magnitude( dm ) == 9.0 );
...
/**
   test_vector_squared_magnitude_3
*/

void test_vector_squared_magnitude_3( void )
{
   ...
   CU_ASSERT( cf_matvec_vector_squared_magnitude( cfm ) == 9.0 );
...
/**
   test_vector_squared_magnitude_4
*/

void test_vector_squared_magnitude_4( void )
{
   ...
   CU_ASSERT( cd_matvec_vector_squared_magnitude( cdm ) == 9.0 );
...
add_test_vector_squared_magnitude( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vector_squared_magnitude", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vector_squared_magnitude_1
   add_test_to_suite( p_suite, test_vector_squared_magnitude_1, "test_vector_squared_magnitude_1" );

   // test_vector_squared_magnitude_2
   add_test_to_suite( p_suite, test_vector_squared_magnitude_2, "test_vector_squared_magnitude_2" );

   // test_vector_squared_magnitude_3
   add_test_to_suite( p_suite, test_vector_squared_magnitude_3, "test_vector_squared_magnitude_3" );

   // test_vector_squared_magnitude_4
   add_test_to_suite( p_suite, test_vector_squared_magnitude_4, "test_vector_squared_magnitude_4" );
