/**
 @file Matvec_test_vector_item.c
 @author Greg Lee
 @version 1.0.0
...
add_test_vector_item( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vector_item", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vector_item_1
   add_test_to_suite( p_suite, test_vector_item_1, "test_vector_item_1" );

   // test_vector_item_2
   add_test_to_suite( p_suite, test_vector_item_2, "test_vector_item_2" );

   // test_vector_item_3
   add_test_to_suite( p_suite, test_vector_item_3, "test_vector_item_3" );

   // test_vector_item_4
   add_test_to_suite( p_suite, test_vector_item_4, "test_vector_item_4" );
