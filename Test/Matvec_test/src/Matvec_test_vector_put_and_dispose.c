...
/**
   test_vector_put_and_dispose_1
*/

void test_vector_put_and_dispose_1( void )
{
   f_matvec_t *fm = NULL;

   fm = f_matvec_make( 1, 3 );

   f_matvec_vector_put_and_dispose( fm, 1.0, 0 );
   f_matvec_vector_put_and_dispose( fm, 2.0, 1 );
   f_matvec_vector_put_and_dispose( fm, 3.0, 2 );
...
/**
   test_vector_put_and_dispose_2
*/

void test_vector_put_and_dispose_2( void )
{
   d_matvec_t *dm = NULL;

   dm = d_matvec_make( 1, 3 );

   d_matvec_vector_put_and_dispose( dm, 1.0, 0 );
   d_matvec_vector_put_and_dispose( dm, 2.0, 1 );
   d_matvec_vector_put_and_dispose( dm, 3.0, 2 );
...
/**
   test_vector_put_and_dispose_3
*/

void test_vector_put_and_dispose_3( void )
{
   cf_matvec_t *cfm = NULL;

   cfm = cf_matvec_make( 1, 3 );

   cf_matvec_vector_put_and_dispose( cfm, 1.0 + 1.0*I, 0 );
   cf_matvec_vector_put_and_dispose( cfm, 2.0 + 2.0*I, 1 );
   cf_matvec_vector_put_and_dispose( cfm, 3.0 + 3.0*I, 2 );
...
/**
   test_vector_put_and_dispose_4
*/

void test_vector_put_and_dispose_4( void )
{
   cd_matvec_t *cdm = NULL;

   cdm = cd_matvec_make( 1, 3 );

   cd_matvec_vector_put_and_dispose( cdm, 1.0 + 1.0*I, 0 );
   cd_matvec_vector_put_and_dispose( cdm, 2.0 + 2.0*I, 1 );
   cd_matvec_vector_put_and_dispose( cdm, 3.0 + 3.0*I, 2 );
...
add_test_vector_put_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vector_put_and_dispose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vector_put_and_dispose_1
   add_test_to_suite( p_suite, test_vector_put_and_dispose_1, "test_vector_put_and_dispose_1" );

   // test_vector_put_and_dispose_2
   add_test_to_suite( p_suite, test_vector_put_and_dispose_2, "test_vector_put_and_dispose_2" );

   // test_vector_put_and_dispose_3
   add_test_to_suite( p_suite, test_vector_put_and_dispose_3, "test_vector_put_and_dispose_3" );

   // test_vector_put_and_dispose_4
   add_test_to_suite( p_suite, test_vector_put_and_dispose_4, "test_vector_put_and_dispose_4" );
