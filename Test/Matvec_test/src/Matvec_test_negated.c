...
add_test_negated( void )
{
   ...
   p_suite = CU_add_suite("suite_test_negated", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_negated_1
   add_test_to_suite( p_suite, test_negated_1, "test_negated_1" );

   // test_negated_2
   add_test_to_suite( p_suite, test_negated_2, "test_negated_2" );

   // test_negated_3
   add_test_to_suite( p_suite, test_negated_3, "test_negated_3" );

   // test_negated_4
   add_test_to_suite( p_suite, test_negated_4, "test_negated_4" );
