...
add_test_one( void )
{
   ...
   p_suite = CU_add_suite("suite_test_one", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_one_1
   add_test_to_suite( p_suite, test_one_1, "test_one_1" );

   // test_one_2
   add_test_to_suite( p_suite, test_one_2, "test_one_2" );

   // test_one_3
   add_test_to_suite( p_suite, test_one_3, "test_one_3" );

   // test_one_4
   add_test_to_suite( p_suite, test_one_4, "test_one_4" );
