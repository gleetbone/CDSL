/**
 @file Matvec_test_make_from_args.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_make_from_args_1
*/

void test_make_from_args_1( void )
{
   f_matvec_t *fm = NULL;
...
/**
   test_make_from_args_2
*/
void test_make_from_args_2( void )
{
   d_matvec_t *dm = NULL;
...
/**
   test_make_from_args_3
*/

void test_make_from_args_3( void )
{
...
/**
   test_make_from_args_4
*/

void test_make_from_args_4( void )
{
...
add_test_make_from_args( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_from_args", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_from_args_1
   add_test_to_suite( p_suite, test_make_from_args_1, "test_make_from_args_1" );

   // test_make_from_args_2
   add_test_to_suite( p_suite, test_make_from_args_2, "test_make_from_args_2" );

   // test_make_from_args_3
   add_test_to_suite( p_suite, test_make_from_args_3, "test_make_from_args_3" );

   // test_make_from_args_4
   add_test_to_suite( p_suite, test_make_from_args_4, "test_make_from_args_4" );
