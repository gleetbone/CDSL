...
add_test_set_from( void )
{
   ...
   // test_set_from_3
   add_test_to_suite( p_suite, test_set_from_3, "test_set_from_3" );

   // test_set_from_4
   add_test_to_suite( p_suite, test_set_from_4, "test_set_from_4" );
