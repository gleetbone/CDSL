/**
 @file Matvec_test_deep_dispose.c
 @author Greg Lee
 @version 2.0.0
...
add_test_deep_dispose( void )
{
   ...
   // test_deep_dispose_4
   add_test_to_suite( p_suite, test_deep_dispose_4, "test_deep_dispose_4" );
