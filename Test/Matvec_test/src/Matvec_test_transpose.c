...
add_test_transpose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_transpose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_transpose_1
   add_test_to_suite( p_suite, test_transpose_1, "test_transpose_1" );

   // test_transpose_2
   add_test_to_suite( p_suite, test_transpose_2, "test_transpose_2" );

   // test_transpose_3
   add_test_to_suite( p_suite, test_transpose_3, "test_transpose_3" );

   // test_transpose_4
   add_test_to_suite( p_suite, test_transpose_4, "test_transpose_4" );
