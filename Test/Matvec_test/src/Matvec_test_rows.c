...
add_test_rows( void )
{
   ...
   p_suite = CU_add_suite("suite_test_rows", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_rows_1
   add_test_to_suite( p_suite, test_rows_1, "test_rows_1" );

   // test_rows_2
   add_test_to_suite( p_suite, test_rows_2, "test_rows_2" );

   // test_rows_3
   add_test_to_suite( p_suite, test_rows_3, "test_rows_3" );

   // test_rows_4
   add_test_to_suite( p_suite, test_rows_4, "test_rows_4" );
