...
add_test_copied( void )
{
   ...
   p_suite = CU_add_suite("suite_test_copied", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_copied_1
   add_test_to_suite( p_suite, test_copied_1, "test_copied_1" );

   // test_copied_2
   add_test_to_suite( p_suite, test_copied_2, "test_copied_2" );

   // test_copied_3
   add_test_to_suite( p_suite, test_copied_3, "test_copied_3" );

   // test_copied_4
   add_test_to_suite( p_suite, test_copied_4, "test_copied_4" );
