...
void test_set_to_one_1( void )
{
   f_matvec_t *fm = NULL;

   fm = f_matvec_make_from_args( 2, 2, 4, 1.0, 2.0, 3.0, 4.0 );
   f_matvec_set_to_one( fm );
...
/**
   test_set_to_one_2
*/
void test_set_to_one_2( void )
{
   d_matvec_t *dm = NULL;

   dm = d_matvec_make_from_args( 2, 2, 4, 1.0, 2.0, 3.0, 4.0 );;
   d_matvec_set_to_one( dm );
...
add_test_set_to_one( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_to_one", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_to_one_1
   add_test_to_suite( p_suite, test_set_to_one_1, "test_set_to_one_1" );

   // test_set_to_one_2
   add_test_to_suite( p_suite, test_set_to_one_2, "test_set_to_one_2" );

   // test_set_to_one_3
   add_test_to_suite( p_suite, test_set_to_one_3, "test_set_to_one_3" );

   // test_set_to_one_4
   add_test_to_suite( p_suite, test_set_to_one_4, "test_set_to_one_4" );
