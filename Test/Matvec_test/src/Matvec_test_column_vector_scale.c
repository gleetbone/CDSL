/**
 @file Matvec_test_column_vector_scale.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_column_vector_scale_3
*/

void test_column_vector_scale_3( void )
{
   ...
   cf_matvec_column_vector_scale( cfm, 1.0 + 2.0*I, 1 );

   CU_ASSERT( cfm != NULL );
   CU_ASSERT( cf_matvec_item( cfm, 0, 0 ) == 1.0 + 1.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 0, 1 ) == -2.0 + 6.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 0, 2 ) == 3.0 + 3.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 1, 0 ) == 4.0 + 4.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 1, 1 ) == -5.0 + 15.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 1, 2 ) == 6.0 + 6.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 2, 0 ) == 7.0 + 7.0*I );
   CU_ASSERT( cf_matvec_item( cfm, 2, 1 ) == -8.0 + 24.0*I );
...
/**
   test_column_vector_scale_4
*/

void test_column_vector_scale_4( void )
{
   ...
   cd_matvec_column_vector_scale( cdm, 1.0 + 2.0*I, 1 );

   CU_ASSERT( cdm != NULL );
   CU_ASSERT( cd_matvec_item( cdm, 0, 0 ) == 1.0 + 1.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 0, 1 ) == -2.0 + 6.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 0, 2 ) == 3.0 + 3.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 1, 0 ) == 4.0 + 4.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 1, 1 ) == -5.0 + 15.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 1, 2 ) == 6.0 + 6.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 2, 0 ) == 7.0 + 7.0*I );
   CU_ASSERT( cd_matvec_item( cdm, 2, 1 ) == -8.0 + 24.0*I );
...
add_test_column_vector_scale( void )
{
   ...
   p_suite = CU_add_suite("suite_test_column_vector_scale", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_column_vector_scale_1
   add_test_to_suite( p_suite, test_column_vector_scale_1, "test_column_vector_scale_1" );

   // test_column_vector_scale_2
   add_test_to_suite( p_suite, test_column_vector_scale_2, "test_column_vector_scale_2" );

   // test_column_vector_scale_3
   add_test_to_suite( p_suite, test_column_vector_scale_3, "test_column_vector_scale_3" );

   // test_column_vector_scale_4
   add_test_to_suite( p_suite, test_column_vector_scale_4, "test_column_vector_scale_4" );
