...
add_test_add( void )
{
   ...
   // test_add_3
   add_test_to_suite( p_suite, test_add_3, "test_add_3" );

   // test_add_4
   add_test_to_suite( p_suite, test_add_4, "test_add_4" );
