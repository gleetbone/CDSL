...
void test_do_and_set_all_1( void )
{
   f_matvec_t *fm = NULL;

   fm = f_matvec_make_from_args( 2, 2, 4, 1.0, 2.0, 3.0, 4.0 );
   f_matvec_do_and_set_all( fm, f_func );
...
/**
   test_do_and_set_all_2
*/
void test_do_and_set_all_2( void )
{
   d_matvec_t *dm = NULL;

   dm = d_matvec_make_from_args( 2, 2, 4, 1.0, 2.0, 3.0, 4.0 );;
   d_matvec_do_and_set_all( dm, d_func );
...
add_test_do_and_set_all( void )
{
   ...
   p_suite = CU_add_suite("suite_test_do_and_set_all", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_do_and_set_all_1
   add_test_to_suite( p_suite, test_do_and_set_all_1, "test_do_and_set_all_1" );

   // test_do_and_set_all_2
   add_test_to_suite( p_suite, test_do_and_set_all_2, "test_do_and_set_all_2" );

   // test_do_and_set_all_3
   add_test_to_suite( p_suite, test_do_and_set_all_3, "test_do_and_set_all_3" );

   // test_do_and_set_all_4
   add_test_to_suite( p_suite, test_do_and_set_all_4, "test_do_and_set_all_4" );
