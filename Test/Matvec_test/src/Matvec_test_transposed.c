...
add_test_transposed( void )
{
   ...
   p_suite = CU_add_suite("suite_test_transposed", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_transposed_1
   add_test_to_suite( p_suite, test_transposed_1, "test_transposed_1" );

   // test_transposed_2
   add_test_to_suite( p_suite, test_transposed_2, "test_transposed_2" );

   // test_transposed_3
   add_test_to_suite( p_suite, test_transposed_3, "test_transposed_3" );

   // test_transposed_4
   add_test_to_suite( p_suite, test_transposed_4, "test_transposed_4" );
