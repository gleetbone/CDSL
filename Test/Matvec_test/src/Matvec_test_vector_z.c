...
void test_vector_z_1( void )
{
   ...
   CU_ASSERT( f_matvec_vector_z( fm ) == 3.0 );
...
void test_vector_z_2( void )
{
   ...
   CU_ASSERT( d_matvec_vector_z( dm ) == 3.0 );
...
void test_vector_z_3( void )
{
   ...
   CU_ASSERT( cf_matvec_vector_z( cfm ) == 3.0 + 3.0*I );
...
void test_vector_z_4( void )
{
   ...
   CU_ASSERT( cd_matvec_vector_z( cdm ) == 3.0 + 3.0*I );
...
add_test_vector_z( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vector_z", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vector_z_1
   add_test_to_suite( p_suite, test_vector_z_1, "test_vector_z_1" );

   // test_vector_z_2
   add_test_to_suite( p_suite, test_vector_z_2, "test_vector_z_2" );

   // test_vector_z_3
   add_test_to_suite( p_suite, test_vector_z_3, "test_vector_z_3" );

   // test_vector_z_4
   add_test_to_suite( p_suite, test_vector_z_4, "test_vector_z_4" );
