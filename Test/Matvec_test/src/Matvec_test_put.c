...
void test_put_1( void )
{
   ...
   f_matvec_put( fm, 1.0, 0, 0);
   f_matvec_put( fm, 2.0, 0, 1);
   f_matvec_put( fm, 3.0, 1, 0);
   f_matvec_put( fm, 4.0, 1, 1);
   CU_ASSERT( fm != NULL );
...
void test_put_2( void )
{
   ...
   d_matvec_put( dm, 1.0, 0, 0);
   d_matvec_put( dm, 2.0, 0, 1);
   d_matvec_put( dm, 3.0, 1, 0);
   d_matvec_put( dm, 4.0, 1, 1);
   CU_ASSERT( dm != NULL );
...
void test_put_3( void )
{
   ...
   cf_matvec_put( cfm, 1.0 + 1.0*I, 0, 0);
   cf_matvec_put( cfm, 2.0 + 2.0*I, 0, 1);
   cf_matvec_put( cfm, 3.0 + 3.0*I, 1, 0);
   cf_matvec_put( cfm, 4.0 + 4.0*I, 1, 1);
   CU_ASSERT( cfm != NULL );
...
void test_put_4( void )
{
   ...
   cd_matvec_put( cdm, 1.0 + 1.0*I, 0, 0);
   cd_matvec_put( cdm, 2.0 + 2.0*I, 0, 1);
   cd_matvec_put( cdm, 3.0 + 3.0*I, 1, 0);
   cd_matvec_put( cdm, 4.0 + 4.0*I, 1, 1);
   CU_ASSERT( cdm != NULL );
