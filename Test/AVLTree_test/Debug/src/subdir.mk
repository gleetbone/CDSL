...
src/%.o: ../src/%.c
	...
	gcc -I../../../base -I../../../dbc -I../../../AVLTree -I../../../Protocol_Base -I../../../P_Clonable -I../../../P_Iterable -I../../../P_DIterable -O0 -g3 -ftest-coverage -fprofile-arcs -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
