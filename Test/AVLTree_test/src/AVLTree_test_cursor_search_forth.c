/**
 @file AVLTree_test_cursor_search_forth.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_forth_1( void )
{
   ...
   i_avltree_cursor_search_forth( cursor, 1 );
...
void test_cursor_search_forth_3( void )
{
   ...
   i_avltree_cursor_start( cursor );
   i_avltree_cursor_search_forth( cursor, 2 );
   CU_ASSERT( i_avltree_cursor_off( cursor ) == 0 );
...
void test_cursor_search_forth_5( void )
{
   ...
   s_avltree_cursor_search_forth( cursor, s2 );
