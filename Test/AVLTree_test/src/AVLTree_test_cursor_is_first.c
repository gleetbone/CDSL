...
void test_cursor_is_first_1( void )
{
   ...
   CU_ASSERT( i_avltree_cursor_is_first( cursor ) == 0 );
...
void test_cursor_is_first_2( void )
{
   ...
   CU_ASSERT( i_avltree_cursor_is_first( cursor ) == 1 );
...
void test_cursor_is_first_4( void )
{
   ...
   CU_ASSERT( s_avltree_cursor_is_first( cursor ) == 0 );

   s_avltree_cursor_start( cursor );
   CU_ASSERT( s_avltree_cursor_is_first( cursor ) == 1 );
