...
void test_deep_copy_1( void )
{
   ...
   i_avltree_deep_copy( avltree1, avltree );
...
void test_deep_copy_4( void )
{
   ...
   s_avltree_deep_copy( avltree1, avltree );
...
add_test_deep_copy( void )
{
   ...
   // test_deep_copy_4
   add_test_to_suite( p_suite, test_deep_copy_4, "test_deep_copy_4" );
