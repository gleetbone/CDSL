...
void test_item_at_index_1( void )
{
   ...
   CU_ASSERT( i_avltree_item_at_index( avltree, 0 ) == 1 );
...
void test_item_at_index_2( void )
{
   ...
   CU_ASSERT( i_avltree_item_at_index( avltree, 0 ) == 1 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 1 ) == 2 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 2 ) == 3 );
...
void test_item_at_index_5( void )
{
   ...
   CU_ASSERT( i_avltree_item_at_index( avltree, 0 ) == 1 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 1 ) == 2 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 2 ) == 4 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 3 ) == 6 );
...
void test_item_at_index_6( void )
{
   ...
   CU_ASSERT( i_avltree_item_at_index( avltree, 0 ) == 2 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 1 ) == 3 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 2 ) == 4 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 3 ) == 6 );
...
void test_item_at_index_7( void )
{
   ...
   CU_ASSERT( i_avltree_item_at_index( avltree, 0 ) == 2 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 1 ) == 4 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 2 ) == 5 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 3 ) == 6 );
...
void test_item_at_index_8( void )
{
   ...
   CU_ASSERT( i_avltree_item_at_index( avltree, 0 ) == 2 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 1 ) == 4 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 2 ) == 6 );
   CU_ASSERT( i_avltree_item_at_index( avltree, 3 ) == 7 );
