...
void test_remove_16g( void )
{
   ...
   for( k=0; k<10000; k++ )
   {
      ...
      while ( j< count/2 )
      {
         ...
         {
            i_avltree_remove( avltree, values[i] );
        	j = j + 1;
         }
      }
