/**
 @file AVLTree_test_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_forth_eq_fn_1( void )
{
   ...
   i_avltree_search_forth_eq_fn( avltree, 1, is_equal_int );
...
void test_search_forth_eq_fn_3( void )
{
   ...
   i_avltree_start( avltree );
   i_avltree_search_forth_eq_fn( avltree, 2, is_equal_int );
   CU_ASSERT( i_avltree_off( avltree ) == 0 );
...
void test_search_forth_eq_fn_5( void )
{
   ...
   s_avltree_search_forth_eq_fn( avltree, s2, is_equal_s );
