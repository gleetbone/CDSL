/**
 @file AVLTree_test_cursor_search_back.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_back_1( void )
{
   ...
   i_avltree_cursor_search_back( cursor, 1 );
...
void test_cursor_search_back_3( void )
{
   ...
   i_avltree_cursor_finish( cursor );
   i_avltree_cursor_search_back( cursor, 2 );
   CU_ASSERT( i_avltree_cursor_off( cursor ) == 0 );
...
void test_cursor_search_back_5( void )
{
   ...
   s_avltree_cursor_search_back( cursor, s2 );
