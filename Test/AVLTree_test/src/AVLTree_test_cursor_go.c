...
void test_cursor_go_2( void )
{
   ...
   i_avltree_cursor_go( cursor, 1 );
   CU_ASSERT( i_avltree_cursor_item_at( cursor ) == 2 );
 
   i_avltree_cursor_go( cursor, 2 );
