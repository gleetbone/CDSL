...
void test_phase_1( void )
{
   ...
   v1 = cf_fft_phase( cffft );
   v2 = single_bin_sinusoid_phase_f( 1024, 8, 0.0 );
...
void test_phase_2( void )
{
   ...
   v1 = cd_fft_phase( cdfft );
   v2 = single_bin_sinusoid_phase_d( 1024, 8, 0.0 );
...
add_test_phase( void )
{
   ...
   p_suite = CU_add_suite("suite_test_phase", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_phase_1
   add_test_to_suite( p_suite, test_phase_1, "test_phase_1" );

   // test_phase_2
   add_test_to_suite( p_suite, test_phase_2, "test_phase_2" );
