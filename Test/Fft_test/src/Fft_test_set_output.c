...
add_test_set_output( void )
{
   ...
   p_suite = CU_add_suite("suite_test_set_output", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_set_output_1
   add_test_to_suite( p_suite, test_set_output_1, "test_set_output_1" );

   // test_set_output_2
   add_test_to_suite( p_suite, test_set_output_2, "test_set_output_2" );
