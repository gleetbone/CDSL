...
void test_height_1( void )
{
   ...
   CU_ASSERT( ii_heap_kv_height( heap ) == 0 );
...
void test_height_2( void )
{
   ...
   CU_ASSERT( ii_heap_kv_height( heap ) == 1 );
...
void test_height_3( void )
{
   ...
   CU_ASSERT( ii_heap_kv_height( heap ) == 2 );
...
void test_height_5( void )
{
   ...
   CU_ASSERT( ii_heap_kv_height( heap ) == 3 );
