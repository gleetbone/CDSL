...
void test_is_equal_1( void )
{
   ...
   CU_ASSERT( ii_heap_kv_is_equal( heap, heap ) == 1 );
   
   heap1 = ii_heap_kv_make();
   
   CU_ASSERT( ii_heap_kv_is_equal( heap1, heap ) == 0 );
...
void test_is_equal_2( void )
{
   ...
   ss_heap_kv_dispose( &heap );
   ss_heap_kv_dispose( &heap1 );
