...
void test_forth_1( void )
{
   ...
   CU_ASSERT( i_circular_buffer_count( circular_buffer ) == 4 );
   ...
   CU_ASSERT( i_circular_buffer_item( circular_buffer ) == 13 );
   CU_ASSERT( i_circular_buffer_count( circular_buffer ) == 2 );

   i_circular_buffer_forth( circular_buffer );

   CU_ASSERT( i_circular_buffer_item( circular_buffer ) == 5 );
