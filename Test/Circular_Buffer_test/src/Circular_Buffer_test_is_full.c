/**
 @file Circular_Buffer_test_is_full.c
 @author Greg Lee
 @version 1.0.0
...
add_test_is_full( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_full", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_full_1
   add_test_to_suite( p_suite, test_is_full_1, "test_is_full_1" );
