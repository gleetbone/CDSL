/**
 @file BSTree_test_cursor_search_back.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_back_1( void )
{
   ...
   i_bstree_cursor_search_back( cursor, 1 );
...
void test_cursor_search_back_3( void )
{
   ...
   i_bstree_cursor_finish( cursor );
   i_bstree_cursor_search_back( cursor, 2 );
   CU_ASSERT( i_bstree_cursor_off( cursor ) == 0 );
...
/**
   test_cursor_search_back_5
*/

void test_cursor_search_back_5( void )
{
   ...
   s_bstree_cursor_search_back( cursor, s2 );
...
add_test_cursor_search_back( void )
{
   ...
   // test_cursor_search_back_5
   add_test_to_suite( p_suite, test_cursor_search_back_5, "test_cursor_search_back_5" );
