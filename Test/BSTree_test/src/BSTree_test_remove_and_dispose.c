...
void test_remove_and_dispose_1( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 0 );
...
void test_remove_and_dispose_2( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 1 );
...
void test_remove_and_dispose_2b( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 2 );
...
void test_remove_and_dispose_5( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 3 );
...
void test_remove_and_dispose_5d( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 4 );
...
void test_remove_and_dispose_5e( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 5 );
...
void test_remove_and_dispose_5f( void )
{
   ...
   i_bstree_remove_and_dispose( bstree, 6 );
...
void test_remove_and_dispose_7( void )
{
   ...
   s_bstree_remove_and_dispose( bstree, 0 );
...
void test_remove_and_dispose_7a( void )
{
   ...
   s_bstree_remove_and_dispose( bstree, 1 );
   ...
   result = s_bstree_has( bstree, s2a );
   CU_ASSERT( result == 0 );
