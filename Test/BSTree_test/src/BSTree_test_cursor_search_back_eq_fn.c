/**
 @file BSTree_test_cursor_search_back_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_back_eq_fn_1( void )
{
   ...
   i_bstree_cursor_search_back_eq_fn( cursor, 1, is_equal_int );
...
void test_cursor_search_back_eq_fn_3( void )
{
   ...
   i_bstree_cursor_finish( cursor );
   i_bstree_cursor_search_back_eq_fn( cursor, 2, is_equal_int );
   CU_ASSERT( i_bstree_cursor_off( cursor ) == 0 );
...
void test_cursor_search_back_eq_fn_5( void )
{
   ...
   s_bstree_cursor_search_back_eq_fn( cursor, s2, is_equal_s );
