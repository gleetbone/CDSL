/**
 @file BSTree_test_cursor_go_to_value.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_go_to_value_1( void )
{
   ...
   i_bstree_cursor_go_to_value( cursor, 0 );

   CU_ASSERT( i_bstree_cursor_off( cursor ) == 1 );
   
   i_bstree_deep_dispose( &bstree );
...
void test_cursor_go_to_value_1a( void )
{
   ...
   i_bstree_cursor_go_to_value( cursor, 1 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 1 );
   
   i_bstree_cursor_go_to_value( cursor, 2 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 1 );
...
void test_cursor_go_to_value_2( void )
{
   ...
   i_bstree_cursor_go_to_value( cursor, 3 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 3 );
 
   i_bstree_cursor_go_to_value( cursor, 4 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 3 );
...
void test_cursor_go_to_value_5( void )
{
   ...
   i_bstree_cursor_go_to_value( cursor, 5 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 4 );
 
   i_bstree_cursor_go_to_value( cursor, 6 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 6 );
 
   i_bstree_cursor_go_to_value( cursor, 10 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 6 );
...
void test_cursor_go_to_value_8( void )
{
   ...
   i_bstree_cursor_go_to_value( cursor, 7 );
...
void test_cursor_go_to_value_9( void )
{
   ...
   s_bstree_cursor_go_to_value( cursor, s0 );
   CU_ASSERT( s_bstree_cursor_off( cursor) == 1 );
 
   s_bstree_cursor_go_to_value( cursor, s1 );
   CU_ASSERT( s_bstree_cursor_off( cursor) == 1 );
 
   s_bstree_cursor_go_to_value( cursor, s2 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s2 );
 
   s_bstree_cursor_go_to_value( cursor, s3 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s2 );
 
   s_bstree_cursor_go_to_value( cursor, s4 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s4 );
 
   s_bstree_cursor_go_to_value( cursor, s5 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s4 );
 
   s_bstree_cursor_go_to_value( cursor, s6 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s6 );
 
   s_bstree_cursor_go_to_value( cursor, s7 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s7 );
 
   s_bstree_cursor_go_to_value( cursor, s9 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor) == s7 );
