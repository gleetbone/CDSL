...
void test_cursor_is_last_1( void )
{
   ...
   CU_ASSERT( i_bstree_cursor_is_last( cursor ) == 0 );
...
void test_cursor_is_last_2( void )
{
   ...
   CU_ASSERT( i_bstree_cursor_is_last( cursor ) == 1 );
...
void test_cursor_is_last_4( void )
{
   ...
   CU_ASSERT( s_bstree_cursor_is_last( cursor ) == 0 );
   ...
   s_bstree_cursor_forth( cursor );
   CU_ASSERT( s_bstree_cursor_is_last( cursor ) == 1 );
