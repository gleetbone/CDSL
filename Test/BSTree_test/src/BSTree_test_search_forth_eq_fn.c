/**
 @file BSTree_test_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_forth_eq_fn_1( void )
{
   ...
   i_bstree_search_forth_eq_fn( bstree, 1, is_equal_int );
...
void test_search_forth_eq_fn_3( void )
{
   ...
   i_bstree_start( bstree );
   i_bstree_search_forth_eq_fn( bstree, 2, is_equal_int );
   CU_ASSERT( i_bstree_off( bstree ) == 0 );
...
void test_search_forth_eq_fn_5( void )
{
   ...
   s_bstree_search_forth_eq_fn( bstree, s2, is_equal_s );
