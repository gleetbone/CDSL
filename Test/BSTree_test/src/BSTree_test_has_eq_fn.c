...
void test_has_eq_fn_1( void )
{
   ...
   result = i_bstree_has_eq_fn( bstree, 1, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = i_bstree_has_eq_fn( bstree, 0, is_equal_int );
   CU_ASSERT( result == 0 );
...
void test_has_eq_fn_2( void )
{
   ...
   result = i_bstree_has_eq_fn( bstree, 2, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = i_bstree_has_eq_fn( bstree, 1, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = i_bstree_has_eq_fn( bstree, 3, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_5( void )
{
   ...
   result = i_bstree_has_eq_fn( bstree, 4, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = i_bstree_has_eq_fn( bstree, 2, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = i_bstree_has_eq_fn( bstree, 6, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_7( void )
{
   ...
   result = i_bstree_has_eq_fn( bstree, 5, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_8( void )
{
   ...
   result = i_bstree_has_eq_fn( bstree, 7, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_eq_fn_9( void )
{
   ...
   result = s_bstree_has_eq_fn( bstree, s4, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = s_bstree_has_eq_fn( bstree, s2, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = s_bstree_has_eq_fn( bstree, s6, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = s_bstree_has_eq_fn( bstree, s7, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = s_bstree_has_eq_fn( bstree, s0, is_equal_s );
   CU_ASSERT( result == 0 );
