...
void test_remove_value_1( void )
{
   ...
   i_bstree_remove_value( bstree, 1 );
...
void test_remove_value_2( void )
{
   ...
   i_bstree_remove_value( bstree, 2 );
...
void test_remove_value_2b( void )
{
   ...
   i_bstree_remove_value( bstree, 3 );
...
void test_remove_value_5( void )
{
   ...
   i_bstree_remove_value( bstree, 4 );
...
void test_remove_value_5d( void )
{
   ...
   i_bstree_remove_value( bstree, 5 );
...
void test_remove_value_5e( void )
{
   ...
   i_bstree_remove_value( bstree, 6 );
...
void test_remove_value_5f( void )
{
   ...
   i_bstree_remove_value( bstree, 7 );
...
void test_remove_value_6b( void )
{
   ...
   i_bstree_remove_value( bstree, 8 );
...
void test_remove_value_7( void )
{
   ...
   s_bstree_remove_value( bstree, s1 );
