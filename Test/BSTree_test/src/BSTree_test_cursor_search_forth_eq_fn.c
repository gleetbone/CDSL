/**
 @file BSTree_test_cursor_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_forth_eq_fn_1( void )
{
   ...
   i_bstree_cursor_search_forth_eq_fn( cursor, 1, is_equal_int );
...
void test_cursor_search_forth_eq_fn_3( void )
{
   ...
   i_bstree_cursor_start( cursor );
   i_bstree_cursor_search_forth_eq_fn( cursor, 2, is_equal_int );
   CU_ASSERT( i_bstree_cursor_off( cursor ) == 0 );
...
void test_cursor_search_forth_eq_fn_4( void )
{
   ...
   CU_ASSERT( i_bstree_cursor_off( cursor ) == 0 );
   CU_ASSERT( i_bstree_cursor_item_at( cursor ) == 2 );
   CU_ASSERT( i_bstree_cursor_index( cursor ) == 2 );
...
/**
   test_cursor_search_forth_eq_fn_5
*/

void test_cursor_search_forth_eq_fn_5( void )
{
   ...
   s_bstree_cursor_search_forth_eq_fn( cursor, s2, is_equal_s );
   CU_ASSERT( s_bstree_cursor_off( cursor ) == 0 );
   CU_ASSERT( s_bstree_cursor_item_at( cursor ) == s2a );
   ...
   CU_ASSERT( s_bstree_cursor_index( cursor ) == 2 );
...
add_test_cursor_search_forth_eq_fn( void )
{
   ...
   // test_cursor_search_forth_eq_fn_5
   add_test_to_suite( p_suite, test_cursor_search_forth_eq_fn_5, "test_cursor_search_forth_eq_fn_5" );
