...
void test_last_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_last( bstree ) == 10 );
...
void test_last_2( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_last( bstree ) == 30 );
...
void test_last_5( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_last( bstree ) == 60 );
...
void test_last_8( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_last( bstree ) == 70 );
...
void test_last_9( void )
{
   ...
   CU_ASSERT( ss_bstree_kv_last( bstree ) == s70 );
