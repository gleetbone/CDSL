/**
 @file BSTree_test_key_at_index.c
 @author Greg Lee
 @version 1.0.0
...
void test_key_at_index_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 0 ) == 1 );
...
void test_key_at_index_2( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 0 ) == 1 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 1 ) == 2 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 2 ) == 3 );
...
void test_key_at_index_5( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 0 ) == 1 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 1 ) == 2 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 2 ) == 4 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 3 ) == 6 );
...
void test_key_at_index_6( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 0 ) == 2 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 1 ) == 3 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 2 ) == 4 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 3 ) == 6 );
...
void test_key_at_index_7( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 0 ) == 2 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 1 ) == 4 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 2 ) == 5 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 3 ) == 6 );
...
void test_key_at_index_8( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 0 ) == 2 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 1 ) == 4 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 2 ) == 6 );
   CU_ASSERT( ii_bstree_kv_key_at_index( bstree, 3 ) == 7 );
