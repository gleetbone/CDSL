/**
 @file BSTree_test_remove_value_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_value_and_dispose_1( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 10 );
...
void test_remove_value_and_dispose_2( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 20 );
...
void test_remove_value_and_dispose_2b( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 30 );
...
void test_remove_value_and_dispose_5( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 40 );
...
void test_remove_value_and_dispose_5d( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 50 );
...
void test_remove_value_and_dispose_5e( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 60 );
...
void test_remove_value_and_dispose_5f( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 70 );
...
void test_remove_value_and_dispose_6b( void )
{
   ...
   ii_bstree_kv_remove_value_and_dispose( bstree, 80 );
...
void test_remove_value_and_dispose_7( void )
{
   ...
   ss_bstree_kv_remove_value_and_dispose( bstree, s10 );
