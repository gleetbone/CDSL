/**
 @file BSTree_kv_test_cursor_key_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_key_search_forth_eq_fn_1( void )
{
   ...
   ii_bstree_kv_cursor_key_search_forth_eq_fn( cursor, 1, is_equal_int );
...
void test_cursor_key_search_forth_eq_fn_3( void )
{
   ...
   ii_bstree_kv_cursor_start( cursor );
   ii_bstree_kv_cursor_key_search_forth_eq_fn( cursor, 2, is_equal_int );
   CU_ASSERT( ii_bstree_kv_cursor_off( cursor ) == 0 );
...
void test_cursor_key_search_forth_eq_fn_5( void )
{
   ...
   ss_bstree_kv_cursor_key_search_forth_eq_fn( cursor, s2, is_equal_s );
