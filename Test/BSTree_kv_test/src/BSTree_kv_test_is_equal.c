...
void test_is_equal_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_is_equal( bstree1, bstree ) == 1 );
...
void test_is_equal_2( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_is_equal( bstree, bstree1 ) == 1 );
...
void test_is_equal_2a( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_is_equal( bstree, bstree ) == 1 );
...
void test_is_equal_3( void )
{
   ...
   ss_bstree_kv_put( bstree1, s10, s1 );
   
   CU_ASSERT( ss_bstree_kv_is_equal( bstree, bstree1 ) == 1 );
   CU_ASSERT( ss_bstree_kv_is_deep_equal( bstree, bstree1 ) == 1 );
 
   ss_bstree_kv_deep_dispose( &bstree );
   ss_bstree_kv_dispose( &bstree1 );
...
void test_is_equal_4( void )
{
   ...
   CU_ASSERT( ss_bstree_kv_is_equal( bstree, bstree1 ) == 0 );
   CU_ASSERT( ss_bstree_kv_is_deep_equal( bstree, bstree1 ) == 1 );
