...
void test_cursor_go_1( void )
{
   ...
   ii_bstree_kv_cursor_go( cursor, 0 );
...
void test_cursor_go_2( void )
{
   ...
   ii_bstree_kv_cursor_go( cursor, 1 );
   CU_ASSERT( ii_bstree_kv_cursor_item_at( cursor ) == 20 );
 
   ii_bstree_kv_cursor_go( cursor, 2 );
...
void test_cursor_go_5( void )
{
   ...
   ii_bstree_kv_cursor_go( cursor, 3 );
