/**
 @file BSTree_test_cursor_is_first.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_is_first_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_cursor_is_first( cursor ) == 0 );
...
void test_cursor_is_first_1a( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_cursor_is_first( cursor ) == 1 );
...
void test_cursor_is_first_7( void )
{
   ...
   CU_ASSERT( ss_bstree_kv_cursor_is_first( cursor ) == 1 );
 
   ss_bstree_kv_cursor_finish( cursor );
   
   CU_ASSERT( ss_bstree_kv_cursor_is_first( cursor ) == 0 );
