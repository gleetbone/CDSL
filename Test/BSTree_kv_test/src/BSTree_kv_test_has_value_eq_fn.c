/**
 @file BSTree_test_has_value_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_has_value_eq_fn_1( void )
{
   ...
   result = ii_bstree_kv_has_value_eq_fn( bstree, 10, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_bstree_kv_has_value_eq_fn( bstree, 0, is_equal_int );
   CU_ASSERT( result == 0 );
...
void test_has_value_eq_fn_2( void )
{
   ...
   result = ii_bstree_kv_has_value_eq_fn( bstree, 20, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_bstree_kv_has_value_eq_fn( bstree, 10, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_bstree_kv_has_value_eq_fn( bstree, 30, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_value_eq_fn_5( void )
{
   ...
   result = ii_bstree_kv_has_value_eq_fn( bstree, 40, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_bstree_kv_has_value_eq_fn( bstree, 20, is_equal_int );
   CU_ASSERT( result == 1 );
 
   result = ii_bstree_kv_has_value_eq_fn( bstree, 60, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_value_eq_fn_7( void )
{
   ...
   result = ii_bstree_kv_has_value_eq_fn( bstree, 50, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_value_eq_fn_8( void )
{
   ...
   result = ii_bstree_kv_has_value_eq_fn( bstree, 70, is_equal_int );
   CU_ASSERT( result == 1 );
...
void test_has_value_eq_fn_9( void )
{
   ...
   result = ss_bstree_kv_has_value_eq_fn( bstree, s40, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_bstree_kv_has_value_eq_fn( bstree, s20, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_bstree_kv_has_value_eq_fn( bstree, s60, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_bstree_kv_has_value_eq_fn( bstree, s70, is_equal_s );
   CU_ASSERT( result == 1 );
 
   result = ss_bstree_kv_has_value_eq_fn( bstree, s00, is_equal_s );
   CU_ASSERT( result == 0 );
