/**
 @file BSTree_test_occurrences_value_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_occurrences_value_eq_fn_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_occurrences_value_eq_fn( bstree, 10, is_equal_int ) == 0 );
...
void test_occurrences_value_eq_fn_2( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_occurrences_value_eq_fn( bstree, 10, is_equal_int ) == 1 );
...
void test_occurrences_value_eq_fn_3( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_occurrences_value_eq_fn( bstree, 10, is_equal_int ) == 1 );
   CU_ASSERT( ii_bstree_kv_occurrences_value_eq_fn( bstree, 20, is_equal_int ) == 2 );
   CU_ASSERT( ii_bstree_kv_occurrences_value_eq_fn( bstree, 30, is_equal_int ) == 1 );
...
void test_occurrences_value_eq_fn_4( void )
{
   ...
   CU_ASSERT( ss_bstree_kv_occurrences_value_eq_fn( bstree, s10, is_equal_s ) == 1 );
   CU_ASSERT( ss_bstree_kv_occurrences_value_eq_fn( bstree, s20, is_equal_s ) == 2 );
   CU_ASSERT( ss_bstree_kv_occurrences_value_eq_fn( bstree, s30, is_equal_s ) == 1 );
