...
void test_p_iterable_kv_1( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_dispose_f( pb_tree ) == ii_bstree_kv_dispose );
...
void test_p_iterable_kv_2( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_dispose_with_contents_f( pb_tree ) == ii_bstree_kv_dispose_with_contents );
...
void test_p_iterable_kv_3( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_count_f( pb_tree ) == ii_bstree_kv_count );
...
void test_p_iterable_kv_4( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_value_f( pb_tree ) == ii_bstree_kv_item_at );
...
void test_p_iterable_kv_4a( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_key_f( pb_tree ) == ii_bstree_kv_key_at );
...
void test_p_iterable_kv_5( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_off_f( pb_tree ) == ii_bstree_kv_off );
...
void test_p_iterable_kv_6( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_is_empty_f( pb_tree ) == ii_bstree_kv_is_empty );
...
void test_p_iterable_kv_8( void )
{
   ...
   CU_ASSERT( ii_iterable_kv_forth_f( pb_tree ) == ii_bstree_kv_forth );
   CU_ASSERT( ii_iterable_kv_value( pb_tree) == 24 );
