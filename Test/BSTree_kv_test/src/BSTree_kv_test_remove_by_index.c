/**
 @file BSTree_test_remove_by_index.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_by_index_1( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 0 );
...
void test_remove_by_index_2( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 1 );
...
void test_remove_by_index_2b( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 2 );
...
void test_remove_by_index_5( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 3 );
...
void test_remove_by_index_5d( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 4 );
...
void test_remove_by_index_5e( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 5 );
...
void test_remove_by_index_5f( void )
{
   ...
   ii_bstree_kv_remove_by_index( bstree, 6 );
...
void test_remove_by_index_7( void )
{
   ...
   ss_bstree_kv_remove_by_index( bstree, 0 );
