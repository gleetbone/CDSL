/**
 @file BSTree_kv_test_key_search_forth.c
 @author Greg Lee
 @version 2.0.0
...
void test_key_search_forth_1( void )
{
   ...
   ii_bstree_kv_key_search_forth( bstree, 1 );
...
void test_key_search_forth_3( void )
{
   ...
   ii_bstree_kv_start( bstree );
   ii_bstree_kv_key_search_forth( bstree, 2 );
   CU_ASSERT( ii_bstree_kv_off( bstree ) == 0 );
...
void test_key_search_forth_5( void )
{
   ...
   ss_bstree_kv_key_search_forth( bstree, s2 );
