/**
 @file BSTree_test_occurrences_value.c
 @author Greg Lee
 @version 2.0.0
...
void test_occurrences_value_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_occurrences_value( bstree, 1 ) == 0 );
...
void test_occurrences_value_2( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_occurrences_value( bstree, 10 ) == 1 );
...
void test_occurrences_value_3( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_occurrences_value( bstree, 10 ) == 1 );
   CU_ASSERT( ii_bstree_kv_occurrences_value( bstree, 20 ) == 2 );
   CU_ASSERT( ii_bstree_kv_occurrences_value( bstree, 30 ) == 1 );
...
void test_occurrences_value_4( void )
{
   ...
   CU_ASSERT( ss_bstree_kv_occurrences_value( bstree, s10 ) == 1 );
   CU_ASSERT( ss_bstree_kv_occurrences_value( bstree, s20 ) == 2 );
   CU_ASSERT( ss_bstree_kv_occurrences_value( bstree, s30 ) == 1 );
