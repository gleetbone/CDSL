/**
 @file BSTree_test_remove_last_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_last_and_dispose_1( void )
{
   ...
   ii_bstree_kv_remove_last_and_dispose( bstree );
...
void test_remove_last_and_dispose_7( void )
{
   ...
   ss_bstree_kv_remove_last_and_dispose( bstree );
   ...
   result = ss_bstree_kv_has( bstree, s4a );
   CU_ASSERT( result == 0 );
