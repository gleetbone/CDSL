/**
 @file BSTree_test_remove_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_and_dispose_1( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 1 );
...
void test_remove_and_dispose_2( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 2 );
...
void test_remove_and_dispose_2b( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 3 );
...
void test_remove_and_dispose_5( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 4 );
...
void test_remove_and_dispose_5d( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 5 );
...
void test_remove_and_dispose_5e( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 6 );
...
void test_remove_and_dispose_5f( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 7 );
...
void test_remove_and_dispose_6b( void )
{
   ...
   ii_bstree_kv_remove_and_dispose( bstree, 8 );
...
void test_remove_and_dispose_7( void )
{
   ...
   ss_bstree_kv_remove_and_dispose( bstree, s1 );
