/**
 @file BSTree_kv_test_key_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_key_search_forth_eq_fn_1( void )
{
   ...
   ii_bstree_kv_key_search_forth_eq_fn( bstree, 1, is_equal_int );
...
void test_key_search_forth_eq_fn_3( void )
{
   ...
   ii_bstree_kv_start( bstree );
   ii_bstree_kv_key_search_forth_eq_fn( bstree, 2, is_equal_int );
   CU_ASSERT( ii_bstree_kv_off( bstree ) == 0 );
...
void test_key_search_forth_eq_fn_5( void )
{
   ...
   ss_bstree_kv_key_search_forth_eq_fn( bstree, s2, is_equal_s );
