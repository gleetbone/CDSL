...
void test_is_last_1( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_is_last( bstree ) == 0 );
...
void test_is_last_1a( void )
{
   ...
   CU_ASSERT( ii_bstree_kv_is_last( bstree ) == 1 );
...
void test_is_last_7( void )
{
   ...
   CU_ASSERT( ss_bstree_kv_is_last( bstree ) == 0 );
 
   ss_bstree_kv_finish( bstree );
   
   CU_ASSERT( ss_bstree_kv_is_last( bstree ) == 1 );
