/**
 @file BSTree_kv_test_cursor_search_forth.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_forth_1( void )
{
   ...
   ii_bstree_kv_cursor_search_forth( cursor, 1 );
...
void test_cursor_search_forth_2( void )
{
   ...
   ii_bstree_kv_cursor_start( cursor );
   ii_bstree_kv_cursor_search_forth( cursor, 10 );
...
void test_cursor_search_forth_3( void )
{
   ...
   ii_bstree_kv_cursor_start( cursor );
   ii_bstree_kv_cursor_search_forth( cursor, 20 );
   CU_ASSERT( ii_bstree_kv_cursor_off( cursor ) == 0 );
...
void test_cursor_search_forth_5( void )
{
   ...
   ss_bstree_kv_cursor_search_forth( cursor, s20 );
