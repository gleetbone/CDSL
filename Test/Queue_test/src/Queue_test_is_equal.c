/**
 @file Queue_test_is_equal.c
 @author Greg Lee
 @version 2.0.0
 @brief: "tests for Queue_is_equal"
...
void test_is_equal_3( void )
{
   ...
   CU_ASSERT( int_queue_is_equal( list, list1 ) == 0 );
...
void test_is_equal_5( void )
{
   ...
   CU_ASSERT( s_queue_is_equal( list, list2 ) == 0 );
