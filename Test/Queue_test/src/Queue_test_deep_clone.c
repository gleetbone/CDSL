...
void test_deep_clone_1( void )
{
   ...
   int_queue_t *list_1 = int_queue_deep_clone( list );
...
void test_deep_clone_2a( void )
{
   ...
   CU_ASSERT( list_1 != NULL );
   CU_ASSERT( int_queue_count( list_1 ) == 2 );
   CU_ASSERT( int_queue_is_empty( list_1 ) == 0 );
   CU_ASSERT( int_queue_item( list_1 ) == 24 );
