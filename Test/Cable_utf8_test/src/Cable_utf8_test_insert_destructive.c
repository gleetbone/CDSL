/**
 @file Cable_utf8_test_insert_destructive.c
 @author Greg Lee
 @version 2.0.0
...
void test_insert_destructive_1( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 0 );
...
void test_insert_destructive_2( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 1 );
...
void test_insert_destructive_3( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 2 );
...
void test_insert_destructive_4( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 3 );
...
void test_insert_destructive_17( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 4 );
...
void test_insert_destructive_18( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 5 );
...
void test_insert_destructive_19( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 6 );
...
void test_insert_destructive_20( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 7 );
...
void test_insert_destructive_21( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 8 );
...
void test_insert_destructive_22( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 9 );
...
void test_insert_destructive_23( void )
{
   ...
   cable_utf8_insert_destructive( cable, &cable1, 10 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefghijxyz" ) == 1 );
   CU_ASSERT( cable1 == NULL );
...
/**
   test_insert_destructive_24
*/

void test_insert_destructive_24( void )
{
   cable_utf8_t *cable = NULL;
   cable_utf8_t *cable1 = NULL;
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "bcxyzfghij" ) == 1 );
   CU_ASSERT( cable1 == NULL );
...
add_test_insert_destructive( void )
{
   ...
   // test_insert_destructive_24
   add_test_to_suite( p_suite, test_insert_destructive_24, "test_insert_destructive_24" );
