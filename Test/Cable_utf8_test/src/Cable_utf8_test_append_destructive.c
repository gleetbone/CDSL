/**
 @file Cable_utf8_test_append_destructive.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_append_destructive_1
*/

void test_append_destructive_1( void )
{
   ...
   cable_utf8_append_destructive( cable, &cable1 );
...
/**
   test_append_destructive_2
*/

void test_append_destructive_2( void )
{
   cable_utf8_t *cable = NULL;
   cable_utf8_t *cable1 = NULL;
...
/**
   test_append_destructive_3
*/

void test_append_destructive_3( void )
{
   cable_utf8_t *cable = NULL;
   cable_utf8_t *cable1 = NULL;
...
/**
   test_append_destructive_4
*/

void test_append_destructive_4( void )
{
   cable_utf8_t *cable = NULL;
   cable_utf8_t *cable1 = NULL;
...
add_test_append_destructive( void )
{
   ...
   p_suite = CU_add_suite("suite_test_append_destructive", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_append_destructive_1
   add_test_to_suite( p_suite, test_append_destructive_1, "test_append_destructive_1" );

   // test_append_destructive_2
   add_test_to_suite( p_suite, test_append_destructive_2, "test_append_destructive_2" );

   // test_append_destructive_3
   add_test_to_suite( p_suite, test_append_destructive_3, "test_append_destructive_3" );

   // test_append_destructive_4
   add_test_to_suite( p_suite, test_append_destructive_4, "test_append_destructive_4" );
