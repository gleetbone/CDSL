/**
 @file Cable_utf8_test_make_capacity_from_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_make_capacity_from_cstring_1( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcd", 10 );

   CU_ASSERT( cable != NULL );
   CU_ASSERT( cable_utf8_byte_count( cable ) == 4 );
   CU_ASSERT( cable_utf8_capacity( cable ) == 10 );
...
void test_make_capacity_from_cstring_2( void )
{
   ...
   cp = cable_utf8_as_cstring( cable );
