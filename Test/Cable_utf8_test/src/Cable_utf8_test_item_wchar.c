/**
 @file Cable_utf8_test_item_wchar.c
 @author Greg Lee
 @version 2.0.0
...
void test_item_wchar_1( void )
{
   ...
   c = cable_utf8_item_wchar( cable, 0 );
   CU_ASSERT( c == ( uint32_t ) 0x03B1 );
   
   c = cable_utf8_item_wchar( cable, 1 );
   CU_ASSERT( c == ( uint32_t ) 0x05D0 );
   
   c = cable_utf8_item_wchar( cable, 2 );
   CU_ASSERT( c == ( uint32_t ) 0x0904 );
   
   c = cable_utf8_item_wchar( cable, 3 );
...
void test_item_wchar_2( void )
{
   ...
   c = cable_utf8_item_wchar( cable, 4 );
   CU_ASSERT( c == ( uint32_t ) 0x12000 );
...
void test_item_wchar_3( void )
{
   ...
   c = cable_utf8_item_wchar( cable, 5 );
   CU_ASSERT( c == ( uint32_t ) 0x12000 );
...
void test_item_wchar_4( void )
{
   ...
   c = cable_utf8_item_wchar( cable, 6 );
   CU_ASSERT( c == ( uint32_t ) 0x12000 );
...
void test_item_wchar_5( void )
{
   ...
   c = cable_utf8_item_wchar( cable, 7 );
   CU_ASSERT( c == ( uint32_t ) 0x12000 );
...
add_test_item_wchar( void )
{
   ...
   // test_item_wchar_1
   add_test_to_suite( p_suite, test_item_wchar_1, "test_item_wchar_1" );

   // test_item_wchar_2
   add_test_to_suite( p_suite, test_item_wchar_2, "test_item_wchar_2" );

   // test_item_wchar_3
   add_test_to_suite( p_suite, test_item_wchar_3, "test_item_wchar_3" );

   // test_item_wchar_4
   add_test_to_suite( p_suite, test_item_wchar_4, "test_item_wchar_4" );

   // test_item_wchar_5
   add_test_to_suite( p_suite, test_item_wchar_5, "test_item_wchar_5" );
