/**
 @file Cable_utf8_test_as_lower.c
 @author Greg Lee
 @version 2.0.0
...
void test_as_lower_1( void )
{
   ...
   cable1 = cable_utf8_as_lower( cable, 0, 0 );
   ...
   cable1 = cable_utf8_as_lower( cable, 2, 3 );
...
void test_as_lower_2( void )
{
   ...
   cable1 = cable_utf8_as_lower( cable, 3, 5 );

   CU_ASSERT( cable1 != NULL );
   CU_ASSERT( cable_utf8_is_equal_cstring( cable1, "def" ) == 1 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_as_lower( cable, 7, 9 );

   CU_ASSERT( cable1 != NULL );
   CU_ASSERT( cable_utf8_is_equal_cstring( cable1, "hij" ) == 1 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_as_lower( cable, 0, 9 );

   CU_ASSERT( cable1 != NULL );
   CU_ASSERT( cable_utf8_is_equal_cstring( cable1, "abcdefghij" ) == 1 );
   cable_utf8_dispose( &cable1 );
