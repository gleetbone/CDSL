/**
 @file Cable_utf8_test_insert_character.c
 @author Greg Lee
 @version 2.0.0
...
void test_insert_character_1( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 0 );
...
void test_insert_character_2( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 1 );
...
void test_insert_character_3( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 2 );
...
void test_insert_character_4( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 3 );
...
void test_insert_character_5( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 4 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxefghij" ) == 1 );
...
void test_insert_character_6( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexfghij" ) == 1 );
...
void test_insert_character_7( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 6 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefxghij" ) == 1 );
...
void test_insert_character_8( void )
{
   ...
   cable_utf8_insert_character( cable, "x", 7 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefgxhij" ) == 1 );
