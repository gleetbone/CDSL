/**
 @file Cable_utf8_test_replace_all_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_all_cstring_1( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "a", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xybcd" ) == 1 );
...
void test_replace_all_cstring_2( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "a", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xyzbcd" ) == 1 );
...
void test_replace_all_cstring_3( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "a", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xbcd" ) == 1 );
...
void test_replace_all_cstring_4( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "bc", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axyd" ) == 1 );
...
void test_replace_all_cstring_5( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "bc", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axyzd" ) == 1 );
...
void test_replace_all_cstring_6( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "bc", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axd" ) == 1 );
...
void test_replace_all_cstring_4a( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "b", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axcd" ) == 1 );
...
void test_replace_all_cstring_5a( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "b", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axycd" ) == 1 );
...
void test_replace_all_cstring_7( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "d", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcxy" ) == 1 );
...
void test_replace_all_cstring_8( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "d", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcxyz" ) == 1 );
...
void test_replace_all_cstring_9( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "d", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcx" ) == 1 );
...
void test_replace_all_cstring_10( void )
{
   ...
   cable = cable_utf8_make_from_cstring( "xyzMxyzMMxyz" );

   CU_ASSERT( cable != NULL );

   cable_utf8_replace_all_cstring( cable, "xyz", "a" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "aMaMMa" ) == 1 );
...
void test_replace_all_cstring_11( void )
{
   ...
   cable = cable_utf8_make_from_cstring( "abcMabcMMabc" );

   CU_ASSERT( cable != NULL );

   cable_utf8_replace_all_cstring( cable, "abc", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xyzMxyzMMxyz" ) == 1 );
...
void test_replace_all_cstring_12( void )
{
   ...
   cable = cable_utf8_make_from_cstring( "aMaMMa" );
...
void test_replace_all_cstring_13( void )
{
   ...
   cable = cable_utf8_make_from_cstring( "abcdefghij" );

   CU_ASSERT( cable != NULL );

   cable_utf8_replace_all_cstring( cable, "e", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxyfghij" ) == 1 );
...
void test_replace_all_cstring_14( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "e", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxyzfghij" ) == 1 );
...
void test_replace_all_cstring_15( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "e", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxfghij" ) == 1 );
...
void test_replace_all_cstring_16( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "fg", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexyhij" ) == 1 );
...
void test_replace_all_cstring_17( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "fg", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexyzhij" ) == 1 );
...
void test_replace_all_cstring_18( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "fg", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexhij" ) == 1 );
...
void test_replace_all_cstring_16a( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "f", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexghij" ) == 1 );
...
void test_replace_all_cstring_19( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "h", "xy" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefgxyij" ) == 1 );
...
void test_replace_all_cstring_20( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "h", "xyz" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefgxyzij" ) == 1 );
...
void test_replace_all_cstring_21( void )
{
   ...
   cable_utf8_replace_all_cstring( cable, "h", "x" );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefgxij" ) == 1 );
...
void test_replace_all_cstring_22( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "xyzMxyzMMxyz", 4 );
...
void test_replace_all_cstring_23( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcMabcMMabc", 4 );
...
void test_replace_all_cstring_24( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "aMaMMa", 4 );
