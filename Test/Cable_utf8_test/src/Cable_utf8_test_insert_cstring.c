/**
 @file Cable_utf8_test_insert_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_insert_cstring_1( void )
{
   ...
   cable_utf8_insert_cstring( cable, "x", 0 );
...
void test_insert_cstring_2( void )
{
   ...
   cable_utf8_insert_cstring( cable, "x", 1 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axbcd" ) == 1 );
...
void test_insert_cstring_3( void )
{
   ...
   cable_utf8_insert_cstring( cable, "x", 2 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abxcd" ) == 1 );
...
void test_insert_cstring_4( void )
{
   ...
   cable_utf8_insert_cstring( cable, "x", 3 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcxd" ) == 1 );
...
void test_insert_cstring_5( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 0 );
...
void test_insert_cstring_6( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 1 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axyzbcd" ) == 1 );
...
void test_insert_cstring_7( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 2 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abxyzcd" ) == 1 );
...
void test_insert_cstring_8( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 3 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcxyzd" ) == 1 );
...
void test_insert_cstring_10( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axbcdefghij" ) == 1 );
...
void test_insert_cstring_11( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abxcdefghij" ) == 1 );
...
void test_insert_cstring_12( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcxdefghij" ) == 1 );
...
void test_insert_cstring_14( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "axyzbcdefghij" ) == 1 );
...
void test_insert_cstring_15( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abxyzcdefghij" ) == 1 );
...
void test_insert_cstring_16( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcxyzdefghij" ) == 1 );
...
void test_insert_cstring_17( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 4 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxyzefghij" ) == 1 );
...
void test_insert_cstring_18( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexyzfghij" ) == 1 );
...
void test_insert_cstring_19( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 6 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefxyzghij" ) == 1 );
...
void test_insert_cstring_20( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 7 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefgxyzhij" ) == 1 );
...
void test_insert_cstring_21( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 8 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefghxyzij" ) == 1 );
...
void test_insert_cstring_22( void )
{
   ...
   cable_utf8_insert_cstring( cable, "xyz", 9 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefghixyzj" ) == 1 );
...
void test_insert_cstring_23( void )
{
   ...
   cable_utf8_insert_cstring( cable, "abcde", 0 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcde" ) == 1 );
...
void test_insert_cstring_24( void )
{
   ...
   cable_utf8_insert_cstring( cable, "abcde", 0 );
   cable_utf8_insert_cstring( cable, "abcd", 4 );
   cable_utf8_insert_cstring( cable, "abcdefg", 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdaabcdefgbcde" ) == 1 );
...
void test_insert_cstring_25( void )
{
   ...
   cable_utf8_insert_cstring( cable, "abc", 0 );
...
void test_insert_cstring_26( void )
{
   ...
   cable_utf8_insert_cstring( cable, "abcdefgh", 0 );

   cable_utf8_remove_substring( cable, 3, 4 );

   cable_utf8_insert_cstring( cable, "x", 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcfgxh" ) == 1 );
