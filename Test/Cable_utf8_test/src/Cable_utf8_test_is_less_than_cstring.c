/**
 @file Cable_utf8_test_is_less_than_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_less_than_cstring_1( void )
{
   ...
   CU_ASSERT( cable_utf8_is_less_than_cstring( cable, cable1 ) == 1 );
...
void test_is_less_than_cstring_1a( void )
{
   ...
   CU_ASSERT( cable != NULL );
   CU_ASSERT( cable1 != NULL );
   CU_ASSERT( cable_utf8_is_less_than_cstring( cable, cable1 ) == 0 );
...
{
   cable_utf8_t *cable = NULL;
   char_t *cable1 = NULL;cable_utf8_t *
   cable_utf8_make_capacity( int32_t capacity );
