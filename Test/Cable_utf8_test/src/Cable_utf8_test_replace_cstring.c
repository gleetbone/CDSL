/**
 @file Cable_utf8_test_replace_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_cstring_1( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xy", 0, 1 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xycd" ) == 1 );
...
void test_replace_cstring_2( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xyz", 0, 1 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xyzcd" ) == 1 );
...
void test_replace_cstring_3( void )
{
   ...
   cable_utf8_replace_cstring( cable, "x", 0, 1 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "xcd" ) == 1 );
...
void test_replace_cstring_4( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xy", 1, 2 );
...
void test_replace_cstring_5( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xyz", 1, 2 );
...
void test_replace_cstring_6( void )
{
   ...
   cable_utf8_replace_cstring( cable, "x", 1, 2 );
...
void test_replace_cstring_7( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xy", 2, 3 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abxy" ) == 1 );
...
void test_replace_cstring_8( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xyz", 2, 3 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abxyz" ) == 1 );
...
void test_replace_cstring_9( void )
{
   ...
   cable_utf8_replace_cstring( cable, "x", 2, 3 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abx" ) == 1 );
...
void test_replace_cstring_10( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xy", 4, 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxyghij" ) == 1 );
...
void test_replace_cstring_11( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xyz", 4, 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxyzghij" ) == 1 );
...
void test_replace_cstring_12( void )
{
   ...
   cable_utf8_replace_cstring( cable, "x", 4, 5 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxghij" ) == 1 );
...
void test_replace_cstring_13( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xy", 5, 6 );
...
void test_replace_cstring_14( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xyz", 5, 6 );
...
void test_replace_cstring_15( void )
{
   ...
   cable_utf8_replace_cstring( cable, "x", 5, 6 );
...
void test_replace_cstring_16( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xy", 6, 7 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefxyij" ) == 1 );
...
void test_replace_cstring_17( void )
{
   ...
   cable_utf8_replace_cstring( cable, "xyz", 6, 7 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefxyzij" ) == 1 );
...
void test_replace_cstring_18( void )
{
   ...
   cable_utf8_replace_cstring( cable, "x", 6, 7 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefxij" ) == 1 );
