/**
 @file Cable_utf8_test_replace_all.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_all_2( void )
{
   ...
   cable = cable_utf8_make_from_cstring( "abcd" );
   cable1 = cable_utf8_make_from_cstring( "a" );
   cable2 = cable_utf8_make_from_cstring( "xyz" );
...
void test_replace_all_3( void )
{
   ...
   cable = cable_utf8_make_from_cstring( "abcd" );
   cable1 = cable_utf8_make_from_cstring( "a" );
   cable2 = cable_utf8_make_from_cstring( "x" );
...
void test_replace_all_10( void )
{
   ...
   cable2 = cable_utf8_make_from_cstring( "a" );
...
void test_replace_all_13( void )
{
   ...
   cable1 = cable_utf8_make_from_cstring( "e" );
   cable2 = cable_utf8_make_from_cstring( "xy" );
...
void test_replace_all_16( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcdefghij", 4 );
   cable1 = cable_utf8_make_from_cstring( "fg" );
   cable2 = cable_utf8_make_from_cstring( "xy" );
...
void test_replace_all_16a( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcdefghij", 4 );
   cable1 = cable_utf8_make_from_cstring( "f" );
   cable2 = cable_utf8_make_from_cstring( "x" );
...
void test_replace_all_17a( void )
{
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdexyghij" ) == 1 );
...
void test_replace_all_19( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcdefghij", 4 );
   cable1 = cable_utf8_make_from_cstring( "h" );
   cable2 = cable_utf8_make_from_cstring( "xy" );
