/**
 @file Cable_utf8_test_byte_count.c
 @author Greg Lee
 @version 2.0.0
...
void test_byte_count_1( void )
{
   ...
   CU_ASSERT( cable_utf8_byte_count( cable1 ) == 0 );
...
void test_byte_count_2( void )
{
   ...
   CU_ASSERT( cable1 != NULL );
   CU_ASSERT( cable_utf8_byte_count( cable1 ) == 10 );
   CU_ASSERT( cable_utf8_is_empty( cable1 ) == 0 );
   CU_ASSERT( cable_utf8_capacity( cable1 ) == 4 );
...
add_test_byte_count( void )
{
   ...
   p_suite = CU_add_suite("suite_test_byte_count", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_byte_count_1
   add_test_to_suite( p_suite, test_byte_count_1, "test_byte_count_1" );

   // test_byte_count_2
   add_test_to_suite( p_suite, test_byte_count_2, "test_byte_count_2" );
