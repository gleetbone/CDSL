/**
 @file Cable_utf8_test_starts_with_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_starts_with_cstring_1( void )
{
   ...
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "a" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "ab" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abc" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abcd" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "d" ) == 0 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "ad" ) == 0 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "bd" ) == 0 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "A" ) == 0 );
...
void test_starts_with_cstring_2( void )
{
   ...
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abc" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abcd" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abcde" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abcdefgh" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "abcdefghi" ) == 1 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "d" ) == 0 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "ad" ) == 0 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "bd" ) == 0 );
   CU_ASSERT( cable_utf8_starts_with_cstring( cable, "A" ) == 0 );
