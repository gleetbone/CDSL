...
void test_insert_1( void )
{
   ...
   cable_utf8_insert( cable, cable1, 0 );
...
void test_insert_2( void )
{
   ...
   cable_utf8_insert( cable, cable1, 1 );
...
void test_insert_3( void )
{
   ...
   cable_utf8_insert( cable, cable1, 2 );
...
void test_insert_4( void )
{
   ...
   cable_utf8_insert( cable, cable1, 3 );
...
void test_insert_17( void )
{
   ...
   cable_utf8_insert( cable, cable1, 4 );
...
void test_insert_18( void )
{
   ...
   cable_utf8_insert( cable, cable1, 5 );
...
void test_insert_19( void )
{
   ...
   cable_utf8_insert( cable, cable1, 6 );
...
void test_insert_20( void )
{
   ...
   cable_utf8_insert( cable, cable1, 7 );
...
void test_insert_21( void )
{
   ...
   cable_utf8_insert( cable, cable1, 8 );
...
void test_insert_22( void )
{
   ...
   cable_utf8_insert( cable, cable1, 9 );
