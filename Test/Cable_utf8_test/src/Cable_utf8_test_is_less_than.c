/**
 @file Cable_utf8_test_is_less_than.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_less_than_1( void )
{
   ...
   CU_ASSERT( cable_utf8_is_less_than( cable, cable1 ) == 1 );
...
void test_is_less_than_2( void )
{
   ...
   CU_ASSERT( cable != NULL );
   CU_ASSERT( cable1 != NULL );
   CU_ASSERT( cable_utf8_is_less_than( cable, cable1 ) == 0 );
...
void test_is_less_than_5( void )
{
   ...
   cable1 = cable_utf8_make_capacity_from_cstring( "abceefghi", 4 );
...
void test_is_less_than_7( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcefghi", 4 );
   cable1 = cable_utf8_make_capacity_from_cstring( "abcdefghi", 4 );
