/**
 @file Cable_utf8_test_ends_with_cstring.c
 @author Greg Lee
 @version 2.0.0
...
void test_ends_with_cstring_1( void )
{
   ...
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "d" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "cd" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "bcd" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "abcd" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "a" ) == 0 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "bd" ) == 0 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "ac" ) == 0 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "A" ) == 0 );
...
void test_ends_with_cstring_2( void )
{
   ...
   CU_ASSERT( cable != NULL );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "j" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "ij" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "hij" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "efghij" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "defghij" ) == 1 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "a" ) == 0 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "bd" ) == 0 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "ac" ) == 0 );
   CU_ASSERT( cable_utf8_ends_with_cstring( cable, "A" ) == 0 );
