/**
 @file Cable_utf8_test_replace.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_1( void )
{
   ...
   cable1 = cable_utf8_make_from_cstring( "xy" );

   CU_ASSERT( cable != NULL );
   CU_ASSERT( cable1 != NULL );

   cable_utf8_replace( cable, cable1, 0, 1 );
...
void test_replace_4( void )
{
   ...
   cable_utf8_replace( cable, cable1, 1, 2 );
...
void test_replace_7( void )
{
   ...
   cable_utf8_replace( cable, cable1, 2, 3 );
...
void test_replace_10( void )
{
   ...
   cable_utf8_replace( cable, cable1, 4, 5 );
...
void test_replace_12( void )
{
   ...
   cable_utf8_replace( cable, cable1, 4, 6 );

   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdxhij" ) == 1 );
...
void test_replace_13( void )
{
   ...
   cable_utf8_replace( cable, cable1, 5, 6 );
...
void test_replace_16( void )
{
   ...
   cable_utf8_replace( cable, cable1, 6, 7 );
...
void test_replace_19( void )
{
   ...
   cable = cable_utf8_make_capacity_from_cstring( "abcdefghij", 4 );
   cable1 = cable_utf8_make_capacity_from_cstring( "vwxyz", 4 );
   ...
   CU_ASSERT( cable_utf8_is_equal_cstring( cable, "abcdefvwxyzij" ) == 1 );
