/**
 @file Cable_utf8_test_substring_index.c
 @author Greg Lee
 @version 2.0.0
...
void test_substring_index_1( void )
{
   ...
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 0 );
   ...
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 1 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_make_from_cstring( "cd" );
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 2 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_make_from_cstring( "d" );
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 3 );
   cable_utf8_dispose( &cable1 );
...
void test_substring_index_2( void )
{
   ...
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 4 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_make_from_cstring( "gh" );
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 6 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_make_from_cstring( "ghi" );
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 6 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_make_from_cstring( "ij" );
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 8 );
   cable_utf8_dispose( &cable1 );

   cable1 = cable_utf8_make_from_cstring( "j" );
   CU_ASSERT( cable_utf8_substring_index( cable, cable1 ) == 9 );
   cable_utf8_dispose( &cable1 );
