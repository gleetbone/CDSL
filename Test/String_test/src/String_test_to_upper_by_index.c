/**
 @file string_test_to_upper_by_index.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_to_upper_by_index_1
*/

void test_to_upper_by_index_1( void )
{
   string_t *string = NULL;
   
   string = string_make_from_cstring( "abCd5" );
   
   string_to_upper_by_index( string, 0, 1 );
...
add_test_to_upper_by_index( void )
{
   ...
   p_suite = CU_add_suite("suite_test_to_upper_by_index", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_to_upper_by_index_1
   add_test_to_suite( p_suite, test_to_upper_by_index_1, "test_to_upper_by_index_1" );
