...
void test_is_float64_1( void )
{
   ...
   CU_ASSERT( string_is_float64( string ) == 0 );
...
void test_is_float64_2( void )
{
   ...
   CU_ASSERT( string_is_float64( string ) == 1 );
...
void test_is_float64_3( void )
{
   ...
   string = string_make_from_cstring( "123.456" );
...
void test_is_float64_6( void )
{
   ...
   string = string_make_from_cstring( ".123E4" );
