/**
 @file string_test_from_file_cstring.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_from_file_cstring_1
*/

void test_from_file_cstring_1( void )
{
   FILE *fp = NULL;
   ...
   string_t *string = string_from_file_cstring( "test.txt" );
...
add_test_from_file_cstring( void )
{
   ...
   // test_from_file_cstring_1
   add_test_to_suite( p_suite, test_from_file_cstring_1, "test_from_file_cstring_1" );
