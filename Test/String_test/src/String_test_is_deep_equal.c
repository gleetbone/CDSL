/**
 @file string_test_is_deep_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_deep_equal_1( void )
{
   ...
   CU_ASSERT( string_is_deep_equal( string, string1 ) == 1 );
...
void test_is_deep_equal_2( void )
{
   ...
   CU_ASSERT( string_is_deep_equal( string, string1 ) == 0 );
...
void test_is_deep_equal_6( void )
{
   ...
   CU_ASSERT( string_is_deep_equal( string, string ) == 1 );
...
add_test_is_deep_equal( void )
{
   ...
   // test_is_deep_equal_3
   add_test_to_suite( p_suite, test_is_deep_equal_3, "test_is_deep_equal_4" );
