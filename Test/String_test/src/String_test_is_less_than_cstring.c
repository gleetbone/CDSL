/**
 @file string_test_is_less_than_cstring.c
 @author Greg Lee
 @version 1.0.0
...
void test_is_less_than_cstring_1( void )
{
   ...
   CU_ASSERT( string_is_less_than_cstring( string, "A" ) == 0 );
...
void test_is_less_than_cstring_2( void )
{
   ...
   CU_ASSERT( string_is_less_than_cstring( string, "B" ) == 1 );
...
void test_is_less_than_cstring_3( void )
{
   ...
   CU_ASSERT( string_is_less_than_cstring( string, "ABCDEFGHI" ) == 0 );
...
void test_is_less_than_cstring_4( void )
{
   ...
   CU_ASSERT( string_is_less_than_cstring( string, "ABCDEFGHI2" ) == 1 );
...
void test_is_less_than_cstring_5( void )
{
   ...
   CU_ASSERT( string_is_less_than_cstring( string, "ABC" ) == 0 );
...
add_test_is_less_than_cstring( void )
{
   ...
   // test_is_less_than_cstring_3
   add_test_to_suite( p_suite, test_is_less_than_cstring_3, "test_is_less_than_cstring_4" );
