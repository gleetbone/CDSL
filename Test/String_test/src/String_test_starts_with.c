/**
 @file string_test_starts_with.c
 @author Greg Lee
 @version 1.0.0
...
void test_starts_with_1( void )
{
   ...
   CU_ASSERT( string_starts_with( string, string1 ) == 1 );
...
void test_starts_with_2( void )
{
   ...
   CU_ASSERT( string_starts_with( string, string1 ) == 0 );
...
void test_starts_with_5( void )
{
   ...
   string1 = string_make_from_cstring( "CDE" );
