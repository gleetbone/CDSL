...
void test_has_substring_3( void )
{
   string_t *string = NULL;
   string_t *string1 = NULL;
...
void test_has_substring_4( void )
{
   string_t *string = NULL;
   string_t *string1 = NULL;
   
   string = string_make_from_cstring( "ABC" );
   string1 = string_make_from_cstring( "D" );
...
/**
   test_has_substring_5
*/

void test_has_substring_5( void )
{
   string_t *string = NULL;
   string_t *string1 = NULL;
...
add_test_has_substring( void )
{
   ...
   // test_has_substring_5
   add_test_to_suite( p_suite, test_has_substring_5, "test_has_substring_5" );
