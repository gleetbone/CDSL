...
solution( name )
   ...
   project( name )
      ...
      includedirs { "src", "../../base", "../../dbc", "../../PQueue", "../../Protocol_Base", "../../P_Indexable", "../../P_Iterable", "../../P_Iterable_kv", "../../P_DIterable", "../../P_DIterable_kv", "../../P_Clonable", "../../P_Searcher", "../../P_Sorter"  }
