/**
 @file date_time_duration_test_is_overlap.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_overlap_1( void )
{
   ...
   flag = date_time_duration_is_overlap( date_time_duration, date_time_duration_1 );   
   CU_ASSERT( flag == 0 );
...
add_test_is_overlap( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_overlap", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_overlap_1
   add_test_to_suite( p_suite, test_is_overlap_1, "test_is_overlap_1" );

   // test_is_overlap_2
   add_test_to_suite( p_suite, test_is_overlap_2, "test_is_overlap_2" );

   // test_is_overlap_3
   add_test_to_suite( p_suite, test_is_overlap_3, "test_is_overlap_3" );

   // test_is_overlap_4
   add_test_to_suite( p_suite, test_is_overlap_4, "test_is_overlap_4" );
