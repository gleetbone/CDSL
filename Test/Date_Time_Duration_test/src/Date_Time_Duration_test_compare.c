/**
 @file date_time_duration_test_compare.c
 @author Greg Lee
 @version 2.0.0
...
void test_compare_1( void )
{
   ...
   CU_ASSERT( date_time_duration_compare( date_time_duration, date_time_duration_2 ) == -1 );
   CU_ASSERT( date_time_duration_compare( date_time_duration, date_time_duration ) == 0 );
   CU_ASSERT( date_time_duration_compare( date_time_duration, date_time_duration_1 ) == 0 );
   CU_ASSERT( date_time_duration_compare( date_time_duration_2, date_time_duration ) == 1 );
