/**
 @file date_time_duration_test_put_duration_dhms.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_put_duration_dhms_1
*/

void test_put_duration_dhms_1( void )
{
   ...
   date_time_duration_put_duration_dhms( date_time_duration, 0, 1, 0, 0, 1 );
...
add_test_put_duration_dhms( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_duration_dhms", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_duration_dhms_1
   add_test_to_suite( p_suite, test_put_duration_dhms_1, "test_put_duration_dhms_1" );
