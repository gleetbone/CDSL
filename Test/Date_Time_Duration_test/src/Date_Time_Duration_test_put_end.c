/**
 @file date_time_duration_test_put_end.c
 @author Greg Lee
 @version 2.0.0
...
void test_put_end_1( void )
{
   ...
   end_dt_1 = date_time_make( 2020, 1, 1, 1, 0, 0, 1 );
   date_time_duration_put_end( date_time_duration, end_dt_1 );
...
add_test_put_end( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_end", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_end_1
   add_test_to_suite( p_suite, test_put_end_1, "test_put_end_1" );
