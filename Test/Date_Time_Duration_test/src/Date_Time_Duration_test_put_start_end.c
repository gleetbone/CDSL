/**
 @file date_time_duration_test_put_start_end.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_put_start_end_1
*/

void test_put_start_end_1( void )
{
   date_time_t *start_dt = NULL;
   date_time_t *start_dt_1 = NULL;
   date_time_t *end_dt = NULL;
   date_time_t *end_dt_1 = NULL;
   date_time_t *dt = NULL;
   ...
   end_dt_1 = date_time_make( 2000, 1, 1, 0, 0, 1, 0 );
   date_time_duration_put_start_end( date_time_duration, start_dt_1, end_dt_1 );
...
add_test_put_start_end( void )
{
   ...
   p_suite = CU_add_suite("suite_test_put_start_end", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_put_start_end_1
   add_test_to_suite( p_suite, test_put_start_end_1, "test_put_start_end_1" );
