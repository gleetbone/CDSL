/**
 @file date_time_duration_test_milliseconds_part.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_milliseconds_part_1
*/

void test_milliseconds_part_1( void )
{
   ...
   CU_ASSERT( date_time_duration_milliseconds_part( date_time_duration ) == 5 );
...
add_test_milliseconds_part( void )
{
   ...
   p_suite = CU_add_suite("suite_test_milliseconds_part", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_milliseconds_part_1
   add_test_to_suite( p_suite, test_milliseconds_part_1, "test_milliseconds_part_1" );
