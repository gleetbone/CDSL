/**
 @file date_time_duration_test_is_earlier_than.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_is_earlier_than_1
*/

void test_is_earlier_than_1( void )
{
   ...
   CU_ASSERT( date_time_duration_is_earlier_than( date_time_duration, date_time_duration ) == 0 );
   CU_ASSERT( date_time_duration_is_earlier_than( date_time_duration, date_time_duration_1 ) == 1 );
...
add_test_is_earlier_than( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_earlier_than", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_earlier_than_1
   add_test_to_suite( p_suite, test_is_earlier_than_1, "test_is_earlier_than_1" );
