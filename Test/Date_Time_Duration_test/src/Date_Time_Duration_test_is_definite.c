/**
 @file date_time_duration_test_is_definite.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_definite_2( void )
{
   date_time_duration_t *date_time_duration = NULL;
   
   date_time_duration = date_time_duration_make_milliseconds( 3600000 );
...
add_test_is_definite( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_definite", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_definite_1
   add_test_to_suite( p_suite, test_is_definite_1, "test_is_definite_1" );

   // test_is_definite_2
   add_test_to_suite( p_suite, test_is_definite_2, "test_is_definite_2" );
