/**
 @file date_time_duration_test_is_greater_than_or_equal.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_greater_than_or_equal_1( void )
{
   ...
   CU_ASSERT( date_time_duration_is_greater_than_or_equal( date_time_duration, date_time_duration ) == 1 );
   CU_ASSERT( date_time_duration_is_greater_than_or_equal( date_time_duration, date_time_duration_1 ) == 1 );
