/**
 @file date_time_duration_test_make_start_milliseconds.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_make_start_milliseconds_1
*/

void test_make_start_milliseconds_1( void )
{
   ...
   date_time_duration = date_time_duration_make_start_milliseconds( start_dt, 3600000L );
...
add_test_make_start_milliseconds( void )
{
   ...
   p_suite = CU_add_suite("suite_test_make_start_milliseconds", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_make_start_milliseconds_1
   add_test_to_suite( p_suite, test_make_start_milliseconds_1, "test_make_start_milliseconds_1" );
