/**
 @file date_time_duration_test_hours_part.c
 @author Greg Lee
 @version 2.0.0
...
void test_hours_part_1( void )
{
   ...
   CU_ASSERT( date_time_duration_hours_part( date_time_duration ) == 2 );
...
add_test_hours_part( void )
{
   ...
   p_suite = CU_add_suite("suite_test_hours_part", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_hours_part_1
   add_test_to_suite( p_suite, test_hours_part_1, "test_hours_part_1" );
