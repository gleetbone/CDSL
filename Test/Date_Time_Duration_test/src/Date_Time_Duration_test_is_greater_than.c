/**
 @file date_time_duration_test_is_greater_than.c
 @author Greg Lee
 @version 2.0.0
...
void test_is_greater_than_1( void )
{
   ...
   CU_ASSERT( date_time_duration_is_greater_than( date_time_duration, date_time_duration ) == 0 );
   CU_ASSERT( date_time_duration_is_greater_than( date_time_duration, date_time_duration_1 ) == 1 );
