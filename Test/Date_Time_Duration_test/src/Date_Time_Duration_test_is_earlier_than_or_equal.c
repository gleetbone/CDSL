/**
 @file date_time_duration_test_is_earlier_than_or_equal.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_is_earlier_than_or_equal_1
*/

void test_is_earlier_than_or_equal_1( void )
{
   ...
   end_dt = date_time_make( 2020, 2, 1, 1, 0, 0, 0 );
   ...
   CU_ASSERT( date_time_duration_is_earlier_than_or_equal( date_time_duration, date_time_duration ) == 1 );
   CU_ASSERT( date_time_duration_is_earlier_than_or_equal( date_time_duration, date_time_duration_1 ) == 1 );
...
add_test_is_earlier_than_or_equal( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_earlier_than_or_equal", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_earlier_than_or_equal_1
   add_test_to_suite( p_suite, test_is_earlier_than_or_equal_1, "test_is_earlier_than_or_equal_1" );
