/**
 @file date_time_duration_test_deep_copy.c
 @author Greg Lee
 @version 2.0.0
...
void test_deep_copy_1( void )
{
   ...
   date_time_duration_1 = date_time_duration_make_start_dhms( end_dt, 0, 2, 0, 0, 0 );

   date_time_duration_deep_copy( date_time_duration_1, date_time_duration );
   
   dt = date_time_duration_start( date_time_duration_1 );
   CU_ASSERT( date_time_is_equal( start_dt, dt ) == 1 );
   date_time_dispose( &dt );
   
   dt = date_time_duration_end( date_time_duration_1 );
   CU_ASSERT( date_time_is_equal( end_dt, dt ) == 1 );
   date_time_dispose( &dt );
   
   CU_ASSERT( date_time_duration_duration_milliseconds( date_time_duration_1 ) == 3600000L );
   CU_ASSERT( date_time_duration_is_definite( date_time_duration_1 ) == 1 );
