...
{
   i_bsorter_t *sorter = i_bsorter_make();
...
void test_all_6( void )
{
   ...
   CU_ASSERT( i_sequence_item( seq, 1 ) == 2 );
   CU_ASSERT( i_sequence_item( seq, 2 ) == 3 );
   CU_ASSERT( i_sequence_item( seq, 3 ) == 3 );
   CU_ASSERT( i_sequence_item( seq, 4 ) == 5 );
   CU_ASSERT( i_sequence_item( seq, 5 ) == 6 );
...
add_test_all( void )
{
   ...
   // test_all_6
   add_test_to_suite( p_suite, test_all_6, "test_all_6" );
