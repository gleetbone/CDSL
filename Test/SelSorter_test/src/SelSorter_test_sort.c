...
void test_sort_4( void )
{
   ...
   result = i_selsorter_is_sorted( pb_seq, func );
   CU_ASSERT( result == 1 );
...
void test_sort_5( void )
{
   ...
   result = i_selsorter_is_sorted_predefined_comparison_function( sorter, pb_seq );
   CU_ASSERT( result == 0 );

   i_selsorter_sort_predefined_comparison_function( sorter, pb_seq );
