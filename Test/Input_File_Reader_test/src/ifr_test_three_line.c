...
void test_three_line_1( void )
{
   ...
   file_name = string_make_from_cstring( "src/input_files/f_three_line.txt" );
...
add_test_three_line( void )
{
   ...
   p_suite = CU_add_suite("suite_test_three_line", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_three_line_1
   add_test_to_suite( p_suite, test_three_line_1, "test_three_line_1" );
