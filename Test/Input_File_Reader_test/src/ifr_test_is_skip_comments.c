/**
 @file ifr_test_is_skip_comments.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_is_skip_comments_1
*/

void test_is_skip_comments_1( void )
{
   ifr_t *ifr = NULL;
...
add_test_is_skip_comments( void )
{
   ...
   p_suite = CU_add_suite("suite_test_is_skip_comments", NULL, NULL);
   if (NULL == p_suite) 
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_is_skip_comments_1
   add_test_to_suite( p_suite, test_is_skip_comments_1, "test_is_skip_comments_1" );
