/**
 @file RBTree_test_cursor_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_search_forth_eq_fn_1( void )
{
   ...
   i_rbtree_cursor_search_forth_eq_fn( cursor, 1, is_equal_int );
...
void test_cursor_search_forth_eq_fn_3( void )
{
   ...
   i_rbtree_cursor_start( cursor );
   i_rbtree_cursor_search_forth_eq_fn( cursor, 2, is_equal_int );
   CU_ASSERT( i_rbtree_cursor_off( cursor ) == 0 );
...
void test_cursor_search_forth_eq_fn_5( void )
{
   ...
   s_rbtree_cursor_search_forth_eq_fn( cursor, s2, is_equal_s );
