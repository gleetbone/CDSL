/**
 @file RBTree_test_search_forth_eq_fn.c
 @author Greg Lee
 @version 2.0.0
...
void test_search_forth_eq_fn_1( void )
{
   ...
   i_rbtree_search_forth_eq_fn( rbtree, 1, is_equal_int );
...
void test_search_forth_eq_fn_3( void )
{
   ...
   i_rbtree_start( rbtree );
   i_rbtree_search_forth_eq_fn( rbtree, 2, is_equal_int );
   CU_ASSERT( i_rbtree_off( rbtree ) == 0 );
...
void test_search_forth_eq_fn_5( void )
{
   ...
   s_rbtree_search_forth_eq_fn( rbtree, s2, is_equal_s );
