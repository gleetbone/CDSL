/**
 @file RBTree_test_remove_value_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_remove_value_and_dispose_1( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 1 );
...
void test_remove_value_and_dispose_2( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 2 );
...
void test_remove_value_and_dispose_2b( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 3 );
...
/**
   test_remove_value_and_dispose_2c
*/

void test_remove_value_and_dispose_2c( void )
{
   i_rbtree_t *rbtree = NULL;
...
void test_remove_value_and_dispose_5( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 4 );
...
void test_remove_value_and_dispose_5d( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 5 );
...
void test_remove_value_and_dispose_5e( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 6 );
...
void test_remove_value_and_dispose_5f( void )
{
   ...
   i_rbtree_remove_value_and_dispose( rbtree, 7 );
...
/**
   test_remove_value_and_dispose_6b
...
void test_remove_value_and_dispose_6b( void )
{
   i_rbtree_t *rbtree = NULL;
   int32_t result = 0;
...
/**
   test_remove_value_and_dispose_6c
...
void test_remove_value_and_dispose_6c( void )
{
   i_rbtree_t *rbtree = NULL;
   int32_t result = 0;
...
/**
   test_remove_value_and_dispose_6d
...
void test_remove_value_and_dispose_6d( void )
{
   i_rbtree_t *rbtree = NULL;
   int32_t result = 0;
...
void test_remove_value_and_dispose_7( void )
{
   ...
   s_rbtree_remove_value_and_dispose( rbtree, s1 );
...
add_test_remove_value_and_dispose( void )
{
   ...
   add_test_to_suite( p_suite, test_remove_value_and_dispose_2b, "test_remove_value_and_dispose_2c" );
   ...
   add_test_to_suite( p_suite, test_remove_value_and_dispose_6b, "test_remove_value_and_dispose_6b" );
   add_test_to_suite( p_suite, test_remove_value_and_dispose_6c, "test_remove_value_and_dispose_6c" );
   add_test_to_suite( p_suite, test_remove_value_and_dispose_6d, "test_remove_value_and_dispose_6d" );
