...
void test_edge_id_at_1( void )
{
   ...
   CU_ASSERT( ii_ugraph_edge_id_at( ugraph ) == e );
   
   ii_ugraph_edge_forth( ugraph );
...
void test_edge_id_at_2( void )
{
   ...
   ii_ugraph_edge_start( ugraph );
   CU_ASSERT( ii_ugraph_edge_off( ugraph ) == 0 );
   CU_ASSERT( ii_ugraph_edge_id_at( ugraph ) == e1 );
   
   ii_ugraph_edge_forth( ugraph );
   CU_ASSERT( ii_ugraph_edge_off( ugraph ) == 0 );
   CU_ASSERT( ii_ugraph_edge_id_at( ugraph ) == e2 );
   
   ii_ugraph_edge_forth( ugraph );
   CU_ASSERT( ii_ugraph_edge_off( ugraph ) == 0 );
   CU_ASSERT( ii_ugraph_edge_id_at( ugraph ) == e3 );
   
   ii_ugraph_edge_forth( ugraph );
   CU_ASSERT( ii_ugraph_edge_off( ugraph ) == 0 );
   CU_ASSERT( ii_ugraph_edge_id_at( ugraph ) == e4 );
