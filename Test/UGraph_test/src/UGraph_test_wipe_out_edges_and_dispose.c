/**
 @file UGraph_test_wipe_out_edges_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_wipe_out_edges_and_dispose_1
*/

void test_wipe_out_edges_and_dispose_1( void )
{
   ...
   ii_ugraph_wipe_out_edges_and_dispose( ugraph );
...
/**
   test_wipe_out_edges_and_dispose_2
*/

void test_wipe_out_edges_and_dispose_2( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
...
/**
   test_wipe_out_edges_and_dispose_3
*/

void test_wipe_out_edges_and_dispose_3( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
...
add_test_wipe_out_edges_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_wipe_out_edges_and_dispose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_wipe_out_edges_and_dispose_1
   add_test_to_suite( p_suite, test_wipe_out_edges_and_dispose_1, "test_wipe_out_edges_and_dispose_1" );

   // test_wipe_out_edges_and_dispose_2
   add_test_to_suite( p_suite, test_wipe_out_edges_and_dispose_2, "test_wipe_out_edges_and_dispose_2" );

   // test_wipe_out_edges_and_dispose_3
   add_test_to_suite( p_suite, test_wipe_out_edges_and_dispose_3, "test_wipe_out_edges_and_dispose_3" );
