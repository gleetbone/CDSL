...
{
   ii_ugraph_t *ugraph = NULL;
   ii_ugraph_t *cursor1 = NULL;
   ii_ugraph_t *cursor2 = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   int32_t v3 = 0;
   int32_t v4 = 0;
   ...
   cursor1 = ii_ugraph_make_cursor( ugraph );
   cursor2 = ii_ugraph_make_cursor( ugraph );
   
   ii_ugraph_cursor_vertex_start( cursor1 );
   CU_ASSERT( ii_ugraph_cursor_vertex_off( cursor1 ) == 0 );
