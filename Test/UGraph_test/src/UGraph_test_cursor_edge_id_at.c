/**
 @file UGraph_test_cursor_edge_id_at.c
 @author Greg Lee
 @version 2.0.0
...
void test_cursor_edge_id_at_1( void )
{
   ...
   CU_ASSERT( ii_ugraph_cursor_edge_id_at( cursor ) == e );
...
void test_cursor_edge_id_at_2( void )
{
   ...
   ii_ugraph_cursor_edge_start( cursor );
   CU_ASSERT( ii_ugraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_ugraph_cursor_edge_id_at( cursor ) == e1 );
   
   ii_ugraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_ugraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_ugraph_cursor_edge_id_at( cursor ) == e2 );
   
   ii_ugraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_ugraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_ugraph_cursor_edge_id_at( cursor ) == e3 );
   
   ii_ugraph_cursor_edge_forth( cursor );
   CU_ASSERT( ii_ugraph_cursor_edge_off( cursor ) == 0 );
   CU_ASSERT( ii_ugraph_cursor_edge_id_at( cursor ) == e4 );
