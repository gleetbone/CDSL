...
void test_is_equal_1( void )
{
   ...
   CU_ASSERT( ii_ugraph_is_equal( ugraph, ugraph1 ) == 1 );
...
void test_is_equal_2( void )
{
   ...
   CU_ASSERT( ii_ugraph_is_equal( ugraph, ugraph1 ) == 1 );
   CU_ASSERT( ii_ugraph_is_equal( ugraph, ugraph2 ) == 0 );
...
void test_is_equal_3( void )
{
   ...
   CU_ASSERT( ii_ugraph_is_equal( ugraph, ugraph1 ) == 0 );
...
void test_is_equal_4( void )
{
   ...
   CU_ASSERT( ii_ugraph_is_equal( ugraph, ugraph1 ) == 0 );
   CU_ASSERT( ii_ugraph_is_equal( ugraph1, ugraph ) == 0 );
