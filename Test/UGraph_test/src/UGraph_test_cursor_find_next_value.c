/**
 @file UGraph_test_cursor_find_next_value.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_cursor_find_next_value_1
*/

void test_cursor_find_next_value_1( void )
{
   ...
   v = ii_ugraph_cursor_find_value( cursor, 13 );
   CU_ASSERT( v != NULL );

   v = ii_ugraph_cursor_find_next_value( cursor, 13 );
   CU_ASSERT( v != NULL );

   v = ii_ugraph_cursor_find_value( cursor, 14 );
   CU_ASSERT( v != NULL );

   v = ii_ugraph_cursor_find_next_value( cursor, 14 );
   CU_ASSERT( v == NULL );
...
add_test_cursor_find_next_value( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_find_next_value", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_find_next_value_1
   add_test_to_suite( p_suite, test_cursor_find_next_value_1, "test_cursor_find_next_value_1" );
