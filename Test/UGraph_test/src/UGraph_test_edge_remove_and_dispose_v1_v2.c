/**
 @file UGraph_test_edge_remove_and_dispose_v1_v2.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_edge_remove_and_dispose_v1_v2_1
*/

void test_edge_remove_and_dispose_v1_v2_1( void )
{
   ...
   ii_ugraph_edge_remove_and_dispose_v1_v2( ugraph, v_from, v_to );
...
int
add_test_edge_remove_and_dispose_v1_v2( void )
{
   CU_pSuite p_suite = NULL;

   // add a suite for these tests to the registry
   p_suite = CU_add_suite("suite_test_edge_remove_and_dispose_v1_v2", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_remove_and_dispose_v1_v2_1
   add_test_to_suite( p_suite, test_edge_remove_and_dispose_v1_v2_1, "test_edge_remove_and_dispose_v1_v2_1" );
