/**
 @file UGraph_test_vertex_start.c
 @author Greg Lee
 @version 2.0.0
...
add_test_vertex_start( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vertex_start", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vertex_start_1
   add_test_to_suite( p_suite, test_vertex_start_1, "test_vertex_start_1" );

   // test_vertex_start_2
   add_test_to_suite( p_suite, test_vertex_start_2, "test_vertex_start_2" );

   // test_vertex_start_3
   add_test_to_suite( p_suite, test_vertex_start_3, "test_vertex_start_3" );

   // test_vertex_start_4
   add_test_to_suite( p_suite, test_vertex_start_4, "test_vertex_start_4" );
