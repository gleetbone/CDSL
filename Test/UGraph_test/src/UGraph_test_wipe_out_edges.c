/**
 @file UGraph_test_wipe_out_edges.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_wipe_out_edges_1
*/

void test_wipe_out_edges_1( void )
{
   ...
   ii_ugraph_wipe_out_edges( ugraph );
...
/**
   test_wipe_out_edges_2
*/

void test_wipe_out_edges_2( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
...
/**
   test_wipe_out_edges_3
*/

void test_wipe_out_edges_3( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
...
add_test_wipe_out_edges( void )
{
   ...
   p_suite = CU_add_suite("suite_test_wipe_out_edges", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_wipe_out_edges_1
   add_test_to_suite( p_suite, test_wipe_out_edges_1, "test_wipe_out_edges_1" );

   // test_wipe_out_edges_2
   add_test_to_suite( p_suite, test_wipe_out_edges_2, "test_wipe_out_edges_2" );

   // test_wipe_out_edges_3
   add_test_to_suite( p_suite, test_wipe_out_edges_3, "test_wipe_out_edges_3" );
