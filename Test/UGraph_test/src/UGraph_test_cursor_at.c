...
add_test_cursor_at( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_at", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_at_1
   add_test_to_suite( p_suite, test_cursor_at_1, "test_cursor_at_1" );
