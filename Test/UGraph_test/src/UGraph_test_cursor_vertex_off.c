/**
 @file UGraph_test_cursor_vertex_off.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_cursor_vertex_off_1
*/

void test_cursor_vertex_off_1( void )
{
...
/**
   test_cursor_vertex_off_2
*/

void test_cursor_vertex_off_2( void )
{
   ii_ugraph_t *ugraph = NULL;
   ii_ugraph_cursor_t *cursor = NULL;
   int32_t v1 = 0;
...
/**
   test_cursor_vertex_off_3
*/

void test_cursor_vertex_off_3( void )
{
   ii_ugraph_t *ugraph = NULL;
   ii_ugraph_cursor_t *cursor = NULL;
   int32_t v1 = 0;
...
add_test_cursor_vertex_off( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_vertex_off", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_vertex_off_1
   add_test_to_suite( p_suite, test_cursor_vertex_off_1, "test_cursor_vertex_off_1" );

   // test_cursor_vertex_off_2
   add_test_to_suite( p_suite, test_cursor_vertex_off_2, "test_cursor_vertex_off_2" );

   // test_cursor_vertex_off_3
   add_test_to_suite( p_suite, test_cursor_vertex_off_3, "test_cursor_vertex_off_3" );
