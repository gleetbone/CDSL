...
void test_edge_put_1( void )
{
   ...
   count = ii_ugraph_edge_count( ugraph );
   CU_ASSERT( count == 0 );
...
add_test_edge_put( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_put", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_put_1
   add_test_to_suite( p_suite, test_edge_put_1, "test_edge_put_1" );
