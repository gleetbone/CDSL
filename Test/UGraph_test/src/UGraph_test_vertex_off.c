...
add_test_vertex_off( void )
{
   ...
   p_suite = CU_add_suite("suite_test_vertex_off", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_vertex_off_1
   add_test_to_suite( p_suite, test_vertex_off_1, "test_vertex_off_1" );

   // test_vertex_off_2
   add_test_to_suite( p_suite, test_vertex_off_2, "test_vertex_off_2" );

   // test_vertex_off_3
   add_test_to_suite( p_suite, test_vertex_off_3, "test_vertex_off_3" );
