/**
 @file UGraph_test_edge_wipe_out_and_dispose.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_edge_wipe_out_and_dispose_1
*/

void test_edge_wipe_out_and_dispose_1( void )
{
   ...
   ii_ugraph_edge_wipe_out_and_dispose( ugraph );
...
add_test_edge_wipe_out_and_dispose( void )
{
   ...
   p_suite = CU_add_suite("suite_test_edge_wipe_out_and_dispose", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_wipe_out_and_dispose_1
   add_test_to_suite( p_suite, test_edge_wipe_out_and_dispose_1, "test_edge_wipe_out_and_dispose_1" );
