/**
 @file UGraph_test_edge_vertex_2.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_edge_vertex_2_1
*/

void test_edge_vertex_2_1( void )
{
   ...
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e ) == v2 );
...
/**
   test_edge_vertex_2_2
*/

void test_edge_vertex_2_2( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e1 ) == v2 );
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e2 ) == v3 );
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e3 ) == v4 );
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e4 ) == v5 );
...
/**
   test_edge_vertex_2_3
*/

void test_edge_vertex_2_3( void )
{
   ...
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e1 ) == v3 );
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e2 ) == v4 );
   CU_ASSERT( ii_ugraph_edge_vertex_2( ugraph, e3 ) == v5 );
...
int
add_test_edge_vertex_2( void )
{
   CU_pSuite p_suite = NULL;

   // add a suite for these tests to the registry
   p_suite = CU_add_suite("suite_test_edge_vertex_2", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_vertex_2_1
   add_test_to_suite( p_suite, test_edge_vertex_2_1, "test_edge_vertex_2_1" );

   // test_edge_vertex_2_2
   add_test_to_suite( p_suite, test_edge_vertex_2_2, "test_edge_vertex_2_2" );

   // test_edge_vertex_2_3
   add_test_to_suite( p_suite, test_edge_vertex_2_3, "test_edge_vertex_2_3" );
