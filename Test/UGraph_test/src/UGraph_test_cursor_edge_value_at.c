/**
 @file UGraph_test_cursor_edge_value_at.c
 @author Greg Lee
 @version 1.0.0
...
/**
   test_cursor_edge_value_at_1
*/

void test_cursor_edge_value_at_1( void )
{
   ...
   value = ii_ugraph_cursor_edge_value_at( cursor );
...
add_test_cursor_edge_value_at( void )
{
   ...
   p_suite = CU_add_suite("suite_test_cursor_edge_value_at", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_cursor_edge_value_at_1
   add_test_to_suite( p_suite, test_cursor_edge_value_at_1, "test_cursor_edge_value_at_1" );
