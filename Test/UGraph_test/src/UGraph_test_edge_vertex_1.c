/**
 @file UGraph_test_edge_vertex_1.c
 @author Greg Lee
 @version 2.0.0
...
/**
   test_edge_vertex_1_1
*/

void test_edge_vertex_1_1( void )
{
   ...
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e ) == v1 );
...
/**
   test_edge_vertex_1_2
*/

void test_edge_vertex_1_2( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e1 ) == v1 );
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e2 ) == v2 );
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e3 ) == v3 );
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e4 ) == v4 );
...
/**
   test_edge_vertex_1_3
*/

void test_edge_vertex_1_3( void )
{
   ii_ugraph_t *ugraph = NULL;
   int32_t v1 = 0;
   int32_t v2 = 0;
   ...
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e1 ) == v1 );
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e2 ) == v3 );
   CU_ASSERT( ii_ugraph_edge_vertex_1( ugraph, e3 ) == v4 );
...
int
add_test_edge_vertex_1( void )
{
   CU_pSuite p_suite = NULL;

   // add a suite for these tests to the registry
   p_suite = CU_add_suite("suite_test_edge_vertex_1", NULL, NULL);
   if (NULL == p_suite)
   {
      CU_cleanup_registry();
      return CU_get_error();
   ...
   // test_edge_vertex_1_1
   add_test_to_suite( p_suite, test_edge_vertex_1_1, "test_edge_vertex_1_1" );

   // test_edge_vertex_1_2
   add_test_to_suite( p_suite, test_edge_vertex_1_2, "test_edge_vertex_1_2" );

   // test_edge_vertex_1_3
   add_test_to_suite( p_suite, test_edge_vertex_1_3, "test_edge_vertex_1_3" );
