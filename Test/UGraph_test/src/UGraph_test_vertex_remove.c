/**
 @file UGraph_test_vertex_remove.c
 @author Greg Lee
 @version 2.0.0
...
void test_vertex_remove_1( void )
{
   ...
   ii_ugraph_vertex_remove( ugraph, v );
...
void test_vertex_remove_2( void )
{
   ...
   ii_ugraph_vertex_remove( ugraph, v3 );
   ii_ugraph_vertex_remove( ugraph, v4 );
   ii_ugraph_vertex_remove( ugraph, v5 );
...
void test_vertex_remove_4( void )
{
   ...
   ss_ugraph_vertex_remove( ugraph, v1 );
