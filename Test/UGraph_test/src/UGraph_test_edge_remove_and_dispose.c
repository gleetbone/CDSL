/**
 @file UGraph_test_edge_remove_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_edge_remove_and_dispose_1( void )
{
   ...
   ii_ugraph_edge_remove_and_dispose( ugraph, e );
...
void test_edge_remove_and_dispose_2( void )
{
   ...
   ii_ugraph_edge_remove_and_dispose( ugraph, e1 );
   ii_ugraph_edge_remove_and_dispose( ugraph, e2 );
   ii_ugraph_edge_remove_and_dispose( ugraph, e3 );
   ii_ugraph_edge_remove_and_dispose( ugraph, e4 );
...
void test_edge_remove_and_dispose_4( void )
{
   ...
   ss_ugraph_edge_remove_and_dispose( ugraph, e );
