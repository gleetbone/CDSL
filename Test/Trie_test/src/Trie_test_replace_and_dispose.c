/**
 @file Trie_test_replace_and_dispose.c
 @author Greg Lee
 @version 2.0.0
...
void test_replace_and_dispose_1( void )
{
   ...
   si_trie_replace_and_dispose( trie, 13, "a", 1 );
...
void test_replace_and_dispose_2( void )
{
   ...
   si_trie_replace_and_dispose( trie, 25, "a", 1 );
   si_trie_replace_and_dispose( trie, 14, "b", 1 );
...
void test_replace_and_dispose_3( void )
{
   ...
   si_trie_replace_and_dispose( trie, 25, "a", 1 );
   si_trie_replace_and_dispose( trie, 18, "ax", 2 );
